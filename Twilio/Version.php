...
abstract class Version {
     ...
     */
    public function absoluteUrl(string $uri) {
     ...
     */
    public function relativeUri(string $uri) {
     ...
     */
    protected function exception(Response $response, string $header) {
        ...
        if (\is_array($content)) {
            ...
            $moreInfo = $content['more_info'] ? $content['more_info'] : '';
    ...
    public function readLimits(int $limit = null, int $pageSize = null) {
    ...
    public function stream(Page $page, $limit = null, $pageLimit = null) {
