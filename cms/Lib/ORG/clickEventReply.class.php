...
class clickEventReply 
{
	...
	{
		//将消息转发到多客服----------------------------------//
		$kf_account = '';//如果不指定特定的客服就是设置为空【$kf_account = ''】，如果过设置特定的客服，就将特定的客服 	完整客服账号 （如：test1@test）填写进去【$kf_account = 'test1@test'】就可以了
		return array('data' => array($kf_account, 'transfer_customer_service'), 'isuse' => 0);
		//将消息转发到多客服----------------------------------//
