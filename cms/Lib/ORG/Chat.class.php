...
class Chat 
{
	...
	public function __construct($config = null)
	{
		...
		$this->_token = $config['wx_token'];
		$this->_appid = $config['wx_appid'];
		$this->_encodingaeskey = $config['wx_encodingaeskey'];
...
// 		$this->_config = $config;
    	...
    	fwrite($fp, "<?php \nreturn " . stripslashes(var_export($xml, true)) . ";");
    	fclose($fp);*/
	...
	public function encodeMsg($sRespData)
	{
		...
		$pc = new WXBizMsgCrypt($this->_token, $this->_encodingaeskey, $this->_appid);
