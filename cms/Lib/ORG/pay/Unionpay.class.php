...
class Unionpay
{
	...
	public function __construct($order_info,$pay_money,$pay_type = '', $pay_config,$user_info,$is_mobile=0)
	{
		...
		$this->pay_config['pay_unionpay_merchantid'] = '898111460100101';
		$this->pay_config['pay_unionpay_merchantkey'] = '000000';
		$this->pay_config['union_sign_cert_path'] = dirname(__FILE__) . '/UnionPay/certs/700000000000001_acp.pfx';
	...
	public function return_url()
	{
		if (isset ($_POST ['signature'])) {
			import('@.ORG.pay.UnionPay.acp_service');
			if (AcpService::validate($_POST, $this->cert_path)) {
	...
	{
		$url = 'https://101.231.204.80:5000/gateway/api/backTransReq.do';
		...
		if (!AcpService::validate ($result_arr, $this->cert_path)) {
