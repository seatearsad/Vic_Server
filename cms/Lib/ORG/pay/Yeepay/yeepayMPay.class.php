...
//	正式环境API请求基础地址
	...
	public function __construct($account,$merchantPublicKey,$merchantPrivateKey,$yeepayPublicKey){
		if($_SERVER['HTTP_HOST'] != 'hf.pigcms.com' && $_SERVER['HTTP_HOST'] != 'www.group.com'){
			$this->API_Pay_Base_Url = 'https://ok.yeepay.com/payapi/api/';
			$this->API_Mobile_Pay_Base_Url = 'https://ok.yeepay.com/payapi/mobile/';
			$this->API_PC_Pay_Base_Url = 'https://ok.yeepay.com/payweb/';
			$this->API_Merchant_Base_Url = 'https://ok.yeepay.com/merchant/';
		}
