...
//		}
        ...
        switch ($date){
            ...
            case 2 ://周二
                if ($show_method == 2) {//靠后显示
                    $condition_field .= ",(CASE
                    WHEN (`s`.`open_4`='00:00:00' and `s`.`open_5`='00:00:00' and `s`.`open_6`='00:00:00' and `s`.`close_4`='00:00:00' and `s`.`close_5`='00:00:00' and `s`.`close_6`='00:00:00') then 2
                    WHEN (`m`.`is_reserve` = 1) then 1
            ...
            case 3 ://周三
                if ($show_method == 2) {//靠后显示
                    $condition_field .= ",(CASE
                    WHEN (`s`.`open_7`='00:00:00' and `s`.`open_8`='00:00:00' and `s`.`open_9`='00:00:00' and `s`.`close_7`='00:00:00' and `s`.`close_8`='00:00:00' and `s`.`close_9`='00:00:00') then 2
                    WHEN (`m`.`is_reserve` = 1) then 1
            ...
            case 4 :
                if ($show_method == 2) {//靠后显示
                    $condition_field .= ",(CASE
                    WHEN (`s`.`open_10`='00:00:00' and `s`.`open_11`='00:00:00' and `s`.`open_12`='00:00:00' and `s`.`close_10`='00:00:00' and `s`.`close_11`='00:00:00' and `s`.`close_12`='00:00:00') then 2
                    WHEN (`m`.`is_reserve` = 1) then 1
            ...
            case 5 :
                if ($show_method == 2) {//靠后显示
                    $condition_field .= ",(CASE
                    WHEN (`s`.`open_13`='00:00:00' and `s`.`open_14`='00:00:00' and `s`.`open_15`='00:00:00' and `s`.`close_13`='00:00:00' and `s`.`close_14`='00:00:00' and `s`.`close_15`='00:00:00') then 2
                    WHEN (`m`.`is_reserve` = 1) then 1
            ...
            case 6 :
                if ($show_method == 2) {//靠后显示
                    $condition_field .= ",(CASE
                    WHEN (`s`.`open_16`='00:00:00' and `s`.`open_17`='00:00:00' and `s`.`open_18`='00:00:00' and `s`.`close_16`='00:00:00' and `s`.`close_17`='00:00:00' and `s`.`close_18`='00:00:00') then 2
                    WHEN (`m`.`is_reserve` = 1) then 1
            ...
            case 0 :
                if ($show_method == 2) {//靠后显示
                    $time = date("H:i:s");
                    $condition_field .= ",(CASE
                    WHEN (`s`.`open_19`='00:00:00' and `s`.`open_20`='00:00:00' and `s`.`open_21`='00:00:00' and `s`.`close_19`='00:00:00' and `s`.`close_20`='00:00:00' and `s`.`close_21`='00:00:00') then 2
                    WHEN (`m`.`is_reserve` = 1) then 1
