...
class LinkAction extends BaseAction{
    ...
    private function modules()
	{
		...
		$t = array(
			...
			array('module' => 'HousevillageNewslist', 'linkcode' => str_replace('shequ.php', 'wap.php', U('Wap/House/village_newslist', array('village_id'=>$village_id), true, false, true)),'name'=>$this->modules['HousevillageNewslist'],'sub'=>1,'canselected'=>1,'linkurl'=>'','keyword'=>'','askeyword'=>1),
