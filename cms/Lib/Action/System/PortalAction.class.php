...
class PortalAction extends BaseAction {
	...
	public function ajax_article_child_cates(){
		...
		$child_cates = D('Portal_article_cat')->where(array('fcid'=>$pid,'status'=>1))->select();
	...
	public function article_add(){
		// 资讯分类
		$fcid_list = D('Portal_article_cat')->where(array('fcid'=>0,'status'=>1))->select();
	...
	public function activity(){
		$activityList = D('Portal_activity')->select();
