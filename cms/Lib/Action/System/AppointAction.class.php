...
//			$uidArr[] = $order['uid'];
//			$appointidArr[]  = $order['appoint_id'];
//			$storeidArr[]  = $order['store_id'];
//		}
//
//		if(!empty($uidArr)){
//			$user_where['uid'] = array('in',$uidArr);
//			$user_info = $database_user->where($user_where)->field('`uid`, `phone`, `nickname`')->select();
//		}else{
//			$user_info = $database_user->field('`uid`, `phone`, `nickname`')->select();
//		}
//
//		if(!empty($appointidArr)){
//			$appoint_info = $database_appoint->where(array('in',$appointidArr))->field('`appoint_id`, `appoint_name`, `appoint_type`, `appoint_price`')->select();
//		}else{
//			$appoint_info = $database_appoint->field('`appoint_id`, `appoint_name`, `appoint_type`, `appoint_price`')->select();
//		}
//
//		if(!empty($storeidArr)){
//			$store_info = $database_store->where(array('in',$storeidArr))->field('`store_id`, `name`, `adress`')->select();
//		}else{
