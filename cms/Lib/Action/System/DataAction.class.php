...
//            $objExcel->getActiveSheet()->getColumnDimension('X')->setAutoSize(true);
            ...
            $objActSheet->setCellValue('F1', 'Total Price Before Tax|商品总价（税前）');//无
            ...
            $objActSheet->setCellValue('G1', 'Packing Fee|包装费');
            //$objActSheet->setCellValue('L1', 'Packing Tax|包装税费');
            $objActSheet->setCellValue('H1', 'Total Tax|总税费');
            $objActSheet->setCellValue('I1', 'Bottle Deposit');
            $objActSheet->setCellValue('J1', 'Total Price|总价');
            //$objActSheet->setCellValue('P1', 'Cash|现金');
            //$objActSheet->setCellValue('Q1', 'Status|订单状态');
            $objActSheet->setCellValue('K1', 'Time|时间');
            ...
            if (!empty($result_list)) {
                ...
                foreach ($result_list as $value) {
                    if($tmp_id == $value['real_orderid']){
                        ...
                        $objActSheet->setCellValueExplicit('G' . $index, '',PHPExcel_Cell_DataType::TYPE_NUMERIC);//Packing Fee|包装费
                        //$objActSheet->setCellValueExplicit('L' . $index, '',PHPExcel_Cell_DataType::TYPE_NUMERIC);//Packing Tax|包装税费
                        $objActSheet->setCellValueExplicit('H' . $index, '',PHPExcel_Cell_DataType::TYPE_NUMERIC);//Total Tax|总税费
                        $objActSheet->setCellValueExplicit('I' . $index, '',PHPExcel_Cell_DataType::TYPE_NUMERIC);//Bottle Deposit
                        $objActSheet->setCellValueExplicit('J' . $index, '',PHPExcel_Cell_DataType::TYPE_NUMERIC);//Total Price|总价
                        ...
                        $objActSheet->setCellValueExplicit('K' . $index, '');//时间
...
//                        $objActSheet->setCellValueExplicit('X' . $index, '');//送达时间
                        ...
                        $objActSheet->setCellValueExplicit('F' . $index, $value['goods_price'],PHPExcel_Cell_DataType::TYPE_NUMERIC);//商品总价（税前）////无
                        ...
                        $objActSheet->setCellValueExplicit('G' . $index, floatval(sprintf("%.2f", $value['packing_charge'])),PHPExcel_Cell_DataType::TYPE_NUMERIC);//Packing Fee|包装费
                        ...
                        $objActSheet->setCellValueExplicit('H' . $index, floatval(sprintf("%.2f", $all_record[$value['real_orderid']]['total_tax'])),PHPExcel_Cell_DataType::TYPE_NUMERIC);//Total Tax|总税费
                        $objActSheet->setCellValueExplicit('I' . $index, floatval(sprintf("%.2f", $all_record[$value['real_orderid']]['all_deposit'])),PHPExcel_Cell_DataType::TYPE_NUMERIC);//Bottle Deposit
                        $objActSheet->setCellValueExplicit('J' . $index, floatval($value['price']),PHPExcel_Cell_DataType::TYPE_NUMERIC);//订单总价
                        ...
                        $objActSheet->setCellValueExplicit('K' . $index, $value['use_time'] ? date('Y-m-d H:i:s', $value['use_time']) : '');//送达时间
...
//                        $objActSheet->setCellValueExplicit('W' . $index, $value['use_time'] ? date('Y-m-d H:i:s', $value['use_time']) : '');//送达时间
                ...
                $objActSheet->setCellValueExplicit('G' . $index, floatval(sprintf("%.2f", $total_packing_price)),PHPExcel_Cell_DataType::TYPE_NUMERIC);//Packing Fee|包装费
                ...
                $objActSheet->setCellValueExplicit('H' . $index, floatval(sprintf("%.2f", $total_all_tax)),PHPExcel_Cell_DataType::TYPE_NUMERIC);//Total Tax|总税费
                $objActSheet->setCellValueExplicit('I' . $index, floatval(sprintf("%.2f", $total_deposit)),PHPExcel_Cell_DataType::TYPE_NUMERIC);//Bottle Deposit
                $objActSheet->setCellValueExplicit('J' . $index, floatval(sprintf("%.2f", $total_all_price)),PHPExcel_Cell_DataType::TYPE_NUMERIC);//订单总价
                //$objActSheet->setCellValueExplicit('P' . $index, floatval(sprintf("%.2f", $total_cash)),PHPExcel_Cell_DataType::TYPE_NUMERIC);//Cash|现金
                //$objActSheet->setCellValueExplicit('Q' . $index, '');//订单状态
                $objActSheet->setCellValueExplicit('K' . $index, '');//送达时间
            }
            sleep(2);
        }
        //输出
