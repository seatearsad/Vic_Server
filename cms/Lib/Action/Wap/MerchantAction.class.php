...
class MerchantAction extends BaseAction{
	...
	public function store_list(){
		...
		$this->assign(D('Merchant')->wap_get_Merchant_list_by_catid($get_grouplist_catid,$get_grouplist_catfid,$area_id,$sort_id, $long_lat['lat'], $long_lat['long'], $circle_id));
	...
	public function ajaxList(){
		...
		$return = S('wap_store_'.($get_grouplist_catfid ? $get_grouplist_catfid : $get_grouplist_catid).'_'.$area_id.'_'.$sort_id);
		if(empty($return)){
			$return = D('Merchant')->wap_get_storeList_by_catid($get_grouplist_catid,$get_grouplist_catfid,$area_id,$sort_id, $long_lat['lat'], $long_lat['long'], $circle_id);
			S('wap_store_group_'.($get_grouplist_catfid ? $get_grouplist_catfid : $get_grouplist_catid).'_'.$area_id.'_'.$sort_id,$return,360);
		}
