...
//                    }
    ...
    public function ajaxWorkerTime(){
        if (IS_POST) {
            ...
            if($tmp_gap >= 0){
                ...
                // 查询可预约时间点
                $appoint_num = D('Appoint_order')->get_worker_appoint_num($now_group['appoint_id'], 1);
    ...
    public function worker_list(){
        ...
        $appoint_id = $_GET['appoint_id'] + 0;
        $merchant_worker_list = $database_merchant_workers->get_appoint_worker_list($appoint_id);
