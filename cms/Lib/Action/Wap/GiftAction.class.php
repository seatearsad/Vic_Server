...
class GiftAction extends BaseAction{
    ...
    public function gift_list(){
        ...
        $gift_list = $database_gift->gift_page_list($gift_condition , true , $order , 9999);

        $gift_category_condition['is_del'] = 0;
        $gift_category_condition['status'] = 1;
        $gift_category_condition['cat_id'] = $cat_id;
        $gift_category_detail = $database_gift_category->gift_category_detail($gift_category_condition,true,'cat_id desc',999);

        $this->assign('gift_list' , $gift_list['list']);
        $this->assign('gift_category_detail' , $gift_category_detail['detail']);
        $this->display();
    }
