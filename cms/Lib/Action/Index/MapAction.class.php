...
class MapAction extends BaseAction{
	public function suggestion(){
		...
		$url = 'https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=48.43016873926502,-123.34303379055086&rankby=distance&keyword='.urlencode($_GET['query']).'&key=AIzaSyBt3Lu-FlQE5LgusybLzqGr8lIXmvTsLZU&language=zh-CN';
		import('ORG.Net.Http');
		$http = new Http();
