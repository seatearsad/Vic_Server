...
//		}
        ...
        switch ($date){
            ...
            case 2 ://周二
                ...
                $store['time'] = $row['open_4'] . '~' . $row['close_4'];
                $store['time'] .= ';' . $row['open_5'] . '~' . $row['close_5'];
                $store['time'] .= ';' . $row['open_6'] . '~' . $row['close_6'];
                break;
            case 3 ://周三
                ...
                $store['time'] = $row['open_7'] . '~' . $row['close_7'];
                $store['time'] .= ';' . $row['open_8'] . '~' . $row['close_8'];
                $store['time'] .= ';' . $row['open_9'] . '~' . $row['close_9'];
            ...
            case 4 :
                ...
                $store['time'] = $row['open_10'] . '~' . $row['close_10'];
                $store['time'] .= ';' . $row['open_11'] . '~' . $row['close_11'];
                $store['time'] .= ';' . $row['open_12'] . '~' . $row['close_12'];
                break;
            case 5 :
                ...
                $store['time'] = $row['open_13'] . '~' . $row['close_13'];
                $store['time'] .= ';' . $row['open_14'] . '~' . $row['close_14'];
                $store['time'] .= ';' . $row['open_15'] . '~' . $row['close_15'];
                break;
            case 6 :
                ...
                $store['time'] = $row['open_16'] . '~' . $row['close_16'];
                $store['time'] .= ';' . $row['open_17'] . '~' . $row['close_17'];
                $store['time'] .= ';' . $row['open_18'] . '~' . $row['close_18'];
                break;
            case 0 :
                ...
                $store['time'] .= $row['open_19'] . '~' . $row['close_19'];
                $store['time'] .= ';' . $row['open_20'] . '~' . $row['close_20'];
                $store['time'] .= ';' . $row['open_21'] . '~' . $row['close_21'];
                break;
            default :
                $store['is_close'] = 1;
                $store['time']= '营业时间未知';
