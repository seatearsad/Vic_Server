...
//			}
            ...
            switch ($date){
                case 1 :
                    ...
                    break;
                case 2 ://周二
                    if ($store['open_4'] < $nowtime && $store['close_4'] > $nowtime) {
                        $flag = false;
                    }
                    if ($store['open_5'] < $nowtime && $store['close_5'] > $nowtime) {
                        $flag = false;
                    }
                    if ($store['open_6'] < $nowtime && $store['close_6'] > $nowtime) {
                        $flag = false;
                    }
                    break;
                case 3 ://周三
                    if ($store['open_7'] < $nowtime && $store['close_7'] > $nowtime) {
                        $flag = false;
                    }
                    if ($store['open_8'] < $nowtime && $store['close_8'] > $nowtime) {
                        $flag = false;
                    }
                    if ($store['open_9'] < $nowtime && $store['close_9'] > $nowtime) {
                        $flag = false;
                    }
                    break;
                case 4 :
                    if ($store['open_10'] < $nowtime && $store['close_10'] > $nowtime) {
                        $flag = false;
                    }
                    if ($store['open_11'] < $nowtime && $store['close_11'] > $nowtime) {
                        $flag = false;
                    }
                    if ($store['open_12'] < $nowtime && $store['close_12'] > $nowtime) {
                        $flag = false;
                    }
                    break;
                case 5 :
                    if ($store['open_13'] < $nowtime && $store['close_13'] > $nowtime) {
                        $flag = false;
                    }
                    if ($store['open_14'] < $nowtime && $store['close_14'] > $nowtime) {
                        $flag = false;
                    }
                    if ($store['open_15'] < $nowtime && $store['close_15'] > $nowtime) {
                        $flag = false;
                    }
                    break;
                case 6 :
                    if ($store['open_16'] < $nowtime && $store['close_16'] > $nowtime) {
                        $flag = false;
                    }
                    if ($store['open_17'] < $nowtime && $store['close_17'] > $nowtime) {
                        $flag = false;
                    }
                    if ($store['open_18'] < $nowtime && $store['close_18'] > $nowtime) {
                        $flag = false;
                    }
                    break;
                case 0 :
                    if ($store['open_19'] < $nowtime && $store['close_19'] > $nowtime) {
                        $flag = false;
                    }
                    if ($store['open_20'] < $nowtime && $store['close_20'] > $nowtime) {
                        $flag = false;
                    }
                    if ($store['open_21'] < $nowtime && $store['close_21'] > $nowtime) {
                        $flag = false;
                    }
                    break;
                default :
