...
//    			}
                ...
                switch ($date){
                    case 1 :
                        ...
                        if ($st['open_3'] != '00:00:00' && $st['close_3'] != '00:00:00') {
                            $str .= ',' . $st['open_3'] . '-' . $st['close_3'];
                        }
                        break;
                    case 2 ://周二
                        if ($st['open_4'] != '00:00:00' && $st['close_4'] != '00:00:00') {
                            $str .= ',' . $st['open_4'] . '-' . $st['close_4'];
                        }
                        if ($st['open_5'] != '00:00:00' && $st['close_5'] != '00:00:00') {
                            $str .= ',' . $st['open_5'] . '-' . $st['close_5'];
                        }
                        if ($st['open_6'] != '00:00:00' && $st['close_6'] != '00:00:00') {
                            $str .= ',' . $st['open_6'] . '-' . $st['close_6'];
                        }
                        break;
                    case 3 ://周三
                        if ($st['open_7'] != '00:00:00' && $st['close_7'] != '00:00:00') {
                            $str .= ',' . $st['open_7'] . '-' . $st['close_7'];
                        }
                        if ($st['open_8'] != '00:00:00' && $st['close_8'] != '00:00:00') {
                            $str .= ',' . $st['open_8'] . '-' . $st['close_8'];
                        }
                        if ($st['open_9'] != '00:00:00' && $st['close_9'] != '00:00:00') {
                            $str .= ',' . $st['open_9'] . '-' . $st['close_9'];
                        }
                        break;
                    case 4 :
                        if ($st['open_10'] != '00:00:00' && $st['close_10'] != '00:00:00') {
                            $str .= ',' . $st['open_10'] . '-' . $st['close_10'];
                        }
                        if ($st['open_11'] != '00:00:00' && $st['close_11'] != '00:00:00') {
                            $str .= ',' . $st['open_11'] . '-' . $st['close_11'];
                        }
                        if ($st['open_12'] != '00:00:00' && $st['close_12'] != '00:00:00') {
                            $str .= ',' . $st['open_12'] . '-' . $st['close_12'];
                        }
                        break;
                    case 5 :
                        if ($st['open_13'] != '00:00:00' && $st['close_13'] != '00:00:00') {
                            $str .= ',' . $st['open_13'] . '-' . $st['close_13'];
                        }
                        if ($st['open_14'] != '00:00:00' && $st['close_14'] != '00:00:00') {
                            $str .= ',' . $st['open_14'] . '-' . $st['close_14'];
                        }
                        if ($st['open_15'] != '00:00:00' && $st['close_15'] != '00:00:00') {
                            $str .= ',' . $st['open_15'] . '-' . $st['close_15'];
                        }
                        break;
                    case 6 :
                        if ($st['open_16'] != '00:00:00' && $st['close_16'] != '00:00:00') {
                            $str .= ',' . $st['open_16'] . '-' . $st['close_16'];
                        }
                        if ($st['open_17'] != '00:00:00' && $st['close_17'] != '00:00:00') {
                            $str .= ',' . $st['open_17'] . '-' . $st['close_17'];
                        }
                        if ($st['open_18'] != '00:00:00' && $st['close_18'] != '00:00:00') {
                            $str .= ',' . $st['open_18'] . '-' . $st['close_18'];
                        }
                        break;
                    case 0 :
                        if ($st['open_19'] != '00:00:00' && $st['close_19'] != '00:00:00') {
                            $str .= ',' . $st['open_19'] . '-' . $st['close_19'];
                        }
                        if ($st['open_20'] != '00:00:00' && $st['close_20'] != '00:00:00') {
                            $str .= ',' . $st['open_20'] . '-' . $st['close_20'];
                        }
                        if ($st['open_21'] != '00:00:00' && $st['close_21'] != '00:00:00') {
                            $str .= ',' . $st['open_21'] . '-' . $st['close_21'];
                        }
                        break;
                    default :
                        $str = '未营业';
