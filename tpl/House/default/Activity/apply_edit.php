							...
							<div id="basicinfo" class="tab-pane active">
								...
								<div class="form-group">
									<label class="col-sm-1">活动状态</label>
										...
										<label style="padding-left:0px;"><input type="radio" class="ace" <if condition='$detail["apply_status"] eq 0'>checked="checked"</if> value="0" name="apply_status"><span style="z-index: 1" class="lbl">关闭</span></label>
								</div>
							</div>
						</div>
						<div class="space"></div>
