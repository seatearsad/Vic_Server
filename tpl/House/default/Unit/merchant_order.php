    ...
    <div class="page-content">
        <div class="page-content-area">
            ...
            <div class="row search_table">
				...
				<div>		
				<br>
				<div >本页实际支付总金额：<strong style="color: red" id="total_money"></strong> 平台返点（返点比例{pigcms{$config.house_money_percent}%）：<strong style="color: red" id="money_rebate"></strong></div>
                <div class="col-xs-12">
