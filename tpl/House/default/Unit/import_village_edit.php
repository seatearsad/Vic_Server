						...
						<div class="tab-content">
							<div id="basicinfo" class="tab-pane active">
								<div class="form-group">
									...
									<input class="col-sm-2" size="20" name="usernum" id="usernum" type="text" value="{pigcms{$detail.usernum}" <if condition='$detail["status"] gt 1'>readonly="readonly"</if> />
								</div>
							
							
								<div class="form-group">
									<label class="col-sm-1"><label for="floor_name">单元名称</label></label>
									<input class="col-sm-2" size="20" name="floor_name" id="floor_name" type="text" value="{pigcms{$detail.floor_name}" <if condition='$detail["status"] gt 1'>readonly="readonly"</if>/>
								</div>
                                
                                <div class="form-group">
									<label class="col-sm-1"><label for="floor_layer">单元楼号</label></label>
									<input class="col-sm-2" size="20" name="floor_layer" id="floor_layer" type="text" value="{pigcms{$detail.layer_name}" <if condition='$detail["status"] gt 1'>readonly="readonly"</if>/>
								</div>
