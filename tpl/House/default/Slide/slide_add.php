						...
						<div class="tab-content">
							<div id="basicinfo" class="tab-pane active">
								<div class="form-group">
									<label class="col-sm-1"><label for="name">幻灯片名称</label></label>
                                ...
                                <div class="form-group">
									...
									<input class="col-sm-2" size="20" name="sort" id="sort" type="text" value="1" />
                                   	<label class="col-sm-3"> &nbsp;&nbsp;请填写1-10之间的值，升序排列</label>
								</div>
                                
                                <div class="form-group">
									<label class="col-sm-1">幻灯片状态</label>
