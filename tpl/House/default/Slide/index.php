            ...
            <div class="row">
                ...
                <if condition='!$has_slide'>
                    <div style="margin-top:10px; cursor:pointer" class="alert alert-danger" onClick="window.open('{pigcms{:U('Index/index')}')">
                        ...
                        还未开启&nbsp;&nbsp;<span style="font-weight:bold">首页幻灯片</span>&nbsp;&nbsp;功能，请先到&nbsp;&nbsp;<span style="font-weight:bold">基本信息管理 - 基本信息设置 - 功能库配置&nbsp;&nbsp;</span>开启相应配置。
                    </div>
                <else />
                	<button class="btn btn-success" onclick="slide_add()">添加幻灯片</button>
            	</if>
                                ...
                                <if condition="$list">
                                    <volist name="list['list']" id="vo">
                                        <tr class="<if condition="$i%2 eq 0">odd<else/>even</if>">
                                            ...
                                            <td><div class="tagDiv"><img src="{pigcms{$config.site_url}/upload/slider/{pigcms{$vo.pic}" width="140px" height="58px" /></div></td>
                                            <td><div class="tagDiv">
                                            ...
                                            <td class="button-column">
                                                <a style="width: 60px;" class="label label-sm label-info" title="编辑" href="{pigcms{:U('slider_edit',array('id'=>$vo['id']))}">编辑</a>
...
function slide_add(){
	window.location.href = "/shequ.php?g=House&c=Slide&a=slide_add";
}
</script>
