					...
					<form  class="form-horizontal" method="post" onSubmit="return check_submit()" action="__SELF__">
						<div class="tab-content">
								...
								<div class="form-group">
									...
									<input class="col-sm-2" size="20" name="phone" id="phone" type="text" value=""/> <span class="red line-span none not-phone">&nbsp;&nbsp;无此用户信息</span>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<input class="col-sm-2" size="20" name="housesize" id="housesize" type="text" value=""/>
								</div>
								<div class="form-group">
