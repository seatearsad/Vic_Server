...
function show_province(){
	$.post(choose_province,function(result){
		...
		if(result.error == 0){
			...
			$('#choose_province,#choose_city,#choose_area,#choose_circle').remove();
			alert(result.info);
		}
	});
}
...
function show_city(id,name,type){
	$.post(choose_city,{id:id,name:name,type:type},function(result){
		...
		if(result.error == 0){
			...
			$('#choose_city,#choose_area,#choose_circle').remove();
			alert(result.info);
		}
	});
}
...
function show_area(id,name,type){
	$.post(choose_area,{id:id,name:name,type:type},function(result){
		...
		if(result.error == 0){
			...
			$('#choose_area,#choose_circle').remove();
			alert(result.info);
		}
	});
}
