...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
		<tr>
			<th>订单详情</th>
			<th>物业服务周期：{pigcms{$now_order['property_month_num']}个月 &nbsp;&nbsp;&nbsp;&nbsp;额外：<if condition='$now_order["diy_type"] gt 0'>{pigcms{$now_order["diy_content"]}<else />赠送{pigcms{$now_order["presented_property_month_num"]}个月</if></th>
		</tr>
		<tr>
			<th>订单总价</th>
