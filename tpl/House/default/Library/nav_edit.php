	...
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			<li>
				...
				<a href="{pigcms{:U('nav_index')}">首页自定义导航</a>
			</li>
						...
						<div class="tab-content">
							<div id="basicinfo" class="tab-pane active">
								<div class="form-group">
									<label class="col-sm-1"><label for="name">分类名称：</label></label>
									<input class="col-sm-2" size="20" name="name" id="name" type="text" value="{pigcms{$detail.name}"/>
								</div></div>


                                    <div class="form-group">
                                        <label class="col-sm-1"><label for="url">分类链接：</label></label>
                                            ...
                                            <div id="upload_pic_box">
                                                <ul id="upload_pic_ul">
                                                    <li class="upload_pic_li">
														<img src="/upload/service/{pigcms{$detail['img']}">
                                                        <input type="hidden" value="{pigcms{$detail['img']}" name="img"><br>
                                                        <a onclick="deleteImg('{pigcms{$detail[\'img\']}',this);return false;" href="#">[ 删除 ]</a>
                                                    </li>
                                                </ul>
                                            </div>
                                    </div>
