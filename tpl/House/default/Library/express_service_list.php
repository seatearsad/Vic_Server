	...
	<div class="page-content">
        <div class="page-content-area">
            <div class="row">
                ...
                <else />
                	<button class="btn btn-success handle_btn" href="{pigcms{:U('Library/express_config')}">代送配置<if condition="$village_send">(已开启代送)</if></button>
                	<button class="btn btn-success" onclick="express_add()">添加快递</button>
                                        ...
                                        <tr class="<if condition="$i%2 eq 0">odd<else/>even</if>">
										   ...
										   <if condition="$vo.money gt 0">
                                            ...
                                            <td class="button-column">
                                                <a style="width: 60px;" class="label label-sm label-info handle_btn" title="详情" href="{pigcms{:U('express_detail',array('id'=>$vo['id']))}">详情</a>&nbsp;&nbsp;&nbsp;&nbsp;<a style="width: 60px;" class="label label-sm label-info" title="删除" href="javascript:void(0)" onClick="if(confirm('确认删除该条信息？')){location.href='{pigcms{:U('express_del',array('id'=>$vo['id']))}'}">删除</a>
                                           </td>
                                        </tr>
                                    </volist>
                                <else/>
                                    <tr class="odd"><td class="button-column" colspan="8" >没有任何快递。</td></tr>
                                </if>
                            </tbody>
                        </table>
                        {pigcms{$list.pagebar}
