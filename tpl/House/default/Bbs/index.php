...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="page-content-area">
        	<button class="btn btn-success" onclick="addCategory()">新增分类</button>
        	<button class="btn btn-success" style="margin-left:10px;" onclick="modifyIndexImg()">论坛配置</button>
            <div class="row">
                <div class="col-xs-12">
                                    ...
                                    <volist name="list" id="vo">
                                        <tr class="<if condition="$i%2 eq 0">odd<else/>even</if>">
                                            ...
                                            <td class="button-column">
                                                ...
                                                <a style="width:80px;height:26px;line-height:20px;" class="label label-sm label-info handle_btn" title="文章列表" href="{pigcms{:U('aricle_list',array('cat_id'=>$vo['cat_id']))}">文章列表</a>
												<a style="width:80px;height:26px;line-height:20px;" class="label label-sm label-info handle_btn" title="文章列表" href="javascript:void(0)" onclick="if(confirm('确认删除该分类？')){location.href='{pigcms{:U('delete_category',array('cat_id'=>$vo['cat_id']))}'}">删除分类</a>
                                            </td>
                                        </tr>
                                    </volist>
                                <else/>
