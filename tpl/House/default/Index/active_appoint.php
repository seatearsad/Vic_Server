...
<div class="main-content">
	...
	<div class="page-content">
		<div class="page-content-area">
			<div class="row">
				<div class="col-xs-12">
					<form enctype="multipart/form-data" class="form-horizontal" method="post" action="{pigcms{:U('Index/active_appoint')}" onsubmit="return doSub();">
						<input type="hidden" name="appoint_id" id="group_id"/>
						<div class="tab-content">
							<div id="basicinfo" class="tab-pane active">
								<div class="form-group">
									<label class="col-sm-1"><label for="title">预约网址</label></label>
									<input class="col-sm-2" size="80" name="url" id="group_url" type="text" value=""/>&nbsp;&nbsp;
								...
								<div class="form-group js-show-red-no">
									...
									<input name="label" class="col-sm-2" size="20" type="text" id="label"/>
								...
								<div class="form-group js-show-red-no" style="width:417px;padding-left:140px;">
									...
									<div id="imgBox" style="display:none;"><img style="width:100px;height:100px" id="img" src=""/></div>
								</div>
								<div class="form-group">
...
function checkGroup(){
	...
	$.post('{pigcms{:U("Index/check_appoint")}', {appoint_id:group_id}, function(result){
