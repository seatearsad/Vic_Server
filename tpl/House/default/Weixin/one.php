...
<script type="text/javascript" src="{pigcms{$static_path}js/upyun.js"></script>

<script type="text/javascript">
var diyTool = "{pigcms{:U('Weixin/diytool')}";
var editor;
KindEditor.ready(function(K) {
	editor = K.create('#content', {
		...
		uploadJson : '/shequ.php?g=House&c=Upyun&a=kindedtiropic',
	...
	K('#J_selectImage').click(function(){
		...
		editor.uploadJson = "{pigcms{:U('Weixin/ajax_upload_pic')}";
...
function deleteImage(path,obj){
	$.post("{pigcms{:U('Weixin/ajax_del_pic')}",{path:path});
