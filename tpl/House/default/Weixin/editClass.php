...
<table class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
	...
	<tr>
		...
		<td class="norightborder">
			<if condition="$c['sub'] eq NULL">
				<a href="###" onclick="returnHomepage({pigcms{$c.id},'{pigcms{$c.name}')">选中</a>
			<else />
				<a href="###" onclick="returnHomepage({pigcms{$c.id},'{pigcms{$c.name}')">选中</a> &nbsp; 
				<a href="{pigcms{:U('Article/editClass', array('id' => $c['id']))}">详情</a>
			</if>
		</td>
	</tr>
	</volist>
