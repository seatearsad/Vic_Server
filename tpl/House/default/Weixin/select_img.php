...
<tr>
<th>标题</th>
<th style=" width:80px;">操作 <span class="tooltips" ><img src="{pigcms{$static_path}images/price_help.png" align="absmiddle" /><span>
<p>点击“选中”即可</p>
</span></span></th>
</tr>
</thead>
...
<else/>
<tr><td colspan="2" align="center"><a href="{pigcms{:U('Weixin/one')}" target="_blank" style="color:#369">还没有图文消息，请点击这里添加图文消息</a></td></tr>
</if>
</table>
