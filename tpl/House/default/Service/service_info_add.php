                               ...
                               <div class="form-group">
									...
									<select style="margin-right:10px;" class="col-sm-1" name="cat_fid" id="choose_catfid">
                                        <volist name='cat_flist' id='vo'>
                                        	<option value="{pigcms{$vo['id']}">{pigcms{$vo.cat_name}</option>
                                        </volist>
										</select>
                                ...
                                <div class="form-group">
									...
									<input type="text" value="" id="phone" name="phone" size="20" class="col-sm-2">
								...
								<div class="form-group">
									<label class="col-sm-1">状态</label>
										...
										<label style="padding-left:0px;padding-right:20px;"><input type="radio" checked="checked" class="ace" value="1" name="status"><span style="z-index: 1" class="lbl">开启</span></label>
