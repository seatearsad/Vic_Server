	...
	<div class="page-content">
        <div class="page-content-area">
            ...
            <div class="row">
                ...
                <button class="btn btn-success" onclick="service_catgory_add()">添加顶级分类</button>
                                ...
                                <if condition="$list['list']">
                                    <volist name="list['list']" id="vo">
                                        <tr class="<if condition="$i%2 eq 0">odd<else/>even</if>">
                                            ...
                                            <td><div class="tagDiv"><a href="{pigcms{:U('s_service_category',array('cat_id'=>$vo['id']))}">查看子分类</a></div></td>
                                            <td><div class="tagDiv">
