							...
							<div id="basicinfo" class="tab-pane active">
								...
								<div class="form-group">
									...
									<div id="upload_pic_box">
										<li class="upload_pic_li">
                                        	<img src="/upload/service/{pigcms{$slider_info['pic']}">
                                ...
                                <div class="form-group">
									<label class="col-sm-1">是否开启</label>
										...
										<label style="padding-left:0px;padding-right:20px;"><input type="radio" <if condition='$slider_info["status"] eq 1'>checked</if> class="ace" value="1" name="status"><span style="z-index: 1" class="lbl">开启</span></label>
										<label style="padding-left:0px;"><input type="radio" class="ace" value="0" name="status" <if condition='$slider_info["status"] eq 0'>checked</if> ><span style="z-index: 1" class="lbl" >关闭</span></label>
								</div>
							</div>
						</div>
						<div class="space"></div>
