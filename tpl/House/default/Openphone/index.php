...
<div class="main-content">
	...
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			...
			<li class="active"><a href="{pigcms{:U('Openphone/index')}">常用电话</a></li>
		</ul>
	</div>
	<!-- 内容头部 -->
	<div class="page-content">
        <div class="page-content-area">
            ...
            <div class="row">
                <div class="col-xs-12">
					<button class="btn btn-success" onclick="catgory_add()">添加分类</button>
                                    ...
                                    <volist name="cat_list" id="vo">
                                        <tr class="<if condition="$i%2 eq 0">odd<else/>even</if>">
                                            ...
                                            <td><div class="tagDiv">{pigcms{$vo.cat_name}</div></td>
                                           	<td><div class="tagDiv"><a href="{pigcms{:U('Openphone/phone',array('cat_id'=>$vo['cat_id']))}">电话列表</a></div></td>
