					...
					<form class="form-horizontal" method="post" onSubmit="return check_submit();" action="__SELF__">
						<div class="tab-content">
							...
							<div class="form-group">
								...
								<input type="text" id="cat_sort" name="cat_sort" size="20" class="col-sm-2" value="{pigcms{$now_cat.cat_sort}"/>
							...
							<div class="form-group">
								...
								<label style="padding-left:0px;padding-right:20px;">
									<input name="cat_status" value="1" type="radio" class="ace" <if condition="$now_cat['cat_status'] eq 1">checked="checked"</if>/>
									<span class="lbl" style="z-index: 1">开启</span>
								</label>
								<label style="padding-left:0px;">
									<input name="cat_status" value="0" type="radio" class="ace" <if condition="$now_cat['cat_status'] eq 0">checked="checked"</if>/>
