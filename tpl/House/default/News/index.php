...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="page-content-area">
            <button class="btn btn-success" onclick="CreateCategory()">新增新闻</button>
            <style>
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <td class="button-column">
                                ...
                                <if condition="$vo['is_notice'] eq 0">
                                    <a style="width: 100px;" class="label label-sm label-info <if condition=" $vo['status'] eq 0 "><else/>handle_btn </if>"
                                <if condition=" $vo['status'] eq 0 ">href="javascript:;"<else/>href="{pigcms{:U('News/send',array('news_id'=>$vo['news_id']))}"</if> >
                                <if condition="$vo['status'] eq 0 "> 此新闻已被关闭 <else />微信群发业主 </if>
                                </a>　
                                </if>
