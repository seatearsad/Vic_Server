...
<div class="main-content">
	...
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			...
			<li class="active">快速支付账单</li>
		</ul>
	</div>
	<div class="alert alert-info" style="margin:10px;">
		<button type="button" class="close" data-dismiss="alert"><i class="ace-icon fa fa-times"></i></button>只统计已支付的订单
	</div>
	<!-- 内容头部 -->
													...
													<if condition="$order_list">
														<volist name="order_list" id="vo">
															<tr>
																...
																<td><if condition="$vo['from_plat'] eq 1">店铺快速支付<else />收银台收取</if></td>
