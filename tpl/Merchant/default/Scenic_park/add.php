				...
				<div class="col-xs-12">
					<div class="tabbable">
						<ul class="nav nav-tabs" id="myTab">
							<li class="active">
								<a data-toggle="tab" href="#basicinfo">添加停车场</a>
							</li>
						</ul>
					</div>
						...
						<div class="tab-content">
							<div id="basicinfo" class="tab-pane active">
								<div class="form-group">
									...
									<input type="text" name="parking_name" value="" />
									<span class="form_tips">必填。在订单页显示此名称！</span>
								</div>
								<div class="form-group">
									<label class="col-sm-1">停车场地址</label>
									<input type="text" name="parking_address" value="" />
								...
								<div class="form-group">
									...
									<input type="number" name="parking_count" value="" />
