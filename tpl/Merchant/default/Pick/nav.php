<div id="navbar" class="navbar navbar-default">
	<div class="navbar-container" id="navbar-container">
		...
		<div class="navbar-header pull-left">
			<a href="{pigcms{:U('Pick/index')}" class="navbar-brand" style="padding: 5px 0 0 0;"> 
				<small> 
					<img src="{pigcms{$config.site_merchant_logo}" style="height:38px;width:38px;"/> {pigcms{$config.site_name} - 自提点管理中心
				</small>
			</a>
		</div>		
			...
			<ul class="nav ace-nav">
				...
				<li class="light-blue">
					<a data-toggle="dropdown" href="#" class="dropdown-toggle"> 
						...
						<span class="user-info"> <small>欢迎您，</small> {pigcms{$pick_address.pick_addr}</span> 
