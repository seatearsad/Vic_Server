...
<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
	...
	<tr>
		<th colspan="4">{pigcms{$config['score_name']}抵扣金额:$ {pigcms{$order.score_deducte} {pigcms{$config['score_name']}使用数量: {pigcms{$order.score_used_count}</th>
	</tr>
	<tr>
		<th colspan="4">在线支付金额:$ {pigcms{$order['payment_money']}</th>
	</tr>
	<tr>
		<th colspan="4">使用商家会员卡余额:$ {pigcms{$order['merchant_balance']}</th>
	</tr>
