								...
								<div class="topic_box">
									...
									<tbody>
										<tr>
											...
											<th>原价</th><th>现价</th><th style="display:none">限时价</th><th>库存</th>
										...
										<volist name="now_goods['list']" id="gl" key="num">
											<tr id="{pigcms{$gl['index']}">
												...
												<td style="display:none;"><input type="text" class="txt" name="seckill_prices[]" value="{pigcms{$gl['seckill_price']}" style="width:80px;"></td>
