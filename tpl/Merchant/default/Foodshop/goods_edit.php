						...
						<div class="tab-content">
							<div id="basicinfo" class="tab-pane  active">
								...
								<div class="form-group">
									...
									<span class="form_tips" style="color:red;">必点是在菜单中看不到的，用户下单是按照用餐人数来算份数，如餐具</span>
								</div>
								...
								<div class="topic_box">
									...
									<tbody>
										<tr>
											...
											<th>原价</th><th>现价</th><th style="display:none">限时价</th><th style="display:none">库存</th>
										...
										<volist name="now_goods['list']" id="gl" key="num">
											<tr id="{pigcms{$gl['index']}">
												...
												<td style="display:none"><input type="text" class="txt" name="stock_nums[]" value="{pigcms{$gl['stock_num']}" style="width:80px;"></td>
