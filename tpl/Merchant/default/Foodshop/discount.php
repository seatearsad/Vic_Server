...
<div class="main-content">
	...
	<div class="page-content">
		<div class="page-content-area">
			...
			<div class="row">
				<div class="col-xs-12">
					<a class="btn btn-success" title="新建优惠" href="{pigcms{:U('Foodshop/discount_add', array('store_id' => $store['store_id']))}">新建优惠</a>
								...
								<volist name="discount_list" id="vo">
									<tr>
										...
										<td class="button-column">
											<a style="width:80px;" class="label label-sm label-info" href="{pigcms{:U('Foodshop/discount_edit',array('store_id'=>$vo['store_id'], 'id' => $vo['id']))}">编辑</a>
										</td>
									</tr>
								</volist>
							<else/>
