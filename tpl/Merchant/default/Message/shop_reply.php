...
<div class="main-content">
	...
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			...
			<li><a href="{pigcms{:U('Message/meal_reply')}">{pigcms{$config.shop_alias_name}评论</a></li>
		</ul>
	</div>
	<!-- 内容头部 -->
								...
								<if condition="$reply_list">
									<volist name="reply_list" id="vo">
										<tr class="<if condition="$i%2 eq 0">odd<else/>even</if>">
											...
											<td><a style="width: 60px;" class="label label-sm label-info" title="评论列表" href="{pigcms{:U('Message/shop_reply_detail',array('id'=>$vo['pigcms_id']))}">评论详情</a></td>
										</tr>
									</volist>
								<else/>
