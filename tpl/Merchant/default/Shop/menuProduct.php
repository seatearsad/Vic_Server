...
<div class="main-content">
	...
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
            ...
            <li class="active"><a href="{pigcms{:U('Shop/menuCategories',array('menuId'=>$_GET['menuId'],'store_id'=>$_GET['store_id']))}">{pigcms{:L('C_CATEGORYLIST')}</a></li>
            <li class="active">{pigcms{$category.name}</li>
            <if condition="$parentProduct neq null">
                <li class="active">{pigcms{$parentProduct.name}</li>
            </if>
						...
						<table class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="button-column" style="width:60px;">PLU</th>
									<th width="80">Combo</th>
                                    <if condition="$parentProduct neq null">
                                        <th width="80">Modifiers / Bundles</th>
                                    </if>
									<th width="80">SubProducts</th>
								...
								<if condition="$products">
									<volist name="products" id="vo">
										<tr class="<if condition="$i%2 eq 0">odd<else/>even</if>">
											...
											<td class="button-column">{pigcms{$vo.plu}</td>
											<td>
                                                <if condition="$vo['isCombo'] eq 1">
                                                Yes
                                                    <else />
                                                No
                                                </if>
                                            ...
                                            <if condition="$parentProduct neq null">
                                                <td>
                                                    <if condition="$vo['isModifiers'] eq 1">
                                                        Modifier
                                                    </if>
                                                    <if condition="$vo['isBundles'] eq 1">
                                                        Bundle
                                                    </if>
                                                </td>
                                            </if>
