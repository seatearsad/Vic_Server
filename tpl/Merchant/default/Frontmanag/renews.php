		...
		<div class="page-content-area">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<button class="btn btn-success" onclick="CreateShop()">发布内容</button><span class="red">温馨提示：必需有分类才能发布成功！</span>
									...
									<volist name="introduce" id="vo">
										<tr class="<if condition="$i%2 eq 0">odd<else/>even</if>">
											...
											<td class="button-column" nowrap="nowrap">
												<a title="修改" class="green" style="padding-right:8px;" href="{pigcms{:U('Frontmanag/fbrenews',array('id'=>$vo['id']))}">
...
function CreateClassify(){
	window.location.href = "{pigcms{:U('Frontmanag/classify',array('typ'=>0))}";
}
function CreateShop(){
  window.location.href = "{pigcms{:U('Frontmanag/fbrenews')}";
}
