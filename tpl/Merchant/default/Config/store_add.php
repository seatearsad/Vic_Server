						...
						<div class="tab-content">
							<div id="basicinfo" class="tab-pane active">
								...
								<div class="form-group">
									...
									<input class="col-sm-3" maxlength="30" name="keywords" type="text" value="" id="keywords"/><span class="form_tips">选填。<font color="red">（用 | 分隔不同的关键词，最多5个）</font>，用户在微信将按此值搜索！</span> <a href="javascript:;" id="get_key_btn">按店铺名称获取</a>
								</div>
								<div class="form-group">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <input id="Config_shop_start_time" class="Config_shop_open_stop_time" type="text" value="00:00:00" name="open_1" readonly/>	至
                                            ...
                                            <td class="text-center">
                                                <input id="Config_shop_start_time_2" class="Config_shop_open_stop_time" type="text" value="00:00:00" name="open_2" readonly/>	至
                                            ...
                                            <td class="text-center">
                                                <input id="Config_shop_start_time_3" class="Config_shop_open_stop_time" type="text" value="00:00:00" name="open_3" readonly/>	至
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <input id="Config_shop_start_time_4" class="Config_shop_open_stop_time" type="text" value="00:00:00" name="open_4" readonly/>	至
                                            ...
                                            <td class="text-center">
                                                <input id="Config_shop_start_time_5" class="Config_shop_open_stop_time" type="text" value="00:00:00" name="open_5" readonly/>	至
                                            ...
                                            <td class="text-center">
                                                <input id="Config_shop_start_time_6" class="Config_shop_open_stop_time" type="text" value="00:00:00" name="open_6" readonly/>	至
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <input id="Config_shop_start_time_7" class="Config_shop_open_stop_time" type="text" value="00:00:00" name="open_7" readonly/>	至
                                            ...
                                            <td class="text-center">
                                                <input id="Config_shop_start_time_8" class="Config_shop_open_stop_time" type="text" value="00:00:00" name="open_8" readonly/>	至
                                            ...
                                            <td class="text-center">
                                                <input id="Config_shop_start_time_9" class="Config_shop_open_stop_time" type="text" value="00:00:00" name="open_9" readonly/>	至
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <input id="Config_shop_start_time_10" class="Config_shop_open_stop_time" type="text" value="00:00:00" name="open_10" readonly/>	至
                                            ...
                                            <td class="text-center">
                                                <input id="Config_shop_start_time_11" class="Config_shop_open_stop_time" type="text" value="00:00:00" name="open_11" readonly/>	至
                                            ...
                                            <td class="text-center">
                                                <input id="Config_shop_start_time_12" class="Config_shop_open_stop_time" type="text" value="00:00:00" name="open_12" readonly/>	至
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <input id="Config_shop_start_time_13" class="Config_shop_open_stop_time" type="text" value="00:00:00" name="open_13" readonly/>	至
                                            ...
                                            <td class="text-center">
                                                <input id="Config_shop_start_time_14" class="Config_shop_open_stop_time" type="text" value="00:00:00" name="open_14" readonly/>	至
                                            ...
                                            <td class="text-center">
                                                <input id="Config_shop_start_time_15" class="Config_shop_open_stop_time" type="text" value="00:00:00" name="open_15" readonly/>	至
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <input id="Config_shop_start_time_16" class="Config_shop_open_stop_time" type="text" value="00:00:00" name="open_16" readonly/>	至
                                            ...
                                            <td class="text-center">
                                                <input id="Config_shop_start_time_17" class="Config_shop_open_stop_time" type="text" value="00:00:00" name="open_17" readonly/>	至
                                            ...
                                            <td class="text-center">
                                                <input id="Config_shop_start_time_18" class="Config_shop_open_stop_time" type="text" value="00:00:00" name="open_18" readonly/>	至
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <input id="Config_shop_start_time_19" class="Config_shop_open_stop_time" type="text" value="00:00:00" name="open_19" readonly/>	至
                                            ...
                                            <td class="text-center">
                                                <input id="Config_shop_start_time_20" class="Config_shop_open_stop_time" type="text" value="00:00:00" name="open_20" readonly/>	至
                                            ...
                                            <td class="text-center">
                                                <input id="Config_shop_start_time_21" class="Config_shop_open_stop_time" type="text" value="00:00:00" name="open_21" readonly/>	至
