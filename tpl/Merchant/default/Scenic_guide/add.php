				...
				<div class="col-xs-12">
					<div class="tabbable">
						<ul class="nav nav-tabs" id="myTab">
							<li class="active">
								<a data-toggle="tab" href="#basicinfo">添加导游</a>
							</li>
						</ul>
					</div>
						...
						<div class="tab-content">
							<div id="basicinfo" class="tab-pane active">
								<div class="form-group">
									...
									<input type="text" name="guide_name" value="" />
									<span class="form_tips">必填。</span>
								</div>
								<div class="form-group">
									<label class="col-sm-1">性别</label>
									<select name="guide_gender">
										<option value="1" <if condition="$ticket['guide_gender'] eq 1">selected="selected"</if>>男</option>
										<option value="2" <if condition="$ticket['guide_gender'] eq 2">selected="selected"</if>>女</option>
									</select>
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label>年龄</label></label>
									<input type="text" name="guide_age" value="" />
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label>手机号</label></label>
									<input type="text" name="guide_phone" value="" />
									<span class="form_tips">必填。方便联系！</span>
								</div>
								<div class="form-group">
									<label class="col-sm-1"><label>向导简介</label></label>
									<textarea class="col-sm-5" rows="5" name="guide_intr"></textarea>
