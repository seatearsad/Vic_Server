...
<div class="main-content">
	...
	<div class="page-content">
		...
		<div style="display:inline-block">店铺推广佣金总额：<font color="blue">{pigcms{$all_spread_money}元</font></div>
		
		<form id="frmselect" name="frmselect" method="get" action="" style="margin-bottom:0;margin-left:13px; display:inline-block">
				<input type="hidden" name="g" value="Merchant"/>
				<input type="hidden" name="c" value="Merchant_spread_user"/>
			
				<input type="hidden" name="a" value="store_spread"/>
					...
					<div id="shopList" class="grid-view">
						<table class="table table-striped table-bordered table-hover">
							...
							<tbody>
								...
								<else/>
									<tr class="odd"><td class="button-column" colspan="4" >{pigcms{:L('NO_CONTENT_BKADMIN')}</td></tr>
								</if>
							</tbody>
						</table>
						{pigcms{$pagebar}
