							...
							<div class="tab-content">
								<div id="basicinfo" class="tab-pane active">
									<div class="form-group">
										...
										<input class="col-sm-2" size="20" name="cat_name" id="cat_name" type="text" value="{pigcms{$now_cat.cat_name}"/>
									</div>
									<div class="form-group">
										<label class="col-sm-1"><label for="cat_sort">类别排序</label></label>
										<input class="col-sm-1" size="10" name="cat_sort" id="cat_sort" type="text" value="{pigcms{$now_cat.cat_sort|default='0'}"/>
								...
								<div id="txtintro" class="tab-pane">
									<div class="form-group">
										...
										<input class="col-sm-1" size="20" name="window_info" id="window_info" type="text" value="{pigcms{$now_cat.window_info}"/>
										<span class="form_tips">例如：部分明窗，部分过道窗</span>
									</div>
									<div class="form-group">
										<label class="col-sm-1"><label for="floor_info">楼层</label></label>
										<input class="col-sm-1" size="20" name="floor_info" id="floor_info" type="text" value="{pigcms{$now_cat.floor_info}"/>
										<span class="form_tips">例如：16-18层</span>
									</div>
									<div class="form-group">
										<label class="col-sm-1"><label for="room_size">面积</label></label>
										<input class="col-sm-1" size="20" name="room_size" id="room_size" type="text" value="{pigcms{$now_cat.room_size}"/>
										<span class="form_tips">例如：15-20平米，18平米</span>
									</div>
									<div class="form-group">
										<label class="col-sm-1"><label for="bed_info">床型</label></label>
										<input class="col-sm-1" size="20" name="bed_info" id="bed_info" type="text" value="{pigcms{$now_cat.bed_info}"/>
										<span class="form_tips">例如：1.5米/2张</span>
									</div>
									<div class="form-group">
										<label class="col-sm-1"><label for="network_info">网络</label></label>
										<input class="col-sm-1" size="20" name="network_info" id="network_info" type="text" value="{pigcms{$now_cat.network_info}"/>
										<span class="form_tips">例如：无线WIFI，无线有线</span>
									</div>
									<div class="form-group">
										<label class="col-sm-1"><label for="breakfast_info">早餐</label></label>
										<input class="col-sm-1" size="20" name="breakfast_info" id="breakfast_info" type="text" value="{pigcms{$now_cat.breakfast_info}"/>
										<span class="form_tips">例如：赠送双早，赠送单早，不含早</span>
									</div>
									<div class="form-group" >
										<label class="col-sm-1">其他描述：</label>
										<textarea name="cat_info" id="cat_info" style="width:402px;height:120px;">{pigcms{$now_cat.cat_info}</textarea>
								...
								<div id="txtimage" class="tab-pane">
									...
									<div class="form-group">
										...
										<div id="upload_pic_box">
											<ul id="upload_pic_ul">
												<if condition="$now_cat['pic_arr']">
													<volist name="now_cat['pic_arr']" id="vo">
														<li class="upload_pic_li">
															<img src="./upload/trade_hotel/{pigcms{$vo}">
															<input type="hidden" name="pic[]" value="{pigcms{$now_cat['pic'][$key]}"><br>
															<a href="#" onclick="deleteImage('{pigcms{$now_cat['pic'][$key]}',this);return false;">[ 删除 ]</a>
														</li>
													</volist>
												</if>
											</ul>
