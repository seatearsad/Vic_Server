												...
												<tbody>
													<if condition="$income_list">
														<volist name="income_list" id="vo">
															<tr>
																<if condition='$vo.is_autotrophic eq 1'><td>平台自营</td><else /><td><if condition="$vo.store_id gt 0">{pigcms{$vo.store_name}</if></td></if>
																...
																<td style="font-size:12px;">
																	...
																	<elseif condition="$vo.type eq 'meal'" />
																		<a title="操作订单" class="green handle_btn" style="padding-right:8px;" href="{pigcms{:U('Merchant/Foodshop/order_detail',array('order_id'=>$vo['order_id'],'store_id'=>$vo['store_id']))}">
																			<i class="ace-icon fa fa-search bigger-130">查看详情</i>
																		</a>
																	...
																	<elseif condition="$vo.type eq 'weidian'" />
																		<a title="操作订单" class="green handle_btn" style="padding-right:8px;" href="{pigcms{:U('Orderdetail/weidain_detail',array('order_id'=>$vo['order_id'],'from'=>'bill'))}">
																			<i class="ace-icon fa fa-search bigger-130">查看详情</i>
																		</a>
																	...
																	<elseif condition="$vo.type eq 'wxapp'" />
																		<a title="操作订单" class="green handle_btn" style="padding-right:8px;" href="{pigcms{:U('Orderdetail/wxapp_detail',array('order_id'=>$vo['order_id'],'from'=>'bill'))}">
																			<i class="ace-icon fa fa-search bigger-130">查看详情</i>
																		</a>
																	...
																	<elseif condition="$vo.type eq 'store' OR $vo.type eq 'cash'" />
																		<a title="操作订单" class="green handle_btn" style="padding-right:8px;" href="{pigcms{:U('Orderdetail/store_detail',array('order_id'=>$vo['order_id'],'from'=>'bill'))}">
																			<i class="ace-icon fa fa-search bigger-130">查看详情</i>
																		</a>
												
																	<elseif condition="$vo.type eq 'withdraw'" />
																		<a title="操作订单" class="green handle_btn" style="padding-right:8px;" href="{pigcms{:U('Merchant_money/withdraw_order_info',array('id'=>$vo['order_id']))}">
																			<i class="ace-icon fa fa-search bigger-130">查看详情</i>
																		</a>
																	<elseif condition="$vo.type eq 'coupon'" />
																		<a title="操作订单" class="green handle_btn" style="padding-right:8px;" href="{pigcms{:U('Orderdetail/coupon_detail',array('order_id'=>$vo['order_id'],'mer_id'=>$mer_id))}">
																			<i class="ace-icon fa fa-search bigger-130">查看详情</i>
																		</a>
																	<elseif condition="$vo.type eq 'yydb'" />
																		<a title="操作订单" class="green handle_btn" style="padding-right:8px;" href="{pigcms{:U('Orderdetail/yydb_detail',array('order_id'=>$vo['order_id']))}">
																			<i class="ace-icon fa fa-search bigger-130">查看详情</i>
																		</a>
																	</if>
																</td>
