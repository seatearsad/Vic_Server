		...
		<div class="mainBox">
			...
			<div class="rightMain">
				<form action="{pigcms{:U('Stroe/group_list')}" method="get">
					...
					<a href="{pigcms{:U('Store/group_export',$_GET)}" class="btn btn-success" style="float:right;margin-right: 10px;">导出订单</a>
				</form>
							...
							<tbody>
								<volist name="order_list" id="vo">
									<tr class="<if condition="$i%2 eq 0">odd<else/>even</if>">
										...
										<if condition="$vo.pass_array && count($vo['pass_array'] gt 1)">
