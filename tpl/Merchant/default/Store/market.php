...
<body>
	<div class="headerBox">
		<div class="back" data-url="{pigcms{:U('shop_list')}" title="返回首页"></div>
	...
	<div class="fix card">
		...
		<div class="card_end clr">
			<div class="inbox_top clr">
				<div class="inbox fl">
					<input type="text" id="card_value" placeholder="会员号/手机" />
					<em></em>
				</div>
