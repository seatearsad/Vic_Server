		...
		<div class="mainBox">
			<div class="leftMenu">
				<ul>
					...
					<li class="urlLink cur" data-url="{pigcms{:U('allot_appoint_list')}">
							...
							<volist name="order_list" id="vo">
								<tr class="<if condition="$i%2 eq 0">odd<else/>even</if>">
									...
									<td class="button-column" width="40">
										<a title="查看订单详情"  data-title="订单详情" class="green handle_btn" style="padding-right:8px;" href="{pigcms{:U('allot_appoint_detail',array('order_id'=>$vo['order_id']))}">
											<i class="shortBtn">查看详情</i>
										</a>
									   <if condition='($vo["is_del"] eq 0) && ($vo["paid"] eq 0)'>
											<a href="javascript:void(0)" data-order-id="{pigcms{$vo['order_id']}" class="appoint_del red" style="padding-right:8px;margin-top:20px;display:block;" title="取消订单">
