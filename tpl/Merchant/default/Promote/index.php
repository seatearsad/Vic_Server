		...
		<div class="page-content-area">
			...
			<div class="row">
				<div class="form-group">
					...
					<a href="{pigcms{$config.site_url}/index.php?g=Index&c=Recognition&a=see_qrcode&type=merchant&id={pigcms{$now_merchant.mer_id}&img=1" class="see_qrcode">查看二维码</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="{pigcms{:U('content_edit')}">二维码内容自定义</a></div>
				</div>
				<div class="col-xs-12">
