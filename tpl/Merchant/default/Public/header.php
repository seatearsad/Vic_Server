...
<!--日历-->
<script type="text/javascript" src="{pigcms{$static_path}js/zlDate.js"></script>
...
<if condition="MODULE_NAME eq 'Express'">
<link rel="stylesheet" href="{pigcms{$static_path}css/freight.css" />
</if>
</head>
