...
<title>{pigcms{$config.site_name}_帮助</title>
...
<iframe marginheight="0" marginwidth="0" frameborder="0" width="100%" id="iframepage" name="iframepage" class="wt" onLoad='iFrameHeight()' src="http://o2o-service.pigcms.com/workorder/answer.php?answer_id={pigcms{$answer_id}"></iframe>
