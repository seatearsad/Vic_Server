						...
						<div class="tab-content">				
							<div id="basicinfo" class="tab-pane active">
                               ...
                               <div class="form-group">
									...
									<input class="col-sm-2" size="20" name="mobile" id="mobile" type="mobile" value="{pigcms{$worker_detail['mobile']}"/>
								</div>
								...
								<div class="tabbable">
									...
									<div class="tab-content">
										<div id="shop_time_1" class="tab-pane in active">
											<div>
												<input id="Config_shop_start_time" type="text" value="{pigcms{$worker_detail['office_time']['open']}" name="office_start_time" />	至
												<input id="Config_shop_stop_time" type="text" value="{pigcms{$worker_detail['office_time']['close']}" name="office_stop_time" />
												...
												<span class="form_tips">如果营业时间段设置为00:00-00:00，则表示24小时营业</span>
											</div>
                                    ...
                                    <!--div class="form-group">
										...
										<div class="form-group">
											...
											<input class="col-sm-1" maxlength="100" name="time_gap" type="text" value="{pigcms{$worker_detail['time_gap']}" /><span class="form_tips">预约时间间隔，单位分钟，必须是10的倍数，填写-1则显示为天数预约。</span>
										</div>
								</div>
							</div>
