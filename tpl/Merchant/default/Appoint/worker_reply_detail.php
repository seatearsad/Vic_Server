...
<div class="main-content">
	...
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			...
			<li><a href="{pigcms{:U('worker_reply')}">{pigcms{$config.appoint_alias_name}评论</a></li>
			...
			<div class="profile-user-info profile-user-info-striped">
				<div class="profile-info-row">
					...
					<div class="profile-info-value">
						<span class="editable">{pigcms{$reply_detail.id}</span>
					</div>
				</div>
				<div class="profile-info-row">
                ...
                <div class="profile-info-row">
					<div class="profile-info-name">工作人员名称</div>
					<div class="profile-info-value">
						<span class="editable">{pigcms{$reply_detail.name}</span>
					</div>
				</div>
				...
				<div class="profile-info-row">
					...
					<div class="profile-info-value">
						<span class="editable">{pigcms{$reply_detail.content}</span>
					</div>
				</div>
				<div class="profile-info-row">
				...
				<div class="profile-info-row">
					...
					<div class="profile-info-value">
						<span class="editable">{pigcms{$reply_detail.all_avg_score|intval}</span>
					</div>
				</div>
                ...
                <div class="profile-info-row">
						...
						<div class="profile-info-value">
							<span class="editable"><if condition='$reply_detail["status"] eq 0'><span class="red">未审核</span><elseif condition='$reply_detail["status"] eq 1'/><span class="green">审核通过</span><else/><span class="red">审核不通过</span></if></span>
						</div>
					</div>
                ...
                <if condition='$reply_pic_list'>
                    ...
                    <div class="profile-info-value">
                        <volist name='reply_pic_list' id='vo'>
                            <img class="see_pic" src="{pigcms{$config.site_url}{pigcms{$vo}" width="200" height="200" style=" margin-left:10px" />
                        </volist>
                    </div>
                    </div>
                </if>
						...
						<div class="col-xs-12 col-sm-6 widget-container-span" style="width:100%;margin:0px auto 20px auto;">
							<div class="widget-box">
								...
								<div class="widget-body" style="padding:20px;">
									<label><input type="radio" value="1" checked="checked" name="status">&nbsp;&nbsp;审核通过</label>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <label><input type="radio" value="2" name="status">&nbsp;&nbsp;审核不通过</label>		
								</div>
							</div>
						</div>	
