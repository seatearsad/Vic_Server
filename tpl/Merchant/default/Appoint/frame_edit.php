								...
								<div class="tabbable">
									...
									<div class="tab-content">
										<div id="shop_time_1" class="tab-pane in active">
											<div>
												<input id="Config_shop_start_time" type="text" value="{pigcms{$office_time['open']}" name="office_start_time" />&nbsp;&nbsp;至&nbsp;&nbsp;
												<input id="Config_shop_stop_time" type="text" value="{pigcms{$office_time['close']}" name="office_stop_time" />
