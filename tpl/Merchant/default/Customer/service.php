		...
		<div class="page-content-area">
			<div class="row">
				<div class="col-xs-12" style="padding-left:0px;padding-right:0px;">
					...
					&nbsp;&nbsp;&nbsp;<a class="btn btn-success" href="{pigcms{$config.site_url}/index.php?c=Impc" target="_blank">登录PC版客服中心</a>
					<div class="grid-view" style="padding-top:5px;">
						<table class="table table-striped table-bordered table-hover">
							...
							<tbody>
								...
								<else/>
									<tr class="odd"><td class="button-column" colspan="6" >暂无客服！</td></tr>
								</if>
							</tbody>
						</table>
					</div>
