...
<div class="main-content">
	...
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			...
			<li class="active">【{pigcms{$thisCard['cardname']}】的特权管理</li>
		</ul>
	</div>
	<!-- 内容头部 -->
					...
					<div class="tabbable">
						...
						<div class="tab-content">
							<div class="tab-pane active">
								<button class="btn btn-success" onclick="CreateShop()">发布会员特权</button>
												...
												<volist name="data_vip" id="list">
													<tr class="<if condition="$i%2 eq 0">odd<else/>even</if>">
														...
														<td class="button-column" nowrap="nowrap">
															<a href="{pigcms{:U('Card/useRecords', array('id'=>$thisCard['id'],'type'=>'privilege','itemid'=>$list['id']))}">使用统计</a>
															|
															<a class="green" style="padding-right:8px;" href="{pigcms{:U('Card/privilege_edit', array('itemid'=>$list['id'],'id'=>$thisCard['id']))}" ><i class="ace-icon fa fa-pencil bigger-130"></i></a>
															|
															<a title="删除" class="red" style="padding-right:8px;" href="{pigcms{:U('Card/privilege_del',array('itemid'=>$list['id'],'id'=>$thisCard['id']))}">
...
function CreateShop(){
	window.location.href = "{pigcms{:U('Card/privilege_edit', array('id' => $thisCard['id']))}";
}
