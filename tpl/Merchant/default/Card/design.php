						...
						<div class="grid-view">
							<form class="form" method="post" action="" target="_top" enctype="multipart/form-data">
								<div class="content">
									...
									<tr>
									<td colspan="2">最低{pigcms{$config['score_name']}要求：
									<input type="text" name="miniscore" id="miniscore" value="{pigcms{$card.miniscore}" class="px" style="width:100px;">  只有到达(含)这个{pigcms{$config['score_name']}后才可以申领此卡</td>
									</tr>
									<tr>
									<td colspan="2">会员卡的图标：
