		...
		<div class="page-content-area">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form action="{pigcms{:U('Group/index')}" method="get" style="float:left;margin-left:10px">
								...
								<if condition="$group_list">
									<volist name="group_list" id="vo">
										<tr class="<if condition="$i%2 eq 0">odd<else/>even</if>">
											...
											<td style="text-align:center;"><a style="width: 60px;" class="label label-sm label-info" title="评论列表" href="{pigcms{:U('Message/group_reply',array('group_id'=>$vo['group_id']))}">评论列表</a>&nbsp;&nbsp;<a style="width: 60px;" class="label label-sm label-info" title="订单列表" href="{pigcms{:U('Group/order_list',array('group_id'=>$vo['group_id']))}">订单列表</a><if condition="$config['merchant_edit_group']">&nbsp;&nbsp;<a class="label label-sm label-info" title="编辑" href="{pigcms{:U('Group/edit',array('group_id'=>$vo['group_id']))}">编辑</a></if></td>
										</tr>
									</volist>
								<else/>
