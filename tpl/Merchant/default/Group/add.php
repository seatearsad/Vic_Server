					...
					<form enctype="multipart/form-data" class="form-horizontal" method="post" id="add_form">
						<div class="tab-content">
							...
							<div id="opengroupnum" class="tab-pane">
								<label><input type="radio" name="open_pin" id="radio_open_pin" value="1" class="ace" checked="checked" ><span class="lbl" style="z-index: 1">拼团</span></label>
								<label style=" margin-left:10px;"><input type="radio" name="open_pin"  id="radio_not_pin" value="0" class="ace" ><span class="lbl" style="z-index: 1">过渡功能</span></label>
								<div id="not_pin" style="display:none;">
									<div class="form-group">
										<label  class="col-sm-1">开团人数设置：</label>
										<input class="col-sm-1" maxlength="20" name="open_num" type="num" value="" /><span class="form_tips">开团人数，0表示不限制</span>
									</div>
									<div class="form-group">
										<label  class="col-sm-1">立即开团人数设置：</label>
										<input class="col-sm-1" maxlength="20" name="open_now_num" type="num" value="" /><span class="form_tips">立即成团人数，方便商家临时调整人数，值为0时对开团人数限制没有影响</span>
									</div>
									<div class="form-group">
										<label  class="col-sm-1">组团购人数设置：</label>
										<input class="col-sm-1" maxlength="20" name="group_share_num" type="num" value="" /><span class="form_tips">组团购人数设置，组团购需要用户分享连接，0为不开启</span>
									</div>
									<div class="form-group">
										<label  class="col-sm-1">组团购退款手续费：</label>
										<input class="col-sm-1" maxlength="20" name="group_refund_fee" type="num" value="" /><span class="form_tips">手续费将按单价百分比（0-100）收取</span>
									</div>
									<div class="form-group">
