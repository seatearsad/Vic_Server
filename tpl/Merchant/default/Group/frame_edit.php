						...
						<div class="tab-content">
							...
							<div id="spread" class="tab-pane"  >
								<div class="form-group">
									...
									<input class="col-sm-1" maxlength="20" name="spread_rate" type="text" value="{pigcms{$now_group.spread_rate}" /><span class="form_tips">用户分享链接购买商品获得佣金比例（百分比 0-100）微信中分享有效！</span>
								</div>
								<if condition="$config.open_extra_price eq 0">
								<div class="form-group">
									<label class="col-sm-1">第二级用户分享佣金比例：</label>
									<input class="col-sm-1" maxlength="20" name="sub_spread_rate" type="text" value="{pigcms{$now_group.sub_spread_rate}" /><span class="form_tips">子用户（分享用户再次分享的用户）分享链接购买商品获得佣金比例（百分比 0-100）微信中分享有效！如果此值用户分享的佣金值和大于100，则取100减去用户分享的佣金值</span>
								</div>
								<div class="form-group">
									<label class="col-sm-1">第三级用户分享佣金比例：</label>
									<input class="col-sm-1" maxlength="20" name="third_spread_rate" type="text" value="{pigcms{$now_group.third_spread_rate}" /><span class="form_tips">子用户（分享用户再次分享的用户）分享链接购买商品获得佣金比例（百分比 0-100）微信中分享有效！如果此值用户分享的佣金值和大于100，则取100减去用户分享的佣金值</span>
								</div>
								</if>
							</div>
