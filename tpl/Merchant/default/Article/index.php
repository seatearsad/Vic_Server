	...
	<div class="page-content">
		<div class="page-content-area">
			<div class="row">
				<div class="col-xs-12">
					<div>
						<form action="{pigcms{:U('Article/index')}" method="get"> 
						<input type="hidden" name="c" value="Article"/>
							<input type="hidden" name="a" value="index"/>
							<input type="submit"  style="float:right;" class="btn btn-success" name="submit" value="搜索">
							<input type="text" name="search_content" style="float:right;margin-right:5px;    padding: 10px 25px;" value="">
						</form>
