...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<form id="myform" method="post" action="{pigcms{:U('Card_new/add_card_group')}" frame="true" refresh="true" autocomplete="off" onsubmit="return false;" >
		<table>
			<tr>
				<th width="15%">分组名称</th>
				<td width="85%" colspan="3"><input type="text" name="name" value="{pigcms{$now_group.name}"></td>
				<input type="hidden" name="gid" value="{pigcms{$now_group.id}">
			</tr>
			<tr>
				<th width="15%">分组注释</th>
				<td width="85%" colspan="3"><input type="text" name="des" value="{pigcms{$now_group.des}"></td>
