							...
							<tbody>
								<if condition="$coupon_list">
									<volist name="coupon_list" id="vo">
										...
										<td class="textcenter"><a href="{pigcms{:U('Card_new/edit_coupon',array('coupon_id'=>$vo['coupon_id']))}"> 编辑</a></td>
									
										</tr>
									</volist>
								<else/>
									<tr class="odd"><td class="button-column" colspan="14" >{pigcms{:L('NO_CONTENT_BKADMIN')}</td></tr>
								</if>
							</tbody>
						</table>
						{pigcms{$pagebar}
