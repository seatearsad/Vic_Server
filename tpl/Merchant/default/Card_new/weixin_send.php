								...
								<div class="widget-box">
									<div class="widget-body" id="main" style="padding:20px;height:300px;width:100%;overflow:auto">
										...
										<volist name="coupon_list" id="vo">
											<div class="radio">
												<label>
													<input class="paycheck ace store-list" type="checkbox" <if condition="in_array($vo['coupon_id'],$now_card['weixin_send_couponlist'])">checked="checked" </if>name="coupon_id[]" value="{pigcms{$vo.coupon_id}" id="coupon{pigcms{$vo.coupon_id}"/>
