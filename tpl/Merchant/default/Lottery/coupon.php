					...
					<div class="tab-content">
						<div class="grid-view">
							<form enctype="multipart/form-data" class="form-horizontal" method="post">
								...
								<div class="form-group">
									<label class="col-sm-1"><label for="long_lat"><span class="required" style="color:red;">*</span>优惠券介绍</label></label>
									<textarea  class="col-sm-3" id="sttxt" name="sttxt"  style="height:125px" >{pigcms{$lottery.sttxt}</textarea>
								...
								<div class="form-group">
									<label class="col-sm-1"><label for="info">优惠券活动说明</label></label>
								...
								<div class="form-group">
									<label class="col-sm-1"><label for="sort">兑换券使用说明</label></label>
									<textarea id="aginfo" class="col-sm-3" name="aginfo" style="height: 125px;">{pigcms{$lottery.aginfo}</textarea>
									<span class="form_tips">用户获取优惠券后显示的提示信息</span>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-1"><label for="sort"><span class="required" style="color:red;">*</span>优惠券名称1</label></label>
									<input class="col-sm-3" name="fist" id="fist" type="text" value="{pigcms{$lottery.fist}"/>
									<span class="form_tips">请不要多于50字!</span>
								</div>
								
								<div class="form-group">
									<label class="col-sm-1"><label for="sort"><span class="required" style="color:red;">*</span>优惠券数量</label></label>
									<input class="col-sm-1"  name="fistnums" id="fistnums" type="text" value="{pigcms{$lottery.fistnums}"/>
								</div>
								
								
								<div class="form-group">
									<label class="col-sm-1"><label for="sort">优惠券名称2</label></label>
									<input class="col-sm-3" name="second" id="second" type="text" value="{pigcms{$lottery.second}"/>
									<span class="form_tips">请不要多于50字!</span>
								</div>
								
								<div class="form-group">
									<label class="col-sm-1"><label for="sort">优惠券数量</label></label>
									<input class="col-sm-1"  name="secondnums" id="secondnums" type="text" value="{pigcms{$lottery.secondnums}"/>
								</div>
								
								
								<div class="form-group">
									<label class="col-sm-1"><label for="sort">优惠券名称3</label></label>
								...
								<div class="form-group">
									...
									<div class="radio">
										<label>
											...
											<span class="lbl" style="z-index: 1">不显示</span>
										</label>
										<label>
