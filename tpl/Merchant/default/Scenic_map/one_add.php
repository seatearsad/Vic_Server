...
<div class="main-content">
	...
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			...
			<li>
				<a href="{pigcms{:U('one_index',array('map_id'=>$_GET['map_id']))}">地图二级分类</a>
			</li>
				...
				<div class="col-xs-12">
					<div class="tabbable">
						<ul class="nav nav-tabs" id="myTab">
							<li class="active">
								<a data-toggle="tab" href="#basicinfo">新增二级分类</a>
							</li>
						</ul>
					</div>
...
KindEditor.ready(function(K){
	...
	$('#edit_form').submit(function(){
		$.post("{pigcms{:U('one_add')}",$('#edit_form').serialize(),function(result){
			if(result.status == 1){
				alert(result.info);
				window.location.href = "{pigcms{:U('one_index',array('map_id'=>$_GET['map_id']))}";
			}else{
				alert(result.info);
			}
		})
