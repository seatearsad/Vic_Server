	...
	clickArr['rich_text'] = function(){
		...
		content_editor = KindEditor.create(".js-editor",{
			...
			afterChange:function(){
				var ue_con = content_editor.html();
				if(ue_con != ''){
