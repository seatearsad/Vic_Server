...
$(document).ready(function(){
	...
	$('.add_table').click(function(){
		...
		header_html += '<th style="display:none">原价</th><th>进价</th><th>现价</th><th>限时价</th><th>库存</th>';
		...
		for (var e = 0; e < formathtml.length; e++) {
			header_html += '<tr id="'+format_value[e]+'"><td><input type="text" class="txt" name="numbers[]" value="" style="width:100%;"></td>' + formathtml[e] + '<td style="display:none"><input type="text" class="txt" name="old_prices[]" value="" style="width:80px;"></td><td><input type="text" class="txt" name="cost_prices[]" value="" style="width:80px;"></td><td><input type="text" class="txt" name="prices[]" value="" style="width:80px;"></td><td><input type="text" class="txt" name="seckill_prices[]" value="" style="width:80px;"></td><td><input type="text" class="txt" name="stock_nums[]" value="-1" style="width:80px;"></td>';
