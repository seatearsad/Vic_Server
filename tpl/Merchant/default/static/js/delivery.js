...
function show_edit_area_layer(){
	...
	html += '</ul></li></ul></div></div><button class="tbtn btn-wide area-editor-add-btn js-area-editor-translate">添加</button><div class="area-editor-column area-editor-column-used js-area-editor-used"><div class="area-editor"><h4 class="area-editor-head">已选省、市</h4><ul class="area-editor-list"><li><ul class="area-editor-list area-editor-depth">';
	for (var key in __alldiv){
		if(area_used_id[key] == 1){
...
function show_area_layer(){
	...
	html += '</ul></li></ul></div></div><button class="tbtn btn-wide area-editor-add-btn js-area-editor-translate">添加</button><div class="area-editor-column area-editor-column-used js-area-editor-used"><div class="area-editor"><h4 class="area-editor-head">已选省、市</h4><ul class="area-editor-list"><li><ul class="area-editor-list area-editor-depth"></ul></li></ul></div></div></div></div><div class="area-modal-foot"><button class="tbtn btn-primary btn-wide js-modal-save">确定</button>&nbsp;&nbsp;<button class="tbtn btn-wide js-modal-close">取消</button></div></div></div></div>';
	$('body').append(html);
}