...
//				show_market($('#choose_area').find('option:first').attr('value'),$('#choose_area').find('option:first').html(),1);
//				alert(result.info);
			}
			$('#choose_cityarea').removeAttr('market_id');
		});
	}
}
