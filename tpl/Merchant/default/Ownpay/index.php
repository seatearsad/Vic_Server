				...
				<div class="col-xs-12">
					<div class="tabbable">
						<ul class="nav nav-tabs" id="myTab">	
							<if condition="$hasBind && $config['pay_weixin_open'] OR 1 eq 1  ">
								<li class="active">
									<a data-toggle="tab" href="#weixin">微信支付</a>
								</li>
							</if>
							<li <if condition="!$hasBind AND !1"> class="active"</if>>
					...
					<form enctype="multipart/form-data" class="form-horizontal" method="post" id="add_form">
						<div class="tab-content">
							<if condition="$hasBind OR 1 eq 1 ">
							...
							<div id="tenpay" class="tab-pane <if condition="!$hasBind AND !1">active</if>">
								<div class="form-group">
