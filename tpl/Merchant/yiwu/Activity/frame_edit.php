						...
						<div class="grid-view">
							<form enctype="multipart/form-data" class="form-horizontal" method="post" id="add_form">
								...
								<if condition="$now_activity['type'] eq 1">
									<div id="product_price">
										<div class="form-group">
											...
											<if condition="$now_activity['status'] eq 0">
												<input class="col-sm-1" size="10" name="price" id="price" type="text" value="{pigcms{$now_activity.price}"/>
									...
									<else/>
										<div class="radio">
											...
											<label>
												...
												<span class="lbl" style="z-index: 1">无偿（{pigcms{$config['score_name']}）</span>
											</label>
										</div>
									</if>
								</div>
								...
								<div id="limit_score" <if condition="$now_activity['money'] neq 0">style="display:none;"</if>>
									<div class="form-group">
										<label class="col-sm-1"><label for="mer_score">商家{pigcms{$config['score_name']}</label></label>
										<input class="col-sm-1" size="10" name="mer_score" id="mer_score" type="text" value="{pigcms{$now_activity.mer_score}"/>
										<span class="form_tips">备注：用户消耗商家{pigcms{$config['score_name']}除以 {pigcms{$config.activity_score_scale} 的平台{pigcms{$config['score_name']} 也可参与活动</span>
									</div>
								</div>
								<div class="form-group">
