						...
						<div class="tab-content">
							...
							<div class="form-group js-show-score" >
								<label class="col-sm-2">
									<label for="phone">您当前需要扣除的{pigcms{$config['score_name']}为：<label id="js-deduct">10</label>分</label>
									<label for="phone">您当前的{pigcms{$config['score_name']}为：<label id="js-current-score">{pigcms{$now_merchant.plat_score}</label>分</label>
								</label>
							</div>
							<div class="form-group js-show-score" >
								...
								<input ytpe="text" value="{pigcms{$now_merchant.storage_indexsort}" name='' id='js-change-score'>&nbsp;&nbsp;
							...
							<input type='hidden' value='' name='changescore' id='js-change-score-less'>
