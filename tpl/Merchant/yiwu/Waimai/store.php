                            ...
                            <input type='hidden' value='{pigcms{$store_id}' name='store_id'>
                                <div class="tab-content">
                                    <div id="basicinfo" class="tab-pane active">
                                    	...
                                    	<div class="form-group">
                                                <label class="col-sm-1"><label>打包费</label></label>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <span><label><input id='deliver_type' name="deliver_type" <if condition="$store['deliver_type'] eq 0 ">checked="checked"</if> value="0" type="radio"></label>&nbsp;<span>平台配送</span>&nbsp;</span>
                                        ...
                                        <div class="form-group">
											...
											<input class="col-sm-2" size="20" readOnly="readOnly" id="name" value="{pigcms{$storeName}" type="text"/>
										</div>
                                        <div class="form-group">
											<label class="col-sm-1">关键词：</label>
											<input class="col-sm-3" maxlength="30" name="keywords" type="text" id="keywords" value="{pigcms{$keywordsStr}"/><span class="form_tips">选填。<font color="red">（用空格分隔不同的关键词，最多5个）</font>，用户在微信将按此值搜索！</span> <a href="javascript:;" id="get_key_btn">按店铺名称获取</a>
										</div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <textarea class="col-sm-5" rows="5" name="txt_info"><if condition="$store['tips']">{pigcms{$store['tips']}<else />本店欢迎您下单，为避免高峰期请提前下单，谢谢！</if></textarea>
                                        </div>
                                    </div>
                                </div>
                        </div>
