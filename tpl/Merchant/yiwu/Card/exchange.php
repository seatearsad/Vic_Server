...
<div class="main-content">
	...
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			...
			<li class="active">{pigcms{$config['score_name']}设置</li>
		</ul>
	</div>
	<!-- 内容头部 -->
						...
						<div class="grid-view">
							<form enctype="multipart/form-data" class="form-horizontal" method="post" action="">
								...
								<div class="form-group">
									...
									<span class="form_tips">{pigcms{$config['score_name']}</span>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-1"><label for="endinfo">{pigcms{$config['score_name']}规则说明：</label></label>
