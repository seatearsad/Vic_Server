...
<script type="text/javascript" src="{pigcms{$static_path}js/swiper-3.3.1.jquery.min.js?232" charset="utf-8"></script>
                        ...
                        <ul class="end_ul">
                            <li>
								...
								<volist name="coupon_list[$key]" id="vv">
                                    ...
                                    <dd >
                                        <a href="#" class="clr" date-type="{pigcms{$vv.coupon_id}" date-type="{pigcms{$vv.coupon_id}" data-wxcardid="{pigcms{$vv.wx_cardid}" data-tickettime="{pigcms{$vv.wx_ticket_addtime}" data-sign="{pigcms{$vv.cardsign}">
                                            <div class="left">
                                                <div class="top">
                                            ...
                                            <div class="right <if condition ="$vv.selected eq 1">rightAl</if>">
                                                <div class="rob">
													<if condition ="$vv.selected eq 1">
...
<script type="text/javascript">
	$(function(){
		$('dd a').click(function(event) {
			...
			if($(this).attr('data-wxcardid')!=''&&confirm('是否同步到微信卡包')){
				var cardlist = [];
				var i = 0;
