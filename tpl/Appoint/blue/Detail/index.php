				...
				<div class="navBreadCrumb cf">
					<ul class="cf">
						...
						<if condition="$now_group['store_list'][0]['area']">
							<li><span>»</span></li>
							<li><a href="{pigcms{$config.site_url}/appoint/category/{pigcms{$s_category.cat_url}/{pigcms{$now_group.store_list.0.area.area_url}">{pigcms{$now_group.store_list.0.area.area_name}</a></li>
							<li><span>»</span></li>
							<li><a href="{pigcms{$config.site_url}/appoint/category/{pigcms{$s_category.cat_url}/{pigcms{$now_group.store_list.0.circle.area_url}">{pigcms{$now_group.store_list.0.circle.area_name}</a></li>
						</if>
						<li><span>»</span></li>
					...
					<div class="appraise_list cf">
						<div class="appraise_title">
							<ul class="cf">
								...
								<li class="pinglun">
									<a class="fabiao" href="{pigcms{:U('User/Index/shop_list')}">
