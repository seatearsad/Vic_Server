        ...
        updateCartView: function() {
            ...
            function(e) {
                if (0 != t.foodCounter()) if (0 == e.code) {
                    ...
                    h.find(".boxtotalprice").html("$" + s.approximate(n.box_total_price)),
                    h.find(".shippingfee").html("$" + s.approximate(n.shipping_fee)),
                    h.find(".totalnumber").html(n.food_count),
                    h.find(".originalcost").html("$" + s.approximate(n.origin_total)),
                    h.find(".bill").html("$" + s.approximate(n.total)),
                    h.find(".margintominprice").html(s.approximate(n.marginToMinPrice)),
                    h.find(".count").html(n.food_count + "份"),
                    h.find(".price").html("$" + s.approximate(n.total)),
                    0 == n.box_total_price ? h.find(".packing-cost").addClass("hidden") : h.find(".packing-cost").removeClass("hidden");
                    var r = function(e, t) {
                        return '<div class="clearfix cc-oriange"><span class="fl">' + e + '</span><span class="fr">-$' + t + "</span></div>"
                    },
                    i = "";
