	...
	<form id="myform" method="post" action="{pigcms{:U('Systemnews/add_news')}" frame="true" refresh="true">
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			<tr>
				...
				<td><input type="text" class="input fl" name="title" size="75" placeholder="{pigcms{:L('I_TITLE')}" validate="maxlength:50,required:true"/></td>
			</tr>
            <tr>
                <th width="80">{pigcms{:L('I_SUBTITLE')}</th>
                <td><input type="text" class="input fl" name="sub_title" size="75" placeholder="{pigcms{:L('I_SUBTITLE')}" validate="maxlength:50,required:true"/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" class="input fl" name="desc" size="75" placeholder="{pigcms{:L('I_BRIEF_INTRODUCTION')}" validate="maxlength:150,required:true"/></td>
            </tr>
			<tr>
            ...
            <tr>
                ...
                <td>
                    <span class="cb-enable"><label class="cb-enable selected"><span>{pigcms{:L('I_RECOMMENDED')}</span><input type="radio" name="is_commend" value="1" checked="checked"/></label></span>
                    <span class="cb-disable"><label class="cb-disable "><span>{pigcms{:L('C_CATEGORYDIS')}</span><input type="radio" name="is_commend" value="0" /></label></span>
                </td>
            </tr>
		</table>
