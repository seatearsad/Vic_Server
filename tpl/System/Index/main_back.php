	...
	<div class="mainbox">
		...
		<div id="Profile" class="list">
			...
			<ul>
				...
				<li><span>最后登录时间:</span>{pigcms{$system_session.last_time|date='Y-m-d H:i:s',###}</li>
				<li><span>最后登录IP/地址:</span>{pigcms{$system_session.last_ip|long2ip=###} / {pigcms{$system_session.last.country} {pigcms{$system_session.last.area}</li>
				<li><span>登录次数:</span>{pigcms{$system_session.login_count}</li>
			</ul>
		</div>
