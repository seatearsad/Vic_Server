								...
								<volist name="category_list" id="vo">
									<tr>
										...
										<if condition="empty($_GET['cat_fid'])">
											...
											<td><a href="javascript:void(0);" onclick="window.top.artiframe('{pigcms{:U('category_field',array('cat_id'=>$vo['cat_id']))}','购买须知填写项',580,420,true,false,false,false,'detail',true);">购买须知填写项</a></td>
											<td><a href="javascript:void(0);" onclick="window.top.artiframe('{pigcms{:U('category_field',array('cat_id'=>$vo['cat_id']))}','管理商品属性字段',580,420,true,false,false,false,'detail',true);">商品字段管理</a></td>
										</if>
