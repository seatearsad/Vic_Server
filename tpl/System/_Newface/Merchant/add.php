                    ...
                    <div class="ibox-content">
                        <form id="myform" method="post" action="{pigcms{:U('Merchant/modify')}" frame="true" refresh="true">
                            ...
                            <div class="form-group  row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="account" size="25" placeholder="{pigcms{:L('E_MERCHANT_ACCOUNT1')}" validate="maxlength:20,required:true" tips="{pigcms{:L('E_MERCHANT_ACCOUNTDESC')}"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group  row">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" id="check_pwd" check_width="180" class="form-control" name="pwd" size="25" placeholder="{pigcms{:L('E_MERCHANT_PASSWORD1')}" validate="required:true,minlength:6" tips="{pigcms{:L('PHONE_ASSOCIATE_BKADMIN')}"/>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group  row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" check_width="180" class="form-control" name="name" size="25" placeholder="" validate="maxlength:20,required:true"/>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group  row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="phone" size="25" placeholder="{pigcms{:L('E_CONTACT_NUMBER1')}" validate="required:true" tips="{pigcms{:L('E_MERCHANT_NUMBER1DESC')}"/>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group  row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="email" size="25" placeholder="" validate="email:true" tips="{pigcms{:L('E_CONTACT_EMAILDESC')}"/>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                                ...
                                <div class="col-sm-3">
                                    <div class="switch">
                                        <div class="onoffswitch">
                                            <input name="status" type="checkbox" class="onoffswitch-checkbox" id="status_input" value="on">
