                    ...
                    <div class="ibox-content">
                        <form id="myform" method="post" action="{pigcms{:U('Merchant/store_amend')}" frame="true" refresh="true">
                            ...
                            <div class="form-group  row">
                                <label class="col-sm-3 col-form-label">{pigcms{:L('E_STORE_NAME')}</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group  row">
                                <label class="col-sm-3 col-form-label">{pigcms{:L('E_STORE_COORDINATE')}</label>
                                <div class="col-sm-9" id="choose_map" default_long_lat="{pigcms{$store.long},{pigcms{$store.lat}">

                                </div>
                            </div>
                            <div class="form-group  row">
                                <label class="col-sm-3 col-form-label">{pigcms{:L('E_STORE_LOCATION')}</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group  row">
                                <label class="col-sm-3 col-form-label">{pigcms{:L('E_STORE_ADDRESS')}</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group  row">
                                <label class="col-sm-3 col-form-label">{pigcms{:L('E_STORE_ORDER')}</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group  row">
                                <label class="col-sm-3 col-form-label">{pigcms{:L('E_DINE_IN')}</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group  row">
                                <label class="col-sm-3 col-form-label">{pigcms{:L('E_DELIVERY_FUNCTION')}</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group  row">
                                <label class="col-sm-3 col-form-label">{pigcms{:L('E_STORE_STATUS')}</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group  row">
                                <label class="col-sm-3 col-form-label">{pigcms{:L('E_TAX_PERCENTAGE')}</label>
                            ...
                            <div class="form-group  row">
                                <label class="col-sm-3 col-form-label">{pigcms{:L('_BACK_PROPORTION_')}</label>
                                <div class="col-sm-8 input-group bootstrap-touchspin bootstrap-touchspin-injected">
                            ...
                            <div class="form-group  row">
                                <label class="col-sm-3 col-form-label">{pigcms{:L('E_Default_Tax_Rate')}</label>
                                <div class="col-sm-8 input-group bootstrap-touchspin bootstrap-touchspin-injected">
                            ...
                            <div class="form-group  row">
                                <label class="col-sm-3 col-form-label">{pigcms{:L('E_SERVICE_FEE')}</label>
                                <div class="col-sm-8 input-group bootstrap-touchspin bootstrap-touchspin-injected">
