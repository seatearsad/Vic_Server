                                  ...
                                  refresh="true">
                                    ...
                                    <tr style="display: none;">
                                        ...
                                        <td><input type="text" style="width:200px;" name="img" class="input input-image"
                                                   value="{pigcms{$coupon.img}" validate="required:true" readonly>&nbsp;&nbsp;<a
                                                    href="javascript:void(0)"
                                                    class="btn btn-sm btn-success J_selectImage"
                                                    style="background: #87b87f!important;border-color: #87b87f;color:#fff;">上传图片</a>
                                        </td>
                                    ...
                                    <tr style="display: none;">
                                        ...
                                        <td><input type="text" style="width:200px;" name="wx_share_img"
                                                   class="input input-image" value="{pigcms{$coupon.wx_share_img}"
                                                   validate="required:true" readonly>&nbsp;&nbsp;<a
                                                    href="javascript:void(0)"
                                                    class="btn btn-sm btn-success J_selectImage"
                                                    style="background: #87b87f!important;border-color: #87b87f;color:#fff;">上传图片</a>
                                        </td>
                                    ...
                                    <tr style="display: none;">
                                        ...
                                        <td colspan="2">
                                            <if condition="$coupon['sync_wx'] eq 1"><span>是</span>
                                                <else/>
                                                <span>否</span></if>
                                            &nbsp;&nbsp;
                                            <a href="javascript:void(0)"
                                               onclick="window.top.artiframe('{pigcms{:U('Coupon/show')}','微信卡券示例图',300,500,true,false,false,'','show',true);"
                                               style="color:blue">微信卡券示例图</a>
                                        </td>
                                    ...
                                    <tr class="wx_coupon">
                                        ...
                                        <td colspan="2">
                                            <div id="wx_color"
                                                 style="width:30px;height:30px;background-color:{pigcms{$coupon.color}; float:left;margin-left:10px"></div>
                                        </td>
                                    ...
                                    <tr class="wx_coupon">
                                        ...
                                        <td colspan="3"><img class="mini_img" src="{pigcms{$coupon.icon_url_list}">&nbsp;&nbsp;
                                            描述 :pigcms{$coupon.abstract}
                                        </td>
                                    </tr>
                                    <tr class="wx_coupon">
                                            ...
                                            <table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
                                                <volist name="coupon.text_image_list" id="vo">
                                                    <tr class="plus textIamge">
                                                        <td width="60" style="color:red">卡券图文<label>{pigcms{$i}</label>
                                                        </td>
                                                        <td>
                                                            <table style="width:100%;border:#d5dfe8 1px solid;padding:2px;">
                                                                <tr class="textIamge">
                                                                    <td width="36" style="color:red">图片：</td>
                                                                    <td><img class="mini_img"
                                                                             src="{pigcms{$vo.image_url}"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <if condition="$coupon['allow_new'] eq 1">Yes
                                                <elseif condition="$coupon['allow_new'] eq 0"/>
                                                No
                                            </if>
                                        </td>
                                    ...
                                    <tr style="display: none;">
                                        ...
                                        <td>
                                            <textarea name="des_detial" value="" autocomplete="off"
                                                      validate="required:true">{pigcms{$coupon.des_detial}</textarea>
                                        </td>
                                        <td>每条描述请换行</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td width="85%" colspan="3">
                                            ...
                                            <input type="text" class="input fl" style="margin-left:4px;" name="num_add"
                                                   value="" autocomplete="off" validate="digits:true,min:1">{pigcms{:replace_lang_str(L('_BACK_ALREADY_CLAIM_'),$coupon['had_pull'])}
                                        </td>
                                    </tr>
                                    ...
                                    <if condition="$system_session['level'] neq 3">
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <span class="cb-enable"><label <if condition="$coupon['city_id'] eq 0">class="cb-enable selected"<else/>class="cb-enable"</if>><span>{pigcms{:L('G_UNIVERSAL')}</span><input
                                                            id="yes" type="radio" name="currency" value="1" <if
                                                            condition="$coupon['city_id'] eq 0">checked="checked"</if> /></label></span>
                                                <span class="cb-disable"><label <if condition="$coupon['city_id'] eq 0">class="cb-disable"<else/>class="cb-disable selected"</if> ><span>{pigcms{:L('G_CITY_SPECIFIC')}</span><input
                                                            id="no" type="radio" name="currency" value="2" <if
                                                            condition="$coupon['city_id'] neq 0">checked="checked"</if> /></label></span>
                                            </td>
                                        </tr>
                                        <tr id="adver_region"
                                        <if condition="$coupon['city_id'] eq 0">style="display:none;"</if>
                                        >
                                        <td width="100">{pigcms{:L('_B_PURE_MY_13_')}</td>
                                        <td colspan="2" id="choose_cityareass" province_idss=""
                                            city_idss="{pigcms{$coupon.city_id}"></td>
                                        </tr>
                                        <else/>
                                        <tr>
                                            <td width="100">{pigcms{:L('_B_PURE_MY_13_')}：</td>
                                    ...
                                    <if condition="($coupon.status eq 0) OR ($coupon.status eq 1)">
                                        <tr>
                                            ...
                                            <td>
                                                <span class="cb-enable"><label class="cb-enable <if condition=" $coupon['status'] eq 1">selected
                                    </if>
                                    "><span>{pigcms{:L('_BACK_ACTIVE_')}</span><input type="radio" name="status"
                                                                                      value="1"
                                    <if condition="$coupon['status'] eq 1">checked="checked"</if>
                                    /></label></span>
                                    <span class="cb-disable"><label class="cb-disable <if condition=" $coupon['status'] eq 0">selected</if>
                                        "><span>{pigcms{:L('_BACK_FORBID_')}</span><input type="radio" name="status"
                                                                                          value="0" <if
                                                condition="$coupon['status'] eq 0">checked="checked"</if>/></label></span>
                                    </td>
                                    </tr>
                                    </if>
                                    <tr>
