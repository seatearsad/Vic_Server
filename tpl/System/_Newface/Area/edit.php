                    ...
                    <if condition="$now_area['area_type'] eq 2">
                        ...
                        <div class="form-group  row">
                            ...
                            <div class="col-sm-7 input-group bootstrap-touchspin bootstrap-touchspin-injected">
                                <input type="text" class="touchspin2 form-control" name="delivery_service_fee" size="5" value="{pigcms{$now_area['delivery_service_fee']}" validate="required:true,number:true,maxlength:6" />
                        ...
                        <div class="form-group  row">
                            ...
                            <div class="col-sm-7 input-group bootstrap-touchspin bootstrap-touchspin-injected">
                                <input type="text" class="touchspin2 form-control" name="pickup_service_fee" size="5" value="{pigcms{$now_area['pickup_service_fee']}" validate="required:true,number:true,maxlength:6" />
                                <span class="input-group-addon bootstrap-touchspin-postfix input-group-append"><span class="input-group-text">%</span></span>
                            </div>
                        </div>
                        <div class="form-group  row">
                            ...
                            <div class="col-sm-7 input-group bootstrap-touchspin bootstrap-touchspin-injected">
                                <input type="text" class="touchspin2 form-control" name="pickup_proprotion" size="5" value="{pigcms{$now_area['pickup_proprotion']}" validate="required:true,number:true,maxlength:6" />
                                <span class="input-group-addon bootstrap-touchspin-postfix input-group-append"><span class="input-group-text">%</span></span>
                            </div>
                        </div>
                    </if>
