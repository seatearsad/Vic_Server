            ...
            <div class="col-lg-12">
                <div class="ibox">
                    <div class="ibox-content">
                        <form id="myform" method="post" action="{pigcms{:U('Deliver/bag_edit')}" frame="true"
                              refresh="true">
                            <input type="hidden" name="uid" value="{pigcms{$now_user.uid}"/>
                            <input type="hidden" name="bag_id" value="{pigcms{$now_bag.bag_id}"/>
                            <div class="form-group  row">
                                ...
                                <div class="col-sm-9"><input type="text" size="20" class="form-control"
                                                             name="bag_name"
                                                             value="{pigcms{$now_bag.bag_name}" size="25" validate="maxlength:50,required:true"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group  row">
                                ...
                                <div class="col-sm-9"><input type="text" size="20" class="form-control"
                                                             name="bag_price"
                                                             value="{pigcms{$now_bag.bag_price}" size="20" validate="maxlength:50,required:true"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group  row">
                                ...
                                <div class="col-sm-9"><input type="text" size="50" class="form-control"
                                                             name="bag_tax_rate"
                                                             value="{pigcms{$now_bag.bag_tax_rate}" size="20" validate="maxlength:50,required:true"/>
                                </div>
                            </div>
                            <div class="form-group  row">
                                <label class="col-sm-3 col-form-label">{pigcms{:L('D_COURIER_NOTES')}</label>
                                <div class="col-sm-9"><textarea name="bag_description" class="form-control">{pigcms{$now_bag.bag_description}</textarea>
                                </div>
                            </div>
