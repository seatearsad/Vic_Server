            ...
            <div class="btn-group float-right">
                ...
                <if condition="$system_session['level'] eq 2">
                    ...
                    <if condition="$system_session['level'] neq 3">
                        <a href="{pigcms{:U('Deliver/rule')}"><button class="btn btn-white text-grey">{pigcms{:L('D_DELIVERYFEE_SETTING')}</button></a>
                    </if>
                    <a href="{pigcms{:U('Deliver/map')}"><button class="btn btn-white text-grey">{pigcms{:L('_BACK_COURIER_MONI_')}</button></a>
                    <a href="{pigcms{:U('Deliver/schedule')}"><button class="btn btn-white text-grey">{pigcms{:L('_DELIVER_SCHEDULE_')}</button></a>
                </if>
