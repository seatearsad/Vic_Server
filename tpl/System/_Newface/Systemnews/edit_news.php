                    ...
                    <div class="ibox-content">
                        ...
                        <form id="myform" method="post" action="{pigcms{:U('Systemnews/edit_news')}" frame="true"
                            ...
                            <div class="form-group  row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="title" value="{pigcms{$news.title}"
                            ...
                            <div class="form-group  row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="sub_title"
                                           value="{pigcms{$news.sub_title}" size="95"
                            ...
                            <div class="form-group  row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="desc" size="200"
                                           value="{pigcms{$news.desc}" placeholder=""
                            ...
                            <div class="form-group  row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="sort" value="{pigcms{$news.sort}"
                                ...
                                <div class="col-sm-10">
                                     <span class="cb-enable"><label class="cb-enable <if condition=" $news['is_commend'] eq 1">selected</if>
                                         "><span>{pigcms{:L('I_RECOMMENDED_TOP')}</span><input type="radio"
                                                                                               name="is_commend"
                                                                                               value="1" <if
                                                 condition="$news['is_commend'] eq 1">checked="checked"</if>/></label></span>
                                    <span class="cb-disable"><label class="cb-disable <if condition=" $news['is_commend'] eq 0">selected</if>
                                        "><span>{pigcms{:L('I_RECOMMENDED_NORMAL')}</span><input type="radio"
                                                                                                 name="is_commend"
                                                                                                 value="0" <if
                                                condition="$news['is_commend'] eq 0">checked="checked"</if> /></label></span>
                                </div>
                            </div>
