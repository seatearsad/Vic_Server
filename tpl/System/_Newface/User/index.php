                            ...
                            <if condition="is_array($user_list)">
                                <volist name="user_list" id="vo">
                                    <tr>
                                        ...
                                        <td class="textcenter td_v_middle"><if condition="$vo['status'] eq 1"><span class="label label-primary">{pigcms{:L('_BACK_NORMAL_')}</span><elseif condition="$vo['status'] eq 2" /><span class="label label-warning">{pigcms{:L('_BACK_PENDING_')}</span><else /><span class="label label-warning">{pigcms{:L('_BACK_BANNED_')}</span></if></td>
                                        <td class="textcenter">
