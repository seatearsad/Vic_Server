                            ...
                            <if condition="is_array($order_list)">
                                <volist name="order_list" id="vo">
                                    <tr>
                                        ...
                                        <td class="textcenter">
                                            <a href="javascript:void(0);" onclick="window.top.artiframe('{pigcms{:U('User/order_detail',array('order_id'=>$vo['order_id']))}','{pigcms{:L(\'F_TOPUP_DETAILS\')}',800,560,true,false,false,false,'order_edit',true);"><button class="btn btn-white text-grey" type="button">{pigcms{:L('F_DETAILS')}</button></a>
                                            <a href="javascript:void(0);" onclick="window.top.artiframe('{pigcms{:U('User/edit',array('uid'=>$vo['uid']))}','{pigcms{:L(\'F_EDIT_INFO\')}',680,560,true,false,false,editbtn,'edit',true);"><button class="btn btn-white text-grey" type="button">{pigcms{:L('F_USER_INFO')}</button></a>
                                        </td>
                                    </tr>
                                </volist>
