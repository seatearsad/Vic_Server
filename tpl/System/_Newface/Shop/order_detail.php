                ...
                <div class="ibox">
                    <div class="ibox-content">
                        ...
                        <table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
                            ...
                            <if condition="$order['register_phone']">
                                <tr>
                                    <th colspan="6" style="color:red">
                                        {pigcms{:L('_BACK_REG_NUM_')}：{pigcms{$order['register_phone']}
                                    </th>
                                </tr>
                            </if>
                            ...
                            <tr>
                                <th colspan="6">
                                    {pigcms{:L('_BACK_DELIVERY_STATUS_')}：{pigcms{$order['deliver_status_str']}
                                </th>
                            </tr>
                            ...
                            <if condition="$order['deliver_user_info']">
                                <tr>
                                    <th colspan="6">
                                        {pigcms{:L('_BACK_COURIER_NICK_')}：{pigcms{$order['deliver_user_info']['name']}
                                    </th>
                                </tr>
                                <tr>
                                    <th colspan="6">
                                        {pigcms{:L('_BACK_COURIER_PHONE_')}：{pigcms{$order['deliver_user_info']['phone']}
                                    </th>
                                </tr>
                            </if>
                            <tr>
                                <th colspan="6">{pigcms{:L('_ORDER_TIME_')}：{pigcms{$order['create_time']|date="Y-m-d
                                    H:i:s",###}
                                </th>
                            </tr>
                            <if condition="$order['pay_time']">
                                <tr>
                                    <th colspan="6">
                                        {pigcms{:L('_BACK_PAY_TIME_')}：{pigcms{$order['pay_time']|date="Y-m-d
                                        H:i:s",###}
                                    </th>
                                </tr>
                            </if>
                            <if condition="$order['expect_use_time']">
                                <tr>
                                    <th colspan="6">
                                        {pigcms{:L('_EXPECTED_TIME_')}：{pigcms{$order['expect_use_time']|date="Y-m-d
                                        H:i:s",###}
                                    </th>
                                </tr>
                            </if>
                            <if condition="$order['use_time']">
                                <tr>
                                    <th colspan="6">
                                        {pigcms{:L('_BACK_ARR_TIME_')}：{pigcms{$order['use_time']|date="Y-m-d
                                        H:i:s",###}
                                    </th>
                                </tr>
                            </if>
                            <tr>
                                <th colspan="6">{pigcms{:L('_BACK_SUBTOTAL_')}：${pigcms{$order['goods_price']|floatval}
                            ...
                            <if condition="$order['packing_charge'] gt 0">
                                <tr>
                                    <th colspan="6">
                                        {pigcms{:L('_PACK_PRICE_')}：${pigcms{$order['packing_charge']|floatval}
                                    </th>
                                </tr>
                            </if>
                            <if condition="$order['freight_charge'] gt 0">
                                <tr>
                                    <th colspan="6">
                                        {pigcms{:L('_DELI_PRICE_')}：${pigcms{$order['freight_charge']|floatval}
                                    </th>
                                </tr>
                            </if>
                            <tr>
                            ...
                            <tr>
                                <th colspan="6">
                                    {pigcms{:L('_STORE_PRODUCT_DEPOSIT_')}：${pigcms{$order['deposit_price']|floatval}
                                </th>
                            </tr>
                            <tr>
                                <th colspan="6">
                            ...
                            <if condition="$order['merchant_reduce'] gt 0">
                                <tr>
                                    <th colspan="6">
                                        {pigcms{:L('_STORE_DIS_')}：${pigcms{$order['merchant_reduce']|floatval}
                                    </th>
                                </tr>
                            </if>
                            ...
                            <if condition="$order['score_used_count']">
                                ...
                                <tr>
                                    <th colspan="6">
                                        {pigcms{$config.score_name}抵现：${pigcms{$order['score_deducte']|floatval}
                                    </th>
                                </tr>
                            </if>
                            ...
                            <tr>
                                <th colspan="6">{pigcms{:L('_BACK_PAYMENT_METHOD_')}：{pigcms{$order['pay_type_str']}
                                </th>
                            </tr>
                            <tr>
                                <th colspan="6">{pigcms{:L('_BACK_ORDER_STATUS_')}：{pigcms{$order['status_str']}
                            ...
                            <tr>
                                <th colspan="6">{pigcms{:L('_NOTE_MERCHANT_')}: {pigcms{$order['desc']|default="N/A"}
                                </th>
                            </tr>
