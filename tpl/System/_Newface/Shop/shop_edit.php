...
<div id="wrapper-singlepage">
    ...
    <div id="page-wrapper-singlepage" class="white-bg">
            ...
            <div class="col-lg-12">
                <div class="ibox">
                    <div class="ibox-content">
                        <form id="myform" method="post" action="{pigcms{:U('Shop/shop_amend')}" frame="true"
                              refresh="true">
                            ...
                            <table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
                                ...
                                <tr style="height: 50px">
                                    ...
                                    <td>
                                        <select name="delivery_range_type" class="valid form-control">
                                            <option value="0"
                                            <if condition="$now_shop['delivery_range_type'] eq 0">selected</if>
                                            >{pigcms{:L('_BACK_RADIUS_')}</option>
                                ...
                                <tr style="height: 50px">
                                    ...
                                    <td><input type="text" class="form-control" name="delivery_radius"
        ...
        <script type="text/javascript" src="http://api.map.baidu.com/api?ak=4c1bb2055e24296bbaef36574877b4e2&v=2.0&s=1"
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                var s_is_open_own = $('select[name=s_is_open_own]').val(),
