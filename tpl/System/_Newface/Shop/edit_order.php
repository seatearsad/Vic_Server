                    ...
                    <div class="ibox-content">
                        ...
                        <form id="myform" method="post" action="{pigcms{:U('Shop/save_edit_order')}" frame="true"
                            ...
                            <table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
                                ...
                                <tr>
                                    <th colspan="6">{pigcms{:L('_BACK_TAX_')}：$<span id="tax_price">{pigcms{:round($order['tax_price'],2)}</span>
                                    </th>
                                </tr>
                                <tr>
                                    <th colspan="6">{pigcms{:L('_STORE_PRODUCT_DEPOSIT_')}：$<span id="deposit_price">{pigcms{$order['deposit_price']|floatval}</span>
                                    </th>
                                </tr>
                                <tr>
                                ...
                                <if condition="$order['coupon_id']">
                                    <tr>
                                        <th colspan="6">
                                            {pigcms{:L('_BACK_SYS_CON_PRICE_')}：${pigcms{$order['coupon_price']} 元
                                        </th>
                                    </tr>
                                </if>
                                <if condition="$order['pay_type'] eq 'offline' AND empty($order['third_id'])">
                                    <tr>
                                        <th colspan="6">
                                            {pigcms{:L('_BACK_PAY_OFFLINE_')}：${pigcms{$order['price']-$order['card_price']-$order['merchant_balance']-$order['balance_pay']-$order['payment_money']-$order['score_deducte']-$order['coupon_price']|floatval}元
                                        </th>
                                    </tr>
                                </if>
                                <tr>
                                    <th colspan="6">{pigcms{:L('_BACK_PAYMENT_STATUS_')}：{pigcms{$order['pay_status']}
                                    </th>
                                </tr>
                                <tr>
                                    <th colspan="6">
                                        {pigcms{:L('_BACK_PAYMENT_METHOD_')}：{pigcms{$order['pay_type_str']}
                                    </th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th colspan="6">{pigcms{:L('_NOTE_MERCHANT_')}:
                                        {pigcms{$order['desc']|default="N/A"}
                                    </th>
                                </tr>
                            </table>
