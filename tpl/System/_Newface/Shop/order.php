...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-6 float-right" style="height 90px;margin-top:40px;">
        ...
        <div class="btn-group float-right">
            <a href="{pigcms{:U('Shop/export',$_GET)}" class="button" style="float:right;margin-right: 10px;">
                <button class="btn btn-white text-grey">{pigcms{:L('_BACK_DOWN_ORDER_')}</button>
            </a>
            <if condition="$system_session['level'] eq 2">
                <a href="{pigcms{:U('Shop/export_total',$_GET)}" class="button" style="float:right;margin-right: 10px;">
                    <button class="btn btn-white text-grey ">{pigcms{:L('C_OMZB')}</button>
                </a>
                <a href="{pigcms{:U('Shop/export_store',$_GET)}" class="button" style="float:right;margin-right: 10px;">
                    <button class="btn btn-white text-grey">{pigcms{:L('C_OMRESTRANK')}</button>
                </a>
                <a href="{pigcms{:U('Shop/export_user',$_GET)}" class="button" style="float:right;margin-right: 10px;">
                    <button class="btn btn-white text-grey">{pigcms{:L('C_OMUSERRANK')}</button>
                </a>
            </if>
        </div>
    </div>
                    ...
                    <div style="height: 50px;">
                        ...
                        <div id="tool_bar" style="form-group tutti_toolbar" style="height: 80px;">
                            ...
                            <form action="{pigcms{:U('Shop/order')}" method="get" class="form-inline">
                                ...
                                <span class="tutti_fontsize_small"> {pigcms{:L('_BACK_SEARCH_')}:&nbsp; <input
                                            type="text" name="keyword" class="form-control"
                                            value="{pigcms{$_GET['keyword']}" style="width: 120px;font-size:12px;"/>&nbsp;
                                        <select name="searchtype" class="form-control">
                                            <option value="real_orderid" <if
                                                    condition="$_GET['searchtype'] eq 'real_orderid'">selected="selected" </if> >{pigcms{:L('_BACK_ORDER_NUM_')}</option>
                                        ...
                                        <if condition="$system_session['level'] neq 3">
                                            ...
                                            <select name="city_id" id="city_id" class="form-control">
                                                ...
                                                <volist name="city" id="vo">
                                                    <option value="{pigcms{$vo.area_id}" <if
                                                            condition="$city_id eq $vo['area_id']">selected="selected"</if>>{pigcms{$vo.area_name}</option>
                                                </volist>
                                            </select>
                                        </if>&nbsp;&nbsp;
                                            ...
                                            <div class="float-right">
                                                <if condition="$vo.status eq 0 AND $vo.paid eq 1">
                                                    <a data-href="{pigcms{:U('Shop/refund_update',array('order_id'=>$vo['order_id']))}"
                                                       class="refund">
                                                        <button class="btn btn-white text-grey btn-xs" type="button">
                                                            {pigcms{:L('_BACK_MANUAL_REFUND_')}
                                                        </button>
                                                    </a>
                                                </if>
