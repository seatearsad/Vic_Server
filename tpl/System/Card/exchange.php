			...
			<form id="myform" method="post" action="" refresh="true" enctype="multipart/form-data" >
				<table cellpadding="0" cellspacing="0" class="table_form" width="100%">
					<tr>
						...
						<td>{pigcms{$config['score_name']}设置</td>
					</tr>
					<tr>
						<td width="100">每天签到奖励：</td>
						<td><input type="text" class="input-text" name="everyday" value="{pigcms{$exchange.everyday}"/>{pigcms{$config['score_name']}</td>
					</tr>
					<tr>
						<td>消费1元奖励：</td>
						<td>
							<input type="text" class="input-text" id="reward" value="{pigcms{$exchange.reward}" name="reward">{pigcms{$config['score_name']}
						</td>
					</tr>
					<tr>
						<td valign="top">{pigcms{$config['score_name']}规则说明：</td>
						<td>
