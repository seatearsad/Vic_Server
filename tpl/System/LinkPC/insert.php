...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/tpl/Merchant/default/static/css/style.css" />
	<link rel="stylesheet" type="text/css" href="/tpl/Merchant/default/static/css/cymain.css" />
	
	<script type="text/javascript" src="/tpl/Merchant/default/static/js/common.js"></script>
	<script type="text/javascript" src="/tpl/Merchant/default/static/js/jquery.min.js"></script>
...
<body style="background:#fff;padding:20px 20px;">
	...
	<ul class="modules">
		...
		<li>
			...
			<div class="mright">
				<if condition="$m['sub']"><a href="<?php if (!$m['linkurl']){ echo '?g=System&c=LinkPC&a=' . $m['module'] . '&iskeyword=' . intval($_GET['iskeyword']); }else{ echo $m['linkurl'];}?>">详细</a></if>
