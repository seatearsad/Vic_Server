		...
		<div class="mainbox">
			<div id="nav" class="mainnav_title">
				<ul>
						...
						<a href="javascript:void(0);" onclick="window.top.artiframe('{pigcms{:U('news_add')}','添加新闻',1000,640,true,false,false,addbtn,'add',true);">添加新闻</a>
				</ul>
			</div>
							...
							<if condition="$list['list']">
								<volist name="list['list']" id="vo">
									<tr>
										...
										<td class="textcenter"><a href="javascript:void(0);" onclick="window.top.artiframe('{pigcms{:U('Appoint/news_edit',array('id'=>$vo['id']))}','编辑新闻信息',1000,640,true,false,false,editbtn,'add',true);">编辑</a> | <a href="javascript:void(0);" class="delete_row" parameter="id={pigcms{$vo.id}" url="{pigcms{:U('news_del')}">删除</a>
                                         </td>
									</tr>
								</volist>
