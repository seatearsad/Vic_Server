								...
								<volist name="category_list" id="vo">
									<tr>
                                        ...
                                        <td><if condition='$vo["is_autotrophic"] eq 1'><font color="green">平台自营</font>&nbsp;&nbsp;&nbsp;
                                         <a href="javascript:void(0);" onclick="window.top.artiframe('{pigcms{:U('Appoint/pc_cat_edit',array('cat_id'=>$vo['cat_id']))}','PC端编辑',1000,640,true,false,false,editbtn,'add',true);">PC端编辑</a>&nbsp;|&nbsp;<a href="javascript:void(0);" onclick="window.top.artiframe('{pigcms{:U('Appoint/wap_cat_edit',array('cat_id'=>$vo['cat_id']))}','WAP端编辑',1000,640,true,false,false,editbtn,'add',true);">WAP端编辑</a>
