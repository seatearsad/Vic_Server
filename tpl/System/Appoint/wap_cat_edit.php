...
$(document).ready(function() {
		...
		function plus(){
			...
			if(No>10){
				...
				var shtml ='<tr class="wap_title_'+No+'"><td width="60">标题：</td><td><input type="text" style="width:200px;" class="input" name="wap_title[]"  value="" /></td></td><tr/><tr class="plus" data-num="'+No+'"><td width="40">内容</label></td><td><table style="width:100%;border:#d5dfe8 1px solid;padding:2px;"><tr><td><textarea  style="width:200px;height:60px" class="input" name="wap_content[]" id="wap_content'+No+'" ></textarea></td><td rowspan="2" class="delete"><a href="javascript:void(0)" onclick="del(this)"><img style="width:30px;height:30px;" src="{pigcms{$static_path}images/del.jpg"/></a></td></tr></table></td></tr>';
				
				item.after(shtml);
				get_KindEditor('wap_content'+No);
			}
		}
		function del(obj){
			if($('.plus').length<=1){
    ...
    <if condition='!$detail["wap_content"]'>
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
        	<tr class="wap_title_0">
                <td width="60">标题：</td>
                <td><input type="text" style="width:200px;" class="input" name="wap_title[]"  value="" /></td>
                </td>
			<tr/>
			...
			<tr class="plus" data-num='0'>
				...
				<td>
					<table style="width:100%;border:#d5dfe8 1px solid;padding:2px;">
						<tr>
							<td><textarea  style="width:200px;height:60px" class="input" name="wap_content[]" id="wap_content0" ></textarea></td>
       ...
       <table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
       		...
       		<volist name='detail["wap_content"]' id='vo'>
            	<tr class="wap_title_{pigcms{$key+1}">
                    <td width="60">标题：</td>
                    <td><input type="text" style="width:200px;" class="input" name="wap_title[]"  value="{pigcms{$detail['wap_title'][$key]}" /></td>
                    </td>
				<tr/>
                ...
                <tr class="plus" data-num="{pigcms{$key+1}">
                    ...
                    <td>
                        <table style="width:100%;border:#d5dfe8 1px solid;padding:2px;">
                            <tr>
                                <td><textarea  style="width:200px;height:60px" class="input" name="wap_content[]" id="wap_content{pigcms{$key+1}" >{pigcms{$vo}</textarea></td>
                                <td rowspan="2" class="delete">
                                    <a href="javascript:void(0)" onclick="del(this)"><img style="width:30px;height:30px;" src="{pigcms{$static_path}images/del.jpg"/></a>
                                </td>
                            </tr>
