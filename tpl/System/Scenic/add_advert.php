<include file="Public:header"/>
	<form id="myform" method="post" action="{pigcms{:U('add_advert')}" frame="true" refresh="true" autocomplete="off">
		<input type="hidden" name="cat_id" value="{pigcms{$_GET['cat_id']}"/>
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			<tr>
				<th width="15%">标题</th>
				<td width="85%" colspan="3"><input type="text" class="input fl" name="advert_title" size="40" validate="maxlength:50,required:true"/></td>
			<tr/>
			<tr>
				<th width="15%">排序</th>
				<td width="85%" colspan="3"><input type="text" class="input fl" name="sort" size="10" value="0" validate="maxlength:50,required:true"/>&nbsp;&nbsp;值越大，越靠前</td>
			<tr/>
			<tr>
				<th width="15%">通用广告</th>
			...
			<tr>
				<th width="15%">状态</th>
				<td width="35%" class="radio_box">
					<span class="cb-enable"><label class="cb-enable selected"><span>开启</span><input type="radio" name="advert_status" value="1" checked="checked"/></label></span>
					<span class="cb-disable"><label class="cb-disable"><span>关闭</span><input type="radio" name="advert_status" value="2"/></label></span>
				</td>
			</tr>
			<tr>
				<th width="15%">图片</th>
				<td width="85%" colspan="3">
				    <input type="hidden" name="advert_img" value=""/>
			...
			<tr>
				<th width="80">链接地址</th>
				<td>
					<input type="text" class="input fl" name="advert_url" id="advert_url" style="width:200px;" placeholder="请填写链接地址" validate="maxlength:200,required:true,url:true"/>
