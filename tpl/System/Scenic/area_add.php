<include file="Public:header"/>
	<form id="myform" method="post" action="{pigcms{:U('area_modify')}" frame="true" refresh="true">
		...
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			...
			<tr>
				...
				<tr>
					<th width="80">国外</th>
					<td>
						<span class="cb-enable"><label class="cb-enable selected"><span>国外</span><input type="radio" name="is_abroad" value="1" checked="checked" /></label></span>
						<span class="cb-disable"><label class="cb-disable"><span>国内</span><input type="radio" name="is_abroad" value="2" /></label></span>
					</td>
				</tr>
		</table>
