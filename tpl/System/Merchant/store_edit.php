<include file="Public:header"/>
	<form id="myform" method="post" action="{pigcms{:U('Merchant/store_amend')}" frame="true" refresh="true">
		...
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			...
			<tr>
				<th width="120">{pigcms{:L('E_STORE_COORDINATE')}</th>
				<td id="choose_map" default_long_lat="{pigcms{$store.long},{pigcms{$store.lat}"></td>
			</tr>
			<tr>
				<th width="120">{pigcms{:L('E_STORE_LOCATION')}</th>
			...
			<tr>
				<th width="120">{pigcms{:L('E_STORE_ADDRESS')}</th>
			...
			<tr>
				<th width="120">{pigcms{:L('E_STORE_ORDER')}</th>
			...
			<tr>
				<th width="120">{pigcms{:L('E_DINE_IN')}</th>
				<td>
			...
			<!--tr>
				<th width="120">{pigcms{:L('_BACK_LUNCH_')}</th>
				<td>
			...
			<tr>
				<th width="120">{pigcms{:L('E_DELIVERY_FUNCTION')}</th>
				<td>
			...
			<if condition="$config['store_open_waimai']">
				<tr>
					<th width="120">{pigcms{$config.waimai_alias_name}功能</th>
					<td>
			...
			<tr>
				<th width="120">{pigcms{:L('E_STORE_STATUS')}</th>
				<td>
            ...
            <tr>
                <th width="120">{pigcms{:L('BASE_ENCRYPTION')}</th>
                <td>
            ...
            <tr>
                <th width="120">{pigcms{:L('E_TAX_PERCENTAGE')}</th>
            ...
            <tr>
                <th width="120">{pigcms{:L('_BACK_PROPORTION_')}</th>
            ...
            <tr>
                <th width="120">{pigcms{:L('E_Default_Tax_Rate')}</th>
            ...
            <tr>
                <th width="120">{pigcms{:L('E_SERVICE_FEE')}</th>
