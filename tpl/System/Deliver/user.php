							...
							<if condition="is_array($user_list)">
								<volist name="user_list" id="vo">
									<tr>
										...
										<a href="javascript:void(0);" onclick="window.top.artiframe('{pigcms{:U('Deliver/user_edit',array('uid'=>$vo['uid']))}','编辑用户信息',680,560,true,false,false,editbtn,'edit',true);">编辑</a>
										</td>
									</tr>
								</volist>
