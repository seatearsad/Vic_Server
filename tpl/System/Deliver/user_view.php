	...
	<form id="myform" method="post" action="{pigcms{:U('Deliver/user_view')}" frame="true" refresh="true">
		...
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
            ...
            <tr>
                ...
                <td colspan=3>
                    <span class="cb-enable"><label class="cb-enable"><span>{pigcms{:L('_BACK_PASS_REVIEW_')}</span><input type="radio" name="review" value="1"  /></label></span>
                    <span class="cb-disable"><label class="cb-disable selected"><span>{pigcms{:L('_BACK_NO_PASS_REVIEW_')}</span><input type="radio" name="review" value="0" checked="checked"/></label></span>
                </td>
            </tr>
