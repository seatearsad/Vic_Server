	...
	<form id="myform" method="post" action="{pigcms{:U('Footer/amend')}" frame="true" refresh="true">
		...
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			...
			<tr>
				...
				<td><input type="text" class="input fl" name="url" id="url" value="{pigcms{$now_link.url}" size="60" validate="maxlength:200" tips=""/><a href="#modal-table" class="btn btn-sm btn-success" onclick="addLink('url', 0, 1)" data-toggle="modal"> </a>
					</td>
			</tr>
			<tr>
