					...
					<tr>
						...
						<td>
							...
							<php> }else{</php>
							 ...
							 <input type="text" class="input-text" name="<php>echo $_GET['type'].'_percent';</php>" id="percent" value="<php> echo $config[$_GET['type'].'_percent'];</php>" size="10" validate="number:true,max:100" tips="抽成比例（按百分比，不要填写%，填-1 则跳过当前业务设置）" <php>if($config[$_GET['type'].'_percent']<0||$config[$_GET['type'].'_percent']==''){</php>style="display:none"<php>}</php>/>
