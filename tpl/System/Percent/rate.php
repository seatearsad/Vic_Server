			  ...
			  <td>
				<span class="cb-enable">
					<label class="cb-enable  <php>if(C('config.activity_rate')>=0&&C('config.activity_rate')!=""){</php>selected<php>}</php>">
						<span>设置</span>
						<input type="radio" name="open_group_rate" value="1" <php>if(C('config.activity_rate')>=0&&C('config.activity_rate')!=""){</php>checked="checked"<php>}</php>/>
					</label>
				</span>			     
				<span class="cb-disable">
					<label class="cb-disable  <php>if(C('config.activity_rate')<0||C('config.activity_rate')==""){</php>selected<php>}</php>">
						<span>跳过</span>
						<input type="radio" name="open_group_rate" value="0" <php>if(C('config.activity_rate')<0||C('config.activity_rate')==""){</php>checked="checked"<php>}</php>/>
					</label>
				</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
