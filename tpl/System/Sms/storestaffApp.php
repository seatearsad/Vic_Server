...
<div class="mainbox">
    <div id="nav" class="mainnav_title"><ul><a href="{pigcms{:U('Sms/mobileApp')}" >平台APP版本配置</a>
			<a href="{pigcms{:U('Sms/storestaffApp')}" class="on">店员APP版本配置</a>
			<a href="{pigcms{:U('Sms/merchantApp')}" >商家中心APP版本配置</a>
			<a href="{pigcms{:U('Sms/deliverApp')}" >配送员APP版本配置</a></ul></div>
    <form method="post" action="{pigcms{:U('System/Sms/storestaffApp')}">
        <table cellpadding="0" cellspacing="0" class="table_form" width="100%" style="" >
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="input-text" name="android_version" id="storestaff_android_version" value="{pigcms{$staff_android_v}" size="60" validate="required:true" tips="请填写当前Android版本名称">
                </td>
            </tr>
            <tr>
                <th width="160">Android版本号：</th>
                <td>
                    <input type="text" class="input-text" name="android_version_code" id="storestaff_android_version_code" value="{pigcms{$staff_android_vcode}" size="60" validate="required:true" tips="请填写当前Android版本号">
                </td>
            </tr>
            <tr>
                <th width="160">Android版本描述：</th>
                <td><textarea name="android_version_desc" style="width:480px;height:160px;" id="storestaff_android_version_desc">{pigcms{$staff_android_vdesc}</textarea></td>
            </tr>
            <tr>
                <th width="160">Android下载地址：</th>
                <td><!--validate="required:true"-->
                    <input type="text" class="input-text" name="android_download_url" id="storestaff_android_download_url" value="{pigcms{$staff_android_url}" size="60" validate="required:true" tips="Android下载地址">
                </td>
            </tr>
            </tbody>
        </table>
