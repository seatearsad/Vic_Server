...
<div class="mainbox">
    <div id="nav" class="mainnav_title">
		<ul>
			...
			<a href="{pigcms{:U('Sms/deliverApp')}"  class="on">配送员APP版本配置</a>
		</ul>
	</div>
    <form method="post" action="{pigcms{:U('System/Sms/deliverApp')}">
        <table cellpadding="0" cellspacing="0" class="table_form" width="100%" style="" >
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="input-text" name="android_version" id="deliver_android_version" value="{pigcms{$deliver_android_version}" size="60" validate="required:true" tips="请填写当前Android版本名称">
                </td>
            </tr>
            <tr>
                <th width="160">Android版本号：</th>
                <td>
                    <input type="text" class="input-text" name="android_version_code" id="deliver_android_version_code" value="{pigcms{$deliver_android_vcode}" size="60" validate="required:true" tips="请填写当前Android版本号">
                </td>
            </tr>
            <tr>
                <th width="160">Android版本描述：</th>
                <td><textarea name="android_version_desc" style="width:480px;height:160px;" id="deliver_android_version_desc">{pigcms{$deliver_android_vdes}</textarea></td>
            </tr>
            <tr>
                <th width="160">Android下载地址：</th>
                <td><!--validate="required:true"-->
                    <input type="text" class="input-text" name="android_download_url" id="deliver_android_download_url" value="{pigcms{$deliver_android_url}" size="60" validate="required:true" tips="Android下载地址">
                </td>
            </tr>
            </tbody>
        </table>
