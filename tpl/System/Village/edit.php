...
<form id="myform" method="post" action="{pigcms{:U('Village/update')}" >
	<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
		...
		<tr>
			<th width="80">城市</th>
			<td id="choose_cityarea" circle_id="{pigcms{$info.circle_id}" area_id="{pigcms{$info.area_id}" province_id="{pigcms{$info.province_id}" city_id="{pigcms{$info.city_id}"></td>
		</tr>
		...
		<tr>
			<td width="80">小区名称</td>
			<td>
				<input type="text" class="input fl" name="name" value="{pigcms{$info.name}" placeholder="小区名称" validate="required:true"></td>
		</tr>
		...
		<tr>
			<td width="80">详细地址</td>
			<td>
				<input type="text" class="input fl" name="address" value="{pigcms{$info.address}" placeholder="" validate="required:true"></td>
		</tr>

		<tr>
			<th width="80">小区坐标经纬度</th>
		...
		<tr>
			...
			<td>
				<input type="text" class="input fl" name="administrator" value="{pigcms{$info.administrator}" placeholder="物业公司名称" validate="required:true"></td>
		</tr>

		<tr>
			<td width="80">物业公司电话</td>
			<td>
				<input type="text" class="input fl" name="administrator_tel" value="{pigcms{$info.administrator_tel}" placeholder="物业公司电话" validate="required:true"></td>
		</tr>
		...
		<tr>
			<td width="80">物业费</td>
			<td><input type="text" class="input fl" name="property_price" value="{pigcms{$info.property_price}" placeholder="物业费"></td>
		</tr>

		<tr>
			<td width="80">物业类型</td>
			<td><input type="text" class="input fl" name="property_type" value="{pigcms{$info.property_type}" placeholder="物业类型"></td>
		</tr>
		<tr>
			<td width="80">建筑年代</td>
			<td><input type="text" class="input fl" name="building_age" value="{pigcms{$info.building_age}" placeholder="建筑年代"></td>
		</tr>

		<tr>
			<td width="80">小区均价</td>
			<td><input type="text" class="input fl" name="average_price" value="{pigcms{$info.average_price}" placeholder="小区均价"></td>
		</tr>

		<tr>
			<td width="80">开发商</td>
			<td>
				<input type="text" class="input fl" name="developers" value="{pigcms{$info.developers}" placeholder="开发商"></td>
		</tr>

		<tr>
			<td width="80">列表图片</td>
			<td><input type="text" class="input fl" name="list_img" value="{pigcms{$info.list_img}" id="listImg" placeholder="图片地址" style=" width: 350px;"><a href="javascript:void(0)" class="button" id="image3">浏览</a></td>
		</tr>
