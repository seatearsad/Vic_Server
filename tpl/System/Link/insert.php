...
ul.modules li div.mleft{float:left;width:50%}
ul.modules li div.mright{float:right;width:48%;text-align:right;}
</style>
</head>
...
<div class="mright">
<if condition="$m['sub']"><a href="<?php if (!$m['linkurl']){?>?g=System&c=Link&a={pigcms{$m.module}&iskeyword=<?php echo intval($_GET['iskeyword']);?><?php }else{echo $m['linkurl'];}?>">详情</a></if>
