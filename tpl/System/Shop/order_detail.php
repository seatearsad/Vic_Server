...
<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
	...
	<tr>
		<th colspan="6">{pigcms{:L('_BACK_ACT_AM_PAID_')}：${pigcms{$order['price']+$order['tip_charge']-$order['coupon_price']-$order['merchant_reduce']-$order['delivery_discount']|floatval} </th>
	</tr>
