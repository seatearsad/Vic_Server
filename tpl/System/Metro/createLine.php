...
<form id="myform" method="post" action="{pigcms{:U('Metro/saveLine')}" >
	<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
		...
		<tr>
			<td width="80">线路名称</td>
			<td>
				<input type="text" class="input fl" name="name" value="" placeholder="请填写一个线路名" validate="required:true"></td>
		</tr>
			...
			<td class="radio_box">
				...
				<span class="cb-disable">
					<label class="cb-disable">
						<span>不推荐</span>
						<input type="radio" name="is_hot" value="0"></label>
				</span>
			</td>
		</tr>
		...
		<tr>
			<td width="80">排序</td>
			<td>
				<input type="text" class="input fl" name="sort" value="0" placeholder="请填写一个数值" validate="number:true"></td>
		</tr>
