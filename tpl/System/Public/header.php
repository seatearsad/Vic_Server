...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Tutti Management Site</title>
		<script type="text/javascript">
            ...
            var  meal_alias_name = "{pigcms{$config.meal_alias_name}",parentShowHelpParam = [],parentShowIndex = false,choose_provincess="{pigcms{:U('Adver/ajax_province')}",choose_cityss="{pigcms{:U('Adver/ajax_city')}";
		</script>
