			...
			<form method="post" action="__SELF__" refresh="true" enctype="multipart/form-data" >
				<table cellpadding="0" cellspacing="0" class="table_form" width="100%">
					...
					<tr>
						...
						<span class="form_tips">第一张将作为列表页图片展示！最多上传5个图片！建议尺寸：300*200</span></td>
					</tr>
					<tr>
						<th width="100">图片预览</th>
						<td id="upload_pic_box">
					...
					<tr>
						<th width="80">规格</th>
						<td>
						<textarea rows="6" cols="104" name="specification">
							{pigcms{$detail["specification"]}
						</textarea><span style="color:red">&nbsp;&nbsp;*&nbsp;&nbsp;以回车换行进行分割</span></td>
					</tr>
