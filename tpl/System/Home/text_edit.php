		...
		<div class="mainbox">
			<div id="nav" class="mainnav_title">
				<ul>
					...
					<a href="{pigcms{:U('Home/other_edit',array('id'=>$info['id']))}">编辑图文关键词回复</a>
					<a href="{pigcms{:U('Home/text_edit',array('id'=>$info['id']))}" class="on">编辑文本关键词回复</a>
				</ul>
			</div>
			<form method="post" action="" refresh="true" enctype="multipart/form-data" >
				<table cellpadding="0" cellspacing="0" class="table_form" width="100%">
					<tr>
						<th width="80">关键词</th>
						<td>
						<input type="text" class="input-text" name="key" size="20" placeholder="关键词" validate="maxlength:20,required:true" value="{pigcms{$info.key}"/><span style="color: red;">相同的关键词使用最后一次修改的</span>
