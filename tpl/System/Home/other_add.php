		...
		<div class="mainbox">
			<div id="nav" class="mainnav_title">
				<ul>
					...
					<a href="{pigcms{:U('Home/other_add')}" class="on">添加图文关键词回复</a>
					<a href="{pigcms{:U('Home/text_add')}" >添加文本关键词回复</a>
				</ul>
			</div>
			<form method="post" action="" refresh="true" enctype="multipart/form-data" >
				<table cellpadding="0" cellspacing="0" class="table_form" width="100%">
					<tr>
						<th width="80">关键词</th>
						<td><input type="text" class="input-text" name="key" size="20" placeholder="关键词" validate="maxlength:20,required:true" value="{pigcms{$info.key}"/><span style="color: red;">使用相同的关键词可以实现多图文</span></td>
					</tr>
					<tr>
						<th width="80">回复标题</th>
					...
					<tr>
						<th width="80">回复图片</th>
						<td>
							<input type="file" class="input-text" name="pic" id="pic" value="{pigcms{$info.p}"/>
						</td>
					</tr>
