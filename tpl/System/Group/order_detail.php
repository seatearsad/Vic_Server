	...
	<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
		...
		<tr>
			...
			<td width="35%">
				...
				<if condition="$now_order['status'] eq 0 AND $now_order['paid'] eq 1"><a href="javascript:void(0)" onclick="refund_confirm();"><font color="blue">手动退款</font></a></if>
			</td>
		</tr>
		<tr>
			<th width="15%">数量</th>
		...
		<if condition="$now_order['third_id'] eq '0' AND $now_order['pay_type'] eq 'offline'">
			<tr>
				<th width="15%">线下支付</th>
				<th width="85%" colspan="3">总金额${pigcms{$now_order['total_money']}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;平台余额支付{pigcms{$now_order.balance_pay}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;使用商家会员卡余额 ${pigcms{$now_order.merchant_balance}<br>
				<if condition="$now_order['wx_cheap'] neq '0.00'">微信优惠 ${pigcms{$now_order['wx_cheap']}<br></if>
				<br>{pigcms{$config.score_name}抵扣金额 ${pigcms{$now_order.score_deducte}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{pigcms{$config.score_name}使用数量 {pigcms{$now_order.score_used_count}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<if condition="$system_coupon">
		...
		<else />
			<tr>
				<th width="15%">支付方式</th>
				<th width="85%" colspan="3">余额支付金额 ${pigcms{$now_order.balance_pay}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;在线支付金额 ${pigcms{$now_order.payment_money}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;使用商家会员卡余额 ${pigcms{$now_order.merchant_balance}
				<br>{pigcms{$config.score_name}抵扣金额 ${pigcms{$now_order.score_deducte}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{pigcms{$config.score_name}使用数量 {pigcms{$now_order.score_used_count}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<if condition="$system_coupon">
					平台优惠券抵扣金额:$ {pigcms{$system_coupon.price}
					<elseif condition="$card" />
					商家优惠券抵扣金额:$ {pigcms{$card.price}
