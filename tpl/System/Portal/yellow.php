					...
					<table width="100%" cellspacing="0">
						...
						<tbody>
							...
							<tr>
								...
								<a href="{pigcms{:U('Portal/yellow_add',array('yid'=>$vo['id']))}">编辑</a> | <a href="javascript:void(0);" class="delete_row" parameter="yid={pigcms{$vo.id}" url="{pigcms{:U('Portal/yellow_del')}">删除</a></td>
							</tr>
							</volist>
