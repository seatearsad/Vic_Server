	...
	<div class="container">
		...
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			...
			<tr>
				<th width="80">位置</th>
				<td>
					<div><span><a href="javascript:;" onclick="get_map_lnglat()" id="lbs_baidu">在地图上标注位置<if condition="$Yellow_detail.lng neq ''"><span style="color:green;">【定位成功】</span></if></a></span></div>
...
<script type="text/javascript">
	...
	function get_map_lnglat(){
		index_layer = layer.open({
			...
			offset:'100px',
			area: ['680px', '600px'],
			content: "{pigcms{:U('Portal/yellow_baidu_map')}"
		});
	}
	...
	function setlnglat(lng,lat){
		...
		$('#lbs_baidu').html($('#lbs_baidu').text()+'<span style="color:green;">【定位成功】</span>');
	}
