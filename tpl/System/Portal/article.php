					...
					<table width="100%" cellspacing="0">
						<thead>
							<tr>
								...
								<th class="textcenter">父级分类</th>
								<th class="textcenter">缩略图</th>
								<th class="textcenter">查看量</th>
								<th class="textcenter">时间</th>
								<th class="textcenter">状态</th>
								<th class="textcenter">特别推荐</th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="textcenter"><if condition="$vo['thumb'] neq ''">有<else/>无</if></td>
								...
								<td class="textcenter"><a href="javascript:void(0);" onclick="window.top.artiframe('{pigcms{:U('Portal/article_add',array('aid'=>$vo['aid']))}','编辑资讯',780,450,true,false,false,editbtn,'add',true);">编辑</a> | <a href="javascript:void(0);" class="delete_row" parameter="aid={pigcms{$vo.aid}" url="{pigcms{:U('Portal/article_del')}">删除</a></td>
							</tr>
							</volist>
