				...
				<div class="main_wrap cf">
					...
					<div class="main_wrap_right">
						<ul class="songcan_data clearfix">
							...
							<li class="renjun"> <span>起送价</span> <strong>$ <em><span id="shipmoney1">{pigcms{:floatval($store['basic_price'])}</span></em></strong> </li>
							<li class="peison"> <span>配送费</span> <strong>$ <em class="psfee_">{pigcms{:floatval($store['delivery_fee'])}</em></strong> </li>
						</ul>
					</div>
				</div>
			</div>
