					            	...
					            	<div class="table-section summary-table">
					                    <table cellspacing="0" class="buy-table" id="menu_list">
											...
											<tr>
												...
												<td class="money J-deal-buy-price">$<span id="deal-buy-price">{pigcms{:floatval($food['price'])}</span></td>
											...
											<tr>
											 ...
											 <else />
												...
												<div>
												<strong>满${pigcms{:floatval($full_money)}减</strong>：<span class="inline-block money">-<strong id="deal-buy-total-t">{pigcms{:floatval($minus_money)}</strong></span>
												</div>
												<div>
