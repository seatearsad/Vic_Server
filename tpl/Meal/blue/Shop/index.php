				...
				<li <if condition='$i%4 eq 0'>class="last--even"</if>>
					<a href="{pigcms{$config.site_url}/shop/{pigcms{$vo.id}.html" target="_blank">
						<div class="category_list_img">
							...
							<div class="shop_data">
								<div class="shop_state" <if condition="$vo['delivery']">id="shop_state"</if>><if condition="$vo['delivery']"><if condition="$vo['delivery_system']">平台配送<else />商家配送</if> <else />门店自提</if> </div>
