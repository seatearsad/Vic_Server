				...
				<div class="mall cf J-mall log-mod-viewed" id="content">
					<div class="mall cf J-mall log-mod-viewed" id="content">
						<div class="J-async-deallist cf">
									...
									<a href="{pigcms{$vo.url}" class="deal-tile__cover" hidefocus="true" target="_blank">
										...
										<span class="good-img-wrap" style="height:214px;">
											<span class="range-area">
												...
												<span class="range-desc" style="margin:23px 32px 0 90px;"><img class="lazy_img" src="{pigcms{$static_public}images/blank.gif" data-original="{pigcms{:U('Index/Recognition/see_qrcode',array('type'=>'meal','id'=>$vo['store_id']))}"/>微信扫码 手机查看</span>
							...
							<else/>
								<div style="text-align:center;height:380px;margin-top:60px;">此区域暂无店铺，请看看其他区域</div>
							</if>
						</div>
					</div>
					{pigcms{$pagebar}
