...
<!--									<if condition="$now_order['tuan_type'] neq '2'">-->
						...
						<dd class="dd-padding coupons-code">
							总价： <span>{pigcms{$now_order.total_money}元</span>
						</dd>
						<dd class="dd-padding coupons-code">
							使用{pigcms{$config['score_name']}：<span>{pigcms{$now_order.score_used_count}个 </span>{pigcms{$config['score_name']}抵扣：<span><font color="green">{pigcms{$now_order.score_deducte}</font>元</span>
						</dd>
						<if condition="$system_coupon">
							<dd class="dd-padding coupons-code">
								平台优惠券抵扣：<span><font color="green">{pigcms{$system_coupon.price}</font>元</span>
							</dd>
						<elseif condition="$card" />
							<dd class="dd-padding coupons-code">
								商家优惠券抵扣：<span><font color="green">{pigcms{$card.price}</font>元</span>
							</dd>
						</if>

						<dd class="dd-padding coupons-code">
							实际支付： <span><font color="green">{pigcms{$now_order['payment_money']+$now_order['balance_pay']}</font>元</span>
						</dd>
						<dd class="dd-padding coupons-code">
