...
<body>
	<header class="pigcms-header mm-slideout">
		<a href="#slide_menu" id="pigcms-header-left">
	      ...
	      <p id="pigcms-header-title">{pigcms{$config.group_alias_name}商品管理</p>
		<a  href="{pigcms{:U('Index/group_add')}" id="pigcms-header-right">添加商品</a>
		</header>
...
<script type="text/javascript" src="{pigcms{$static_path}js/iscroll.js"></script>
	<div class="item-list-wrap">
		...
		<div class="item-list-footer">
			<a href="{pigcms{:U('Index/mpackageadd')}" class="footer-operation">
				<i class="iconfont icon-add"></i><span>添加套餐</span>
			</a>
			<a href="{pigcms{:U('Index/group_add')}" class="footer-operation">
...
<script>
	...
	var url = "{pigcms{:U('Index/gpro')}",
		can_manage = 1;
		$(function(){
			$(".pigcms-main").css('height', $(window).height()-50);
		})
		var myScroll_fliter, edit_url = "";
		/*function loaded() {
