							...
							<div class="mainbox cf">
								<div class="table-section summary-table">
									<table cellspacing="0" class="buy-table" id="menu_list">
										...
										<tr>
											<td></td>
										<td colspan="3" class="extra-fee total-fee rightpadding"><strong>税费</strong>：<span class="inline-block money">+<strong>5%</strong></span></td>
										</tr>
										<tr>
											<td></td>
											<td colspan="3" class="extra-fee total-fee rightpadding"><strong>应付金额</strong>：<span class="inline-block money">$<strong id="deal-buy-total-t">{pigcms{$total_off_price}<if condition="$now_group.extra_pay_price gt 0 AND $config.open_extra_price eq 1">+{pigcms{$now_group.extra_pay_price}{pigcms{$config.extra_price_alias_name}</if></strong></span>
											</td>									
										</tr>							
									</table>
								</div>
