					...
					<if condition="$group_list">
						<ul>
							<volist name="group_list" id="vo">
								<li <if condition="$i%3 eq 0  || $i eq count($group_list)">class="last--even"</if>>
									<div class="category_list_img">
										...
										<div class="datal">
											...
											<div class="deal-tile__detail cf">
												<span class="price">$<strong>{pigcms{$vo.price}<if condition="$vo.extra_pay_price  neq ''">{pigcms{$vo.extra_pay_price}</if></strong> </span>
												<span>门店价 ${pigcms{$vo.old_price}<if condition="$vo.extra_pay_price  neq ''">{pigcms{$vo.extra_pay_price}</if></span>	
										...
										<div class="extra-inner cf">
											...
											<else />
											<div class="sales">开团时间：<strong class="num">{pigcms{$vo['begin_time']}</strong></div >
											</if>
										</div>
									</div>
								</li>
