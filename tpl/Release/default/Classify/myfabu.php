...
.pager {
 ...
 <div id="site-mast" class="site-mast"><include file="topbar"/></div>
  <div class="body_div" style="margin:0 auto; width: 1000px;margin-top: 7px;">
   ...
   <div class="dl_nav">
    <span> <a href="{pigcms{$siteUrl}/classify/">{pigcms{$config.classify_name}首页</a> &gt;  <a href="{pigcms{$siteUrl}/classify/mycenter.html">个人中心</a> &gt;  <a href="javascript:;" style="color: #f97d03;"> 我的发布 </a> </span>
   </div>
   <div class="ucenter">
