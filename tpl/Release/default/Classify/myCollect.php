...
<html lang="zh-CN">
 ...
 <body>
  ...
  <div class="body_div" style="margin:0 auto; width: 1000px;background-color: #fff;padding-bottom: 30px;margin-top: 7px;">
   <div class="c_header">
    <a class="c_logo" href="{pigcms{$siteUrl}/classify/" style="font-size: 20px;">{pigcms{$config.classify_name}首页</a>
    <a class="c_publish" href="{pigcms{$siteUrl}/classify/selectsub.html"> <i class="ico"></i>发布 </a>
   </div>
   <div class="dl_nav">
    <span> <a href="{pigcms{$siteUrl}/classify/">{pigcms{$config.classify_name}首页</a> &gt; <a href="{pigcms{$siteUrl}/classify/mycenter.html" rel="nofollow">个人中心</a> &gt; <a href="javascript:;" rel="nofollow" style="color: #f97d03;">我的收藏</a> </span>
   </div>
