...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  ...
  <meta name="keywords" content="{pigcms{$config.site_name} {pigcms{$config.classify_name} {pigcms{$detail['title']}" />
 ...
 <body>
  ...
  <div id="header">
	<if condition="isset($config['classify_logo']) AND !empty($config['classify_logo'])">
	 ...
	 <a href="{pigcms{$siteUrl}/classify/" target="_blank"><img src="{pigcms{$config.classify_logo}" alt="{pigcms{$config.classify_name}" title="{pigcms{$config.classify_name}" width="185" height="58" /></a>
	 </span>
	 <else/>
    <span id="logo">
