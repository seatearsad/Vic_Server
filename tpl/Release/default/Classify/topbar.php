		...
		<ul class="basic-info">
			<if condition="$now_select_city">
				<li class="user-info cf">
					<div class="span" style="font-size:16px;color:red;padding-right:3px;cursor:default;float:left;line-height:24px;">{pigcms{$now_select_city.area_name}</div>
					<div class="span" style="padding-right:10px;color:#7d7d7d;float:left;line-height:24px;">[<a href="{pigcms{:UU('Index/Changecity/index',array('request'=>'%2Fclassify%2F'))}">切换城市</a>]</div>
					<div class="span" style="padding-right:10px;float:left;">|</div>
				</if>
			</if>
			<li class="user-info cf">
