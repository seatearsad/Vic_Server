	...
	<body>
		...
		<div class="containr"> 
			<div class="body" style="width:100%;"> 
				...
				<div class="menu_main">
				<article style=" position: relative;width: 980px;padding-left:220px">
					<div class="menu cf" >
						<div class="menu_right cf" style="margin-top:0px">						
				...
				<article style=" position: relative;width: 1200px;">
					<div class="menu cf" >
								...
								<div class="category_list cf">
									<ul class="cf">
										<volist name="vo['group_list']" id="voo" offset="0" length="8" key="k">
											<li class="<if condition='$k gt 4'>btp0</if> li <if condition="$k%4 eq 0 || $k eq count($vo['group_list'])">last--even</if>">
												<div class="category_list_img">
													...
													<div class="extra-inner cf">
														<if condition="$voo['sale_count']+$voo['virtual_num']">
