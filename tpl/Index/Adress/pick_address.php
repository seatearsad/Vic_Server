	...
	<else/>
		...
		<script>
			$(function(){
				...
				window.parent.change_pick_adress(first_obj.attr('pick_addr_id'),first_obj.attr('pick_name'),first_obj.attr('phone'),first_obj.attr('province'),first_obj.attr('city'),first_obj.attr('area'));
