						...
						<li>
							<a href="{pigcms{:U('gift_list',array('cat_id'=>$good_gift_cagtegory['cat_id']))}">
								...
								<div class="categoryText">
									...
									<p>{pigcms{$good_gift_cagtegory['desc']}</p>
								</div>
							</a>
						</li>
                   </volist>
                                    ...
                                    <li>
                                        <div class="wrap">
                                            ...
                                            <div class="proInfo">
                                                ...
                                                <if condition='in_array($gift["exchange_type"],array(0,2))'><p>积分：{pigcms{$gift.payment_pure_integral}<em>积分</em></p></if>
											<if condition='in_array($gift["exchange_type"],array(1,2))'>
											 <p>现金+：{pigcms{$gift.payment_integral}<em>积分</em><em>+</em>{pigcms{$gift.payment_money}<em>元</em></p></if>
    ...
    <div class="secRow indexRow3">
        <div class="w1200">
            ...
            <!--         <div class="tagGroup ofh">
                ...
                <h3 class="fl title"><i class="dib"></i>高端生活</h3><p class="fl subTitle">用积分换取美好生活</p>
            </div>
