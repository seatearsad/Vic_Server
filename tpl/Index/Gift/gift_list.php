                    ...
                    <td>
						<div class="states">
							<div class="link-list clearfix"> 
								...
								<a href="{pigcms{:U('gift_list',array('cat_id'=>$_GET['cat_id'],'integral_start'=>$_GET['integral_start'],'integral_end'=>$_GET['integral_end'],'exchange_type'=>0,'type'=>$_GET['type']))}" <if condition='$_GET["exchange_type"] eq 0'>class="on"</if>>全积分</a> 
								<a href="{pigcms{:U('gift_list',array('cat_id'=>$_GET['cat_id'],'integral_start'=>$_GET['integral_start'],'integral_end'=>$_GET['integral_end'],'exchange_type'=>1,'type'=>$_GET['type']))}" <if condition='$_GET["exchange_type"] eq 1'>class="on"</if>>积分+现金</a>
							</div>
						</div>
					</td>
                </tr>
						...
						<td>
							<div class="states">
								<div class="link-list clearfix"> 
									...
									<a href="{pigcms{:U('gift_list',array('type'=>$_GET['type'],'integral_start'=>$_GET['integral_start'],'integral_end'=>$_GET['integral_end'],'exchange_type'=>0))}" <if condition='$_GET["exchange_type"] eq 0'>class="on"</if>>全积分</a> 
									<a href="{pigcms{:U('gift_list',array('type'=>$_GET['type'],'integral_start'=>$_GET['integral_start'],'integral_end'=>$_GET['integral_end'],'exchange_type'=>1))}" <if condition='$_GET["exchange_type"] eq 1'>class="on"</if>>积分+现金</a>
								</div>
							</div>
						</td>
					</tr>
					...
					<volist name='gift_list["list"]' id='gift'>
						<li class="item">
							<div class="wrap">
								...
								<if condition='in_array($gift["exchange_type"],array(0,2))'><p class="bonus">积分：{pigcms{$gift.payment_pure_integral}<em>积分</em></p></if>
								<if condition='in_array($gift["exchange_type"],array(1,2))'>
								 <p class="bonus">{pigcms{$gift.payment_integral}<em>积分</em><em>+</em>{pigcms{$gift.payment_money}<em>元</em></p>
								</if>
							</div>
						</li>
				   </volist>
