...
<section class="mainSection">
    ...
    <div class="w1200">
	<form action="{pigcms{:U('order')}" method="post" onsubmit="check_submit()">
        <div class="myOrder">
            <div class="payOption">
            ...
            <div class="itemDetail mt30">
                <div class="wrap">
                    <!--div class="hd">
                        <a href="##" class="fr backCart">返回购物车></a>
                        <strong>商品详情</strong>
                    </div-->
            ...
            <div class="pay mt20 clearfix">
                ...
                <div class="fr total">
				<if condition='$gift_detail["exchange_type"] eq 0'>
					 <span>合计：</span><p class="bonus dib"><span>{pigcms{$gift_detail['payment_pure_integral'] * $_GET['num']} <em>积分</em></span></p>
				<elseif condition='$gift_detail["exchange_type"] eq 1'/>
					 <span>合计：</span><p class="bonus dib"><span>{pigcms{$gift_detail['payment_integral'] * $_GET['num']}  <em>积分</em></span><span><em>+</em>{pigcms{$gift_detail['payment_money'] * $_GET['num']}  <em>元</em></span></p>
				</if>
                </div>
            </div>
        </div>
