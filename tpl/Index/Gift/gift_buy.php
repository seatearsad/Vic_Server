        ...
        <div class="myOrder">
            <div class="orderList">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                            ...
                            <div class="desc">
                                <div class="wrap">
									...
									<if condition='$_GET["exchange_type"] eq 0'>
										<p class="bonusStyle mt10">积分</p>
									<elseif condition='$_GET["exchange_type"] eq 1' />
										<p class="bonusStyle mt10">积分<em>+</em>现金兑换</p>
									</if>
                                </div>
                            </div>
                        </a> </td>
						...
						<if condition='$_GET["exchange_type"] eq 0'>
							<td class="price"><p class="bonus"><span>{pigcms{$gift_detail['payment_pure_integral']} <em>积分</em></span></p></td>
						<elseif condition='$_GET["exchange_type"] eq 1'/>
							<td class="price"><p class="bonus"><span>{pigcms{$gift_detail['payment_integral']} <em>积分</em></span><span><em>+</em>{pigcms{$gift_detail['payment_money']} <em>元</em></span></p></td>
						</if>
                        ...
                        <if condition='$_GET["exchange_type"] eq 0'>
							<td class="price"><p class="bonus"><span><font class="payment_pure_integral">{pigcms{$gift_detail['payment_pure_integral'] * $_GET['num']}</font><em>积分</em></span></p></td>
						<elseif condition='$_GET["exchange_type"] eq 1' />
							<td class="price"><p class="bonus"><span><font class="payment_integral">{pigcms{$gift_detail["payment_integral"] * $_GET['num']}</font> <em>积分</em></span><span><em>+</em><font class="payment_money">{pigcms{$gift_detail["payment_money"] * $_GET['num']}</font> <em>元</em></span></p></td>
						</if>
            ...
            <div class="pay mt20 clearfix">
                ...
                <div class="fr total">
                    <span>合计：</span>
					 <if condition='$_GET["exchange_type"] eq 0'>
						<p class="bonus dib"><span><font class="payment_pure_integral">{pigcms{$gift_detail['payment_pure_integral'] * $_GET['num']}</font> <em>积分</em></span></p>
					<elseif condition='$_GET["exchange_type"] eq 1' />
						<p class="bonus dib"><span><font class="payment_integral">{pigcms{$gift_detail["payment_integral"] * $_GET['num']}</font> <em>积分</em></span><span><em>+</em><font class="payment_money">{pigcms{$gift_detail["payment_money"] * $_GET['num']}</font> <em>元</em></span></p>
					</if>
                </div>
            </div>
        </div>
								...
								<div class="desc">
									...
									<div class="info">
										...
										<if condition='in_array($gift["exchange_type"],array(0,2))'>
											<p class="bonus"><span>{pigcms{$gift['payment_pure_integral']} <em>积分</em></span></p>
										</if>
										<if condition='in_array($gift["exchange_type"],array(1,2))'>
											<p class="bonus"><span>{pigcms{$gift['payment_integral']} <em>积分</em></span><span><em>+</em>{pigcms{$gift['payment_money']}  <em>元</em></span></p>
										</if>
									</div>
								</div>
							</li>
