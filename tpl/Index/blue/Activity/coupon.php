...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>{pigcms{$now_activity.name} - 优惠券 - {pigcms{$config.site_name}</title>
			...
			<div class="oneyuan cf">
				<div class="navBreadCrumb cf">
					<ul class="cf">
						...
						<li>
							<div class="navBreadCrumb_txt"><a href="{pigcms{$config.site_url}/activity/2/all">优惠券&nbsp;&nbsp;&gt;</a></div>
						</li>
						...
						<div class="product_list_top">
							...
							<div class="cf">
								<div class="product_number cf">
									<div class="product_number_top">总数量<span>{pigcms{$now_activity.all_count}</span></div>
							...
							<div class="product_info_top cf">
								<if condition="$now_activity['money']">
									<div class="product_info_list_left">兑换价格：</div>
									<div class="product_info_list_num"><span>$</span>{pigcms{$now_activity.money}</div>
								<else/>
									<div class="product_info_list_left">兑换{pigcms{$config['score_name']}：</div>
									<div class="product_info_list_num">{pigcms{$now_activity.mer_score}<span>分</span><if condition="$now_activity['all_count']-$now_activity['part_count'] gt 0"><span class="score_tips">您可以选择使用  <strong>{pigcms{$now_activity['mer_score']/$config['activity_score_scale']}</strong> 平台{pigcms{$config['score_name']}参与活动</span></if></div>
								</if>
							</div>
								...
								<div class="product_list_bottom cf">
									<form action="" method="get" id="buy_form">
										<if condition="!$now_activity['money']">
											<div class="cf">
												<div class="input">
													<div class="product_info_list_left">{pigcms{$config['score_name']}类别：</div>
													<ul style="border:none;">
														<li style="border-right:none;"><label for="mer_score"><input type="radio" id="mer_score" name="score_type" value="1" checked="checked"/> 商家{pigcms{$config['score_name']}&nbsp;&nbsp;&nbsp;&nbsp;</label></li>
														<li style="border-right:none;"><label for="sys_score">&nbsp;&nbsp;&nbsp;<input type="radio" id="sys_score" name="score_type" value="2"/> 平台{pigcms{$config['score_name']}&nbsp;&nbsp;&nbsp;</li>
													</ul>
												</div>
											</div>
										</if>
							...
							<volist name="tui_activityList" id="vo">
								<li>
									<a href="{pigcms{$vo.url}">
										<img src="{pigcms{$vo.list_pic}" style="width:158px;"/>
									</a>
