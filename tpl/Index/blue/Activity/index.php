...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="banner activity_banner" <if condition="$now_activity['bg_color']">style="background-color:{pigcms{$now_activity.bg_color}"</if>>
			<div class="banner_img">
				...
				<div class="banner_list">
					...
					<div id="divdown1">
						<div class="banner_list_datad" id="time_d">{pigcms{$time_array['d']}</div><div class="banner_list_icon_txt">天</div>
									...
									<div class="category_list_img">
										...
										<div class="datal">
											...
											<div class="deal-tile__detail cf" style="border-bottom:0;">
												...
												<else/>
													<span id="price"><if condition="$vo['eal_money']">$<strong>{pigcms{$vo.eal_money}</strong><else/><strong>{pigcms{$vo.mer_score}</strong> {pigcms{$config['score_name']}</if></span>
												</if>
