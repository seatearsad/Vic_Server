	...
	<body>
        ...
        <div class="body">
			<div class="hd">
				<div class="hd_left">
					<form action="">
						<a href="{pigcms{$_SERVER.REQUEST_SCHEME}://{pigcms{$now_city.area_url}.{pigcms{$config.many_city_top_domain}{pigcms{$_GET.request}" class="site_enter">点击进入{pigcms{$now_city.area_name}站&gt;&gt;</a>
			...
			<div class="had_city">推荐城市：<volist name="hot_city" id="vo"><a href="{pigcms{$_SERVER.REQUEST_SCHEME}://{pigcms{$vo.area_url}.{pigcms{$config.many_city_top_domain}{pigcms{$_GET.request}">{pigcms{$vo.area_name}</a></volist></div>
				...
				<volist name="all_city" id="vo">
					<li id="city_set_{pigcms{$key}">
						...
						<volist name="vo" id="voo">
							<a href="{pigcms{$_SERVER.REQUEST_SCHEME}://{pigcms{$voo.area_url}.{pigcms{$config.many_city_top_domain}{pigcms{$_GET.request}" title="{pigcms{$voo.area_name}" <if condition="$voo['is_hot']">class="col_hs"</if>>{pigcms{$voo.area_name}</a>
						</volist>
					</li>
				</volist>
			</ul>
