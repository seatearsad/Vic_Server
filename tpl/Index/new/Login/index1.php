	...
	<div class="site-body pg-login cf">
	    ...
	    <div class="component-login-section component-login-section--page mt-component--booted" >
		    <div class="origin-part theme--www">
				...
				<p style="float: right;display:inline;display:none" id="forgetpwd">忘记密码？<a href="#" onclick="$(this).attr('href','{pigcms{:U('Login/forgetpwd')}&accphone='+$('#login-phone').val());">点这里</a></p>
