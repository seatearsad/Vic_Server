...
<div class="header_top">
    <div class="hot cf">
        <div class="loginbar cf">
			...
			<div class="span">|</div>			
			<div class="weixin cf">
				<span>可用积分:<i>{pigcms{$now_user['score_count']}</i></span>
			</div>
			</if>
            <div class="span">|</div>
			<div class="weixin cf">
				...
				<li class="li_txt_info cf">
					...
					<div class="li_txt_info_ul">
						<ul class="cf">
							...
							<li><a class="dropdown-menu__item" rel="nofollow" href="{pigcms{:UU('User/Point/index')}">我的积分</a></li>
