										...
										<a href="javascript:void(0)" style="cursor: default;">
											...
											<div class="text">
												<dl>
													...
													<dd class="clr middle">
														<div class="fl">月售{pigcms{$vo['product_sale']}{pigcms{$vo['unit']}  <if condition="$vo['stock'] neq -1 AND $vo['stock'] lt 10">库存{pigcms{$vo['stock']}{pigcms{$vo['unit']}</if></div>
