				...
				success : function(result){
					if(result.errorCode == 0){
						...
						if(result.errorCode == '20110023'){
							...
							var pay	=	'';
							pay	+=	'<a href="{pigcms{:U('My/recharge')}"><div id="pay" class="m-b-sm">您的余额<span class="color-green2">'+now_money+'</span>，还差'+money+'<br>请点击 <span class="color-orange">充值</span></div></a>';
							$('#pay_s').html(pay);
						}
