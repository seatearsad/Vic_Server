...
<body>
    <div class="time_list">
        <ul>
            ...
            <li>
                <input type="text" placeholder="{pigcms{:L('_ENGLISH_TXT_')}({pigcms{:L('_STORE_REQUIRED_')})" name="cate_name_en">
            </li>
            <li>
                <input type="text" placeholder="{pigcms{:L('_CHINESE_TXT_')}" name="cate_name_cn">
            </li>
            <li></li>
            <li>
                <div class="add_c">
                    {pigcms{:L('_B_PURE_MY_26_')}
                </div>
            </li>
        </ul>
    </div>
