...
<head>
	...
	<style>
		.dealcard .price>.strong-color{font-size:.266rem;}
		.dealcard .price>strong{font-size:.32rem;}
		.dealcard .location_list{background-color:white;color:#9E9E9E;}
	</style>
</head>
<body id="index">
        <div id="container">
			...
			<div class="deal-container">
				<div class="deals-list" id="deals">
					...
					<else/>	
						<div class="no-deals">暂无此类预约，请查看其他分类</div>
					</if>
				</div>
		...
		<script>
			var location_url = "{pigcms{:U('Appoint/index')}";
