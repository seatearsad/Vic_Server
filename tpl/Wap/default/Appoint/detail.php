...
.m-detail-buy .w-button {
  width: 112px;
	...
	.appoint_attr{padding:4px 10px;font-size:13px;line-height:38px;height:38px;color:#333;border-radius:2px;border-color:#d7d7d7;border:1px solid #ccc;white-space:nowrap;
text-overflow:ellipsis;
-o-text-overflow:ellipsis;
overflow: hidden; }
	.appoint_attr.active{padding:4px 10px;font-size:13px;line-height:38px;height:38px;color:#333;border-radius:2px;border-color:#d7d7d7;border:1px solid red;}
</style>
</head>
<body id="index">
		...
		<div id="enter_im_div" style="-webkit-transition: opacity 200ms ease; transition: opacity 200ms ease; opacity: 1; display: block;cursor:move;z-index: 10000;">
			...
			<dl class="list" id="deal-feedback" style="margin-bottom:30px;">
				<dd>
					<dl>
						<dt style="color:#06c1ae;">评价<span>
							<span class="stars">
								<for start="0" end="5">
									<if condition="5 gt 3"><i class="text-icon icon-star"  style="margin-right:1px;"></i>
									<elseif condition="$now_group['score_mean'] gt $i-1"/><i class="text-icon icon-star-gray"  style="margin-right:1px;"><i class="text-icon icon-star-half"  style="margin-right:1px;"></i></i>
									<else/><i class="text-icon icon-star-gray"  style="margin-right:1px;"></i>
									</if>
								</for><em class="star-text">{pigcms{$now_group.score_mean}</em>
							</span>
							</span></dt>
							<dd class="dd-padding">
								<div class="feedbackCard">
									<div class="userInfo">
										<weak class="username">222</weak>
									</div>
									<div class="score">
										<span class="stars"><for start="0" end="5"><if condition="3 gt 2"><i class="text-icon icon-star"></i><else/><i class="text-icon icon-star-gray"></i></if></for></span>
										<weak class="time">1212</weak>
									</div>
									<div class="comment">
										<p>333</p>
									</div>
