		    	...
		    	<dd>
		    		<dl>
		        		...
		        		<dd class="dd-padding kv-line" id="color-gray">
		        			<h6>位置:</h6>
	                        <i class="icon-location" data-node="icon"></i><span class="color-gray" data-node="addAddress"><?php if(!empty($now_adress['adress'])): ?><?php echo $now_adress['adress']; ?><?php else : ?>点击选择位置<?php endif; ?></span> <i class="right_arrow"></i>
