...
<body id="index">
		<div class="btn-wrapper">
			<ul class="tab">
				<li class="active"><a class="react" href="{pigcms{:U('My/appoint_collect')}">项目</a>
				</li><li><a class="react" href="{pigcms{:U('My/worker_collect')}">技师</a>
				</li>
			</ul>
		</div>
        <div id="container">
			        				...
			        				<a href="{pigcms{$vo.url}" class="react">
										<div class="dealcard">
										    ...
										    <div class="dealcard-block-right">
													...
													<div class="title text-block">[{pigcms{$vo.merchant_name}]{pigcms{$vo.appoint_name}</div>
										        <div class="price">
