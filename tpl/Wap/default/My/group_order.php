...
<body id="index">
    ...
    <script src="{pigcms{:C('JQUERY_FILE')}"></script>
		...
		<div style="height:10px"></div>
			<div class="top-btn"><a class="react"><i class="text-icon">⇧</i></a></div>				<div style="display:none;"><script src="http://s4.cnzz.com/stat.php?id=1254604920&web_id=1254604920" language="JavaScript"></script></div>
