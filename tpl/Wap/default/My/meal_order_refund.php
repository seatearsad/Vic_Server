...
<body>
        ...
        <div class="wrapper-list">
			    ...
			    <dd>
			        <dl>
						<dd class="kv-line-r dd-padding">
							<h6>购买数量：</h6><p>{pigcms{$now_order.total}</p>
						</dd>
						<dd class="kv-line-r dd-padding">
							<h6>订单总价：</h6><p>{pigcms{$now_order.price}元</p>
						</dd>
			            <dd class="kv-line-r dd-padding">
			...
			<div class="btn-wrapper">
				<span onclick="window.location.href='{pigcms{:U('My/meal_order_check_refund',array('mer_id' => $mer_id, 'orderid'=>$now_order['order_id'], 'store_id' => $now_order['store_id']))}'" class="btn btn-larger btn-block btn-strong" style="margin-bottom:15px;">确定取消</span>
			</div>
		</div>
