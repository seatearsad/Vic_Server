...
<body>
	...
	<div>
		<a class="my-account" href="{pigcms{:U('My/myinfo')}">
			...
			<div class="user-info more more-weak">
				...
				<p class="umoney">余额：<strong>{pigcms{$now_user.now_money}</strong> 元 &nbsp;&nbsp;&nbsp<span>{pigcms{$config['score_name']}：<strong>{pigcms{$now_user.score_count}</strong> 分</span></p>
	...
	<if condition="isset($config['specificfield'])">
		<dd>
			<a class="react" href="{pigcms{:U('My/inputinfo')}">
				<div class="more more-weak">
					<i class="text-icon order-zuo order-icon">#</i>完善信息{pigcms{$config}<span class="more-after"></span>
				</div>
			</a>
		</dd>
   </if>
	...
	<dl class="list">
		<dd>
			<a class="react" href="{pigcms{:U('My/group_collect')}">
				<div class="more more-weak">
					<i class="text-icon order-fav order-icon" style="background-color:#F5716E;">☆</i>{pigcms{$config.group_alias_name}收藏<span class="more-after"></span>
				</div>
			</a>
		</dd>
        <dd>
			<a class="react" href="{pigcms{:U('My/appoint_collect')}">
				<div class="more more-weak">
					<i class="text-icon order-fav order-icon" style="background-color:#F5716E;">☆</i>预约收藏<span class="more-after"></span>
				</div>
			</a>
		</dd>
		<dd>
	...
	<dl class="list">
		<dd>
			<a class="react" href="{pigcms{:U('My/spread_list')}">
				<div class="more more-weak">
					<i class="text-icon order-jiudian order-icon" style="background-color:#0092DE;">推</i>我的推广<span class="more-after"></span>
				</div>
			</a>
		</dd>
		<dd>
			<a class="react" href="{pigcms{:U('My/my_spread_qrcode')}">
				<div class="more more-weak">
					<i class="text-icon order-jiudian order-icon" style="background-color:#20DE6C;">码</i>我的推广二维码<span class="more-after"></span>
				</div>
			</a>
		</dd>
	</dl>
