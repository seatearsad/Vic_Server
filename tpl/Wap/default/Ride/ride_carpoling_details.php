...
//				details	+='	<div class="m-t-sm text-base">'+ride_details.start_date+' 出发</div>';
				...
				details	+='	<div class="m-b-xs">司机信息</div>';
...
//				}
				...
				details	+='			<div class="m-t-xs">司机手机：</div>';
				details	+='			<div class="m-t-xs">司机业务：</div>';
				...
				details	+='			<div class="m-t-xs">'+ride_details.owner_phone+'</div>';
