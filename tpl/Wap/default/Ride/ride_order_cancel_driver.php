...
<div class="app-content with-header text-left text-base">
	...
	<div class="clearfix b-b" style="padding-bottom:5px;">
		...
		<div class="col-xs-8 no-padder m-l-n">
			<input id="sit_number" type="text" value="不付违约金" class="m-t-xs w-full no-border f-30" readonly>
		</div>
	</div>
	<div class="clearfix b-b" style="padding-bottom:5px;">
		<div class="col-xs-4 f-10">
		...
		<div class="col-xs-8 no-padder m-l-n">
			<input id="sit_number" type="text" value="{pigcms{$total} 元" class="m-t-xs w-full no-border f-30" readonly>
		</div>
	</div>
