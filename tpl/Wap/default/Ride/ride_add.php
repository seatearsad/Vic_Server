...
<div class="app-content with-header text-left text-base">
	...
	<div class="clearfix b-b" style="padding-bottom:5px;">
		...
		<div class="col-xs-8 no-padder m-l-n">
			<input id="ride_price" type="number" placeholder="(元)" class="m-t-xs w-full no-border f-30">
		</div>
	</div>
	<div class="clearfix b-b" style="padding-bottom:5px;">
		<div class="col-xs-4 f-10">
		...
		<div class="col-xs-8 no-padder m-l-n">
			<input id="cancel_time" type="number" placeholder="默认发车(30分钟)前允许违约" class="m-t-xs w-full no-border f-30">
		</div>
	</div>
	<div class="clearfix b-b" style="padding-bottom:5px;">
		<div class="col-xs-4 f-10">
		...
		<div class="col-xs-8 no-padder m-l-n">
			<input id="penalty" type="number" placeholder="乘客违约，赔N(元)，0无违约金" class="m-t-xs w-full no-border f-30">
		</div>
	</div>
	<div class="clearfix b-b" style="padding-bottom:5px;">
		<div class="col-xs-4 f-10">
