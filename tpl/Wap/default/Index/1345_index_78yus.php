...
<link type="text/css" rel="stylesheet" href="{pigcms{$static_path}tpl/1345/css/base.css">
...
<body class="bg17 hAndroid hAndroid2x">
<!--music-->
...
<if condition="$homeInfo['switch'] eq 0">
  <section class="ap oh carouselBox" id="carouselBox" ontouchstart="touchStart(event)" ontouchmove="touchMove(event);" ontouchend="touchEnd(event);" style="overflow: hidden;">
        <ul class="oh ab carouselPics" id="carouselPics" style="width: 500%; position: relative; left: -960px;">
