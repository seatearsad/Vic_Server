...
<link href="{pigcms{$static_path}tpl/1333/css/cate.css" rel="stylesheet" type="text/css" />
<style>
...
<div class="device" style="margin-bottom: 100px;">
    <a class="arrow-left" href="#"></a> 
    <a class="arrow-right" href="#"></a>
    <div class="swiper-container" style="height:300px;margin-bottom:100px">
      <div class="swiper-wrapper">
          ...
          <div class="mbg">
                    ...
                    <p class="title">{pigcms{$vo.name}</p></div>
      				...
      				<if condition="$i % 6 eq 0 || $i eq count($info)">
						</div>
						</div>
					</if>
				</volist>
