...
<link type="text/css" rel="stylesheet" href="{pigcms{$static_path}tpl/1357/css/base.css">
...
<else />
    ...
    <ul class="oh menu371"  style="margin:8px 0 3px 0">
          ...
          <li>
              <a href="<if condition="$vo['url'] eq ''">{pigcms{:U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token']))}<else/>{pigcms{$vo.url|htmlspecialchars_decode}</if>">
                  <div class="box">
                      ...
                      <div class="pic"><img src="{pigcms{$vo.img}"></div>
                  </div>
              </a>
          </li>
        </if>
