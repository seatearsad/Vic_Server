...
<link type="text/css" rel="stylesheet" href="{pigcms{$static_path}tpl/1352/css/base.css">
...
<if condition="$homeInfo['switch'] eq 0">
  <section class="ap oh carouselBox carouselBox3" id="carouselBox" ontouchstart="touchStart(event)" ontouchmove="touchMove(event);" ontouchend="touchEnd(event);" style="overflow: hidden;">
