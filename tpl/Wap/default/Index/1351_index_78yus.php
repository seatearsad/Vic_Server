...
<link type="text/css" rel="stylesheet" href="{pigcms{$static_path}tpl/1351/css/base.css">
...
<body class="bg12 hAndroid hAndroid2x">
...
<section id="container">
  <section class="fl oh leftBox">
        <section class="ap oh carouselBox" id="carouselBox" ontouchstart="touchStart(event)" ontouchmove="touchMove(event);" ontouchend="touchEnd(event);" style="overflow: hidden;">
          <ul class="oh ab carouselPics" id="carouselPics" style="width: 2205px; position: relative; left: -1323px;">
            <volist name="flash" id="so">   
               <li style="width: 220px;"><a href="{pigcms{$so.url}"><img src="{pigcms{$so.img}"></a></li>
            </volist>     
          </ul>
            <ul class="tr ab carouselBtns" id="carouselBtns"></ul>
            <div class="ab carouselBtnsBg"></div>
        </section><!--carouselBox end-->
    </section><!--leftBox end-->
    <ul class="fr oh menu121">
...
var resetScrollEle = function(){
  ...
  $("#carouselPics").css('width',picCount*($(".carouselBox").width()));
