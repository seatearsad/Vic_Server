...
<meta charset="utf-8">
<link href="{pigcms{$static_path}css/ktv/style.css" rel="stylesheet" type="text/css">
<link type="text/css" rel="stylesheet" href="{pigcms{$static_path}css/ktv/style01.css">

<script type="text/javascript" charset="utf-8" src="{pigcms{$static_path}js/ktv/page_context.js"></script>
	...
	<ul class="mainmenu2 radius margin10">
		...
		<li class="radius_top border-top-none">
			...
			<a href="{pigcms{:U('Index/content',array('id'=>$vo['id'],'token'=>$vo['token']))}">
				...
				<h2 class="menutitle">{pigcms{$vo.title}</h2>
				<p class="menudesc">{pigcms{$vo.text}</p>
