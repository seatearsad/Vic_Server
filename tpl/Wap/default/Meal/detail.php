...
<div class="footReturn">
	<ul>
		<if condition="$order['paid'] eq 0">
		<li class="footerbtn"><a class="del right3" href="{pigcms{:U('Meal/orderdel', array('mer_id' => $mer_id, 'store_id' => $store_id, 'orderid' => $order['order_id']))}">取消订单</a></li> 
		...
		<elseif condition="$order['status'] eq 0"/>
		<li class="footerbtn"><a class="del right3" href="{pigcms{:U('My/meal_order_refund', array('mer_id' => $mer_id, 'store_id' => $store_id, 'orderid' => $order['order_id']))}">取消订单</a></li> 
		</if>
	</ul>
	<div class="clr"></div>
