			    ...
			    <dd>
			        <dl>
                        ...
                        <if condition="$now_order['score_used_count'] neq '0'">
                            <dd class="kv-line-r dd-padding">
                                <h6>使用积分：</h6><p>{pigcms{$now_order.score_used_count}</p>
                            </dd>
                        </if>
                        <if condition="$now_order['score_deducte'] neq '0.00'">
                            <dd class="kv-line-r dd-padding">
                                <h6>使用积分抵扣余额：</h6><p>{pigcms{$now_order.score_deducte}元</p>
                            </dd>
                        </if>
				...
				<dl class="list">
					<dd>
						<dl>
							...
							<dd class="kv-line-r dd-padding">
								<h6>退款手续费：</h6><p><strong class="highlight-price" style="color:red;">{pigcms{$unconsume_pass_num*$now_order['price']*100/100-$refund_money*100/100}元</strong></p>
							</dd>
						</dl>
					</dd>
				</dl>
