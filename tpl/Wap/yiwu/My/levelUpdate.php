        ...
        <div id="pg-account">
		    <dl class="list">
		    	<dd>
		    		<dl>
				        <dd>
							<div class="react  more-weak" style="margin-left: 0px;">您当前{pigcms{$config['score_name']}： <strong>{pigcms{$now_user.score_count}</strong>&nbsp;&nbsp;&nbsp;当前等级：<span><strong><php>if(isset($levelarr[$now_user['level']])){ $nextlevel=$levelarr[$now_user['level']]['level']+1;echo $levelarr[$now_user['level']]['lname'];}else{ $nextlevel=1; echo '暂无等级';}</php></strong></span></div>
				        </dd>
						</dl>
				        ...
				        <dd>
				        	<div class="react  more-weak">消耗{pigcms{$config['score_name']}：<span>{pigcms{$levelarr[$nextlevel]['integral']}</span></div>
				        </dd>
						<dd>
