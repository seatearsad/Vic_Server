...
<html lang="zh-CN">
	<head>
		...
		<script type="text/javascript">var post_url = "{pigcms{:U('Worker/do_work')}", location_url = "{pigcms{:U('Worker/detail', array('pigcms_id' => $repair_detail['pigcms_id']))}", contentDetail = true;</script>
		<script type="text/javascript" src="{pigcms{$static_path}js/worker.js?555" charset="utf-8"></script>
		<style>
