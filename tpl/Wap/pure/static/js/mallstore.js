var myScroll = null, myScroll2 = null, myScroll3 = null, now_page = 1, hasMorePage = true, isLoading = true;
...
function goods_data()
{
	...
	$.post(ajax_url, {'sort_id':sort_id, 'sort':sort, 'sort_type':sort_type}, function(result){
		if(result.count > 0){
