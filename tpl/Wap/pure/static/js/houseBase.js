...
function showShopList(newPage){
	...
	$.getJSON(ajax_url_root+'ajax_list',{cat_url:cat_url,sort_url:sort_url,type_url:type_url,user_lat:user_lat,user_long:user_long,page:listShopNowPage,'is_wap':2},function(result){
		//console.log(result);
