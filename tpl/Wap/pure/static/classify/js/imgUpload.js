    ...
    var _default = {
        ...
        success: function(data, index) {
            if (data.code === 1) {
				...
				$("#imgShow" + index + '>img').attr('src',data.url);
...
ImgUpload.prototype = {
    ...
    init: function() {
        ...
        function() {
            ...
            _this.liIndex += 1;
			var loadingStr = '<li class="col-25 JSimg upload_item" id="imgShow' + _this.liIndex + '"><div class="rect pr"><img src=""><i class="pa fa  fa-close imgDelete upload_delete"></i></div><input type="hidden" name="inputimg[]" value=""></li>';
            $(_this.opt.container).append(loadingStr);
            getItemSize();
            _this.getItemCount();
            _this.zipImg({
                files: _tar,
