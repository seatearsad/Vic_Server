...
<![endif]-->
<script type="text/javascript" src="{pigcms{$static_path}js/mallbuygoods.js"></script>
</head>
	...
	<section class="Speci">
		<div class="title">
			...
			<div class="title_Price clr">
				...
				<del>原价300</del> -->
				<if condition="$now_goods['stock_num'] eq -1">
				<span class="Surplus fl">库存充足</span>
				<else />
				<span class="Surplus fl">剩余{pigcms{$now_goods['stock_num']}</span>
				</if>
			</div>
