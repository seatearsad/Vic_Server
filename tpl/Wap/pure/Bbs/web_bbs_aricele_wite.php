		...
		<div id="container">
				<div id="scroller" class="village_my">
					...
					<div class="fabu-type-info">
						<nav>
							<section>
								<textarea name="aricle_title" id="content" onKeyDown="textdown(event)" onKeyUp="textup()" onfocus="if(value=='快来晒晒你的新鲜事吧。'){value=''}" onblur="if (value ==''){value='快来晒晒你的新鲜事吧。'}">快来晒晒你的新鲜事吧。</textarea>
							</section>
						</nav>
					</div>
					...
					<div class="fabu-type-info" style="display: none;">
						<nav>
							<section>
								...
								<textarea id="content" name="aricle_content" onKeyDown="textdown(event)" onKeyUp="textup()" onfocus="if(value=='填写报名描述，地点，规则等信息。'){value=''}" onblur="if (value ==''){value='填写报名描述，地点，规则等信息。'}">填写报名描述，地点，规则等信息。</textarea>
							</section>
						</nav>
