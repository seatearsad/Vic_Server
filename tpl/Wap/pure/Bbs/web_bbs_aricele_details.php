					...
					<div class="row bbs-my-top">
						...
						<div class="col-100">
							<div class="bbs-list-desc">
								<p>{pigcms{$detail['aDetails']['aricle_title']}
								</p>
						...
						<if condition='$detail["aZanList"]'>
							<div class="col-100">
								...
								<volist name='detail["aZanList"]' id='zan'>
									<span><img src="{pigcms{$zan['uid']['avatar']}" /></span>
								</volist>
								</div>
							</div>
						</if>
						...
						<div class="col-100">
							<div class="bbs-foot bbs-detail-pl">
								<p>评论&nbsp;{pigcms{$detail['aDetails']['aricle_comment_total']}</span>
								</p>
							</div>
							<div class="bbs-list-pl">
								...
								<ul>
								<li>
											<p class="bbs-detail-pl-desc">暂无评论。</p>
										</li></ul>
								</if>
							</div>
						</div>
