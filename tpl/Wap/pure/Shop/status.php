...
<div id="wrapper" class="">
    <div id="fis_elm__2">
        <div id="common-widget-nav" class="common-widget-nav ">
            <div class="left-slogan"> <a class="left-arrow icon-arrow-left2" data-node="navBack" href="javascript:history.go(-1);" id="goBackUrl"></a> </div>
    ...
    <div id="fis_elm__3">
        <div id="common-widget-tab" class="common-widget-tab">
            <ul class="order-tab">
                ...
                <li><a href="{pigcms{:U('Shop/order_detail', array('order_id' => $order_id))}">订单详情</a></li>
            </ul>
        </div>
    </div>
    <div id="fis_elm__4">
        <div id="order-widget-orderhistory" class="order-widget-orderhistory">
            ...
            <div class="time-btm"> <img src="{pigcms{$static_path}shop/images/timer_2132249.png">
                <div class="right-btn">
                    <div class="title none"> <a class="cui-btn active" href="{pigcms{:U('Shop/confirm_order', array('order_id' => $order['order_id'], 'store_id' => $order['store_id']))}">再来一单</a> </div>
                </div>
            </div>
        </div>
    </div>
