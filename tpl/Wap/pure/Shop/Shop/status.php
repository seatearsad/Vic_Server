    ...
    <div id="fis_elm__4">
        <div id="order-widget-orderhistory" class="order-widget-orderhistory">
                ...
                <div class="item">
                    ...
                    <div class="status-card">
                        ...
                        <div class="card-content">
                            ...
                            <p class="small"> 
          						<if condition="$vo['status'] eq 0"> <span>订单编号：{pigcms{$vo.order_id}</span>
          						<elseif condition="$vo['status'] eq 1"/> <span>订单编号：{pigcms{$vo.order_id}</span>
            ...
            <div class="time-btm"> <img src="{pigcms{$static_path}shop/images/timer_2132249.png">
                <div class="right-btn">
                    <div class="title none"> <a class="cui-btn active" href="{pigcms{:U('Shop/index')}">去别家逛逛</a> </div>
                </div>
            </div>
        </div>
    </div>
