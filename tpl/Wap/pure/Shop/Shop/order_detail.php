...
<div class="container">
	...
	<section>
		...
		<ul class="box">
			...
			<li>快递单号：{pigcms{$order['express_number']}</li>
			</if>
		...
		<ul class="box">
			...
			<li>{pigcms{$store['freight_alias']|default='配送费用'}：${pigcms{$order['freight_charge']|floatval} 元</li>
		...
		<ul class="box">
			...
			<li>使用积分：{pigcms{$order['score_used_count']} </li>
			<li>积分抵现：${pigcms{$order['score_deducte']|floatval} 元</li>
			</if>
