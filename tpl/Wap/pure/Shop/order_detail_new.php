        ...
        <section class="defrayal">
            <div class="defrayal_n">
                <a href="{pigcms{:U('Shop/order_detail', array('order_id' => $order_details['order_id']))}">
                    ...
                    <elseif condition="$order_details['deliver_log_list']['status'] eq 6"/> <h2>配送结束</h2> <p>配送员已完成配送，欢迎下次光临！</p>
                    <elseif condition="$order_details['deliver_log_list']['status'] eq 7"/>
                        <if condition="$order['is_pick_in_store'] eq 3"><h2>店员已发货</h2> <p>已发货给快递公司<strong style="color:red">【{pigcms{$order_details['express_name']}】</strong>，快递单号:<strong style="color:green">{pigcms{$order_details['express_number']}</strong></p>
                        <else /><h2>店员验证消费</h2> <p>订单改成已消费</p>
                        </if>
        ...
        <section class="g_details p40">
            ...
            <div class="infor">
                ...
                <div class="answer clr">
                    ...
                    <div class="fr">应收总额: ${pigcms{$order_details['price']|floatval}</div>
                </div>
