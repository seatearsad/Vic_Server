...
<section class="Navigation">
	<ul class="clr">
		...
		<a href="{pigcms{:U('Deliver/send')}"><li class="on1" style="border-bottom:#ef4c79 2px solid;color:#ef4c79">待配送</li></a>
	...
	<div class="Dgrab" id="Dgrab1">
		...
		<section class="robbed supply_{pigcms{$row['supply_id']}" data-id="{pigcms{$row.supply_id}">
			...
			<div class="sign_bottom">
				<a href="javascript:;" class="Dis" data-id="{pigcms{$row['supply_id']}">配送</a>
			</div>
		</section>
		</volist>
		<else />
