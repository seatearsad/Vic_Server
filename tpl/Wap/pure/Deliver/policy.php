...
<body style="background:url('{pigcms{$static_path}img/login_bg.png');">
    <div id="back_btn">
        <span class="material-icons title_icon">keyboard_arrow_left</span>
    </div>
	<section>
	<div class="Land_top" style="color:#333333;">
		...
		<div style="margin-top:10px;margin-bottom: 20px;font-weight: bold;font-size: 14px;">Courier Privacy Policy</div>
	</div>
	<div style="width: 84%;margin-left: 8%;line-height: 150%">
        <p>
        We respect your privacy and are committed to protecting it through our compliance with this privacy policy (“Policy”). This Policy describes the types of information we may collect from you or that you may provide (“Personal Information”) on the tutti.app/courier website (“Website”), “tutti.app/courier” mobile application (“Mobile Application”), and any of their related products and services (collectively, “Services”), and our practices for collecting, using, maintaining, protecting, and disclosing that Personal Information. It also describes the choices available to you regarding our use of your Personal Information and how you can access and update it.<br />
        </p>
        <p>
            This Policy is a legally binding agreement between you (“User”, “you” or “your”) and Kavl Technology Ltd. (doing business as “Tutti Delivery”, “we”, “us” or “our”). If you are entering into this agreement on behalf of a business or other legal entity, you represent that you have the authority to bind such entity to this agreement, in which case the terms “User”, “you” or “your” shall refer to such entity. If you do not have such authority, or if you do not agree with the terms of this agreement, you must not accept this agreement and may not access and use the Services. By accessing and using the Services, you acknowledge that you have read, understood, and agree to be bound by the terms of this Policy. This Policy does not apply to the practices of companies that we do not own or control, or to individuals that we do not employ or manage.
        </p>
        <p>
            <br />
        </p>
        ...
        <div>
            <div class="document">
                <p class="paragraph text-align-type-left pap-line-1.07 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-8pt">
        ...
        <div>
            ...
            <p class="paragraph text-align-type-left pap-line-1.07 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-8pt">
                <a href="https://forms.gle/8naF6JUMNWsDABgA9">https://forms.gle/8naF6JUMNWsDABgA9</a>
            </p>
            <p class="paragraph text-align-type-left pap-line-1.07 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-8pt">
