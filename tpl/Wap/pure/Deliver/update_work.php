...
<body>
    ...
    <div id="all">
        <div id="title">
            Update Proof of Work Eligibility
        </div>
        <div class="tip">
        ...
        <div class="tip">
            <input type="text" name="sin_num" placeholder="Social Insurance Number" />
        </div>
        <div class="tip" style="color: black;">
            <span style="font-weight: bold;margin-bottom: 10px;">Proof of Work Eligibility</span>
