...
<body style="background:#ebf3f8; background-size: 100% 137px;max-width: 100%">
	...
	<section>
        <div class="Land_top">
            ...
            <span class="step">
                <span class="back curr">2</span>
                <span class="step_title" style="color:#f39824">{pigcms{:L('_DELIVER_STEP_2_')}</span>
            </span>
            <span class="step">
        ...
        <div class="Land_top">
            <h2>{pigcms{:L('_DELIVER_STEP_2_')}</h2>
        </div>
        <div id="reg_list">
            <div style="float: left;width: 100%;text-align: center;margin-top: 20px;">
                <img src="{pigcms{$static_public}images/deliver/step2.png" width="100">
            </div>
