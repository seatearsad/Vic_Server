...
<head>
	...
	<meta charset="utf-8">
	<title>{pigcms{$now_page.page_name}</title>
...
<body>
				...
				<div class="headerbar">
					<div class="headerbar-wrap clearfix">
						...
						<div class="headerbar-reedit">
							<a href="http://d.pigcms.com/user.php?c=store&amp;a=wei_page#edit/1091" class="js-no-follow">重新编辑</a>
						</div>
					</div>
				</div>
			<?php } ?>
	...
	window.shareData = {
				...
				"tTitle": "{pigcms{$now_page.page_name}",
				"tContent": "{pigcms{$now_page.page_desc}"
	};
	</script>
	{pigcms{$shareScript}
</body>
