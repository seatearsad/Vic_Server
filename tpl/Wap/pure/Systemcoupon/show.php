   ...
   <if condition="($phone OR $unlogin_phone OR ($coupon['had_pull'] eq $coupon['num']))">
	...
	<section class="content1">
		...
		<div class="verify">
			...
			<button id="reg_send_sms" type="button" onclick="sendsms(this)" style="border-radius:3px;background-color:#ECEC85;height: 1.35rem; width: 2.85rem;" >获取验证码</button>
			<else />
