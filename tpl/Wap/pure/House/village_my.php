	...
	<body>
		<div id="container">
			<div id="scroller" class="village_my">
				...
				<nav>
					<section class="link-url" data-url="{pigcms{:U('House/order_list')}"><span><img src="{pigcms{$static_path}images/order.png" /></span>
						<p>我的订单</p>
					</section>
					<section class="link-url" data-url="{pigcms{:U('My/adress')}"><span><img src="{pigcms{$static_path}images/address.png" /></span>
						<p>收货地址</p>
					</section>
