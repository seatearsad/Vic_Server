...
<html lang="zh-CN">
	...
	<body>
    <if condition="!$is_app_browser">
        <header class="pageSliderHide"><div id="backBtn"></div>在线报修列表<div id="plus" onclick="location.href='{pigcms{:U('House/village_my_repair',array('village_id'=>$now_village['village_id']))}'"><img src="{pigcms{$static_path}images/new_my/recharge.png" /></div></header>
    </if>
		<div id="container">
