...
<html lang="zh-CN">
	<head>
		...
		<script type="text/javascript">
			var okUrl = "{pigcms{:U('House/village_my_repairlists',array('village_id'=>$now_village['village_id']))}";
		</script>
	...
	<else />
		...
		<div id="container">
			<div id="scroller" class="village_repair">
				...
				<div class="area_btn"><input type="button" id="submit_btn" value="报修"/></div>
			</div>
		</div>
