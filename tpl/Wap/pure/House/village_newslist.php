...
<html>
	<head>
		...
		<script type="text/javascript">var location_url = "{pigcms{:U('House/village_ajax_news')}";var backUrl = "{pigcms{:U('House/village',array('village_id'=>$now_village['village_id']))}";</script>
		<script type="text/javascript" src="{pigcms{$static_path}js/village_newslist.js?215" charset="utf-8"></script>
	</head>
	<body>
    <if condition="!$is_app_browser">
						...
						<div class="swiper-container swiper-container1">
							<ul class="swiper-wrapper">
								<volist name="category_list" id="vo">
									<li class="swiper-slide <if condition="$i eq 1">on</if>" data-cat_id="{pigcms{$vo.cat_id}">{pigcms{$vo.cat_name}</li>
								</volist>
							</ul>
						</div>
					</div>
