...
<html lang="zh-CN">
	<head>
		...
		<script type="text/javascript">
			var location_url = "{pigcms{:U('House/village_meallist',array('village_id'=>$now_village['village_id']))}",totalPage = {pigcms{$totalPage};var backUrl = "{pigcms{:U('House/village',array('village_id'=>$now_village['village_id']))}";
		</script>
