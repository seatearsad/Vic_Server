...
<html>
    ...
    <body>
                    ...
                    <div class="owner clr">
                        ...
                        <div class="fr">
                            ...
                            <div class="apply clr">
                                ...
                                <div class="house link-url" data-url="{pigcms{:U('village',array('village_id'=>$vo['village_id']))}">使用房屋</div>
                            </div>
                            <elseif condition="$vo['status']==2" />
                            <div class="application">申请中</div>
                    ...
                    <div class="owner clr">
                        ...
                        <div class="fr">
                            ...
                            <div class="join">
                                ...
                                <div class="again link-url" data-url="{pigcms{:U('empty_village_room_info',array('pigcms_id'=>$vo['vacancy_id']))}">重新加入</div>
                            </div>
                            <!--<div class="join">
                                <div class="fail"><span>加入失败</span></div>
        ...
        <section class="tie clr">
            <div class="jr link-url" data-url="{pigcms{:U('House/empty_village_list')}">加入房屋</div>
            <div class="bd link-url" data-url="{pigcms{:U('House/empty_bind_relatives')}">绑定亲属</div>
        </section>
