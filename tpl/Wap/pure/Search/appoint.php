	...
	<body>
		...
		<section class="searchBox pageSliderHide">
			<ul>	
				...
				<li class="dropdown-toggle active" data-url="{pigcms{:U('Search/appoint',array('w'=>urlencode($keywords)))}"  data-url-type="openLeftWindow"><span class="nav-head-name">预约</span></li>
			</ul>
		</section>
		<div id="container">
			<div id="scroller">
				...
				<section class="navBox">
					<ul style="border-top: 1px solid #edebeb;">	
						...
						<li class="dropdown-toggle caret sort <if condition="$now_sort eq 'appointNum'">active</if>" data-sort="appointNum"><span class="nav-head-name">预约最多</span></li>
					...
					<dl class="dealcard">
						<volist name="group_list" id="vo">
							<dd class="link-url" data-url="{pigcms{$vo.url}">
								...
								<div class="dealcard-block-right">									
									<div class="brand">{pigcms{$vo.appoint_name} <if condition="$vo['juli']"><span class="location-right">约：{pigcms{:round($vo.juli/1000,1)}km</span></if></div>					
