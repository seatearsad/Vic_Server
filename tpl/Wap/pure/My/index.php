...
<body>
	...
	<if condition="!empty($scroll_msg)">
		<div style="margin-top:5px;display:none" class="scroll_msg" >
			<div >
				<div class="" style="font-size:12px;" id="scrollText">
					<marquee  style="padding:10px 0 0 0" >
	...
	<if condition="$config.open_score_fenrun eq 1 AND $now_user.openid neq ''">
