...
<script type="text/javascript">
    ...
    $(function(){
        ...
        var len=navL.length;
        var w=navL.width();
        scrollerIn.width(w*len);

        var myScroll;
        myScroll = new IScroll('#scrollerBox', { scrollX: true, scrollY: true, mouseWheel: true,click:true });
	...
	var banner_hei = document.getElementById('banner_hei');
	banner_hei.style.height	=	banner_height+'px';
</script>
