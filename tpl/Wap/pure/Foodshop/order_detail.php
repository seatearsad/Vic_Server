...
<section class="Cart CartReserve">
	...
	<!--  新增html -->  
	<div class="Cart_list Cartbot_list">
		<ul>
	...
	<div class="Serving" <if condition="$is_add_menu eq 0 AND $is_call_store eq 0">style="display:none"</if>>
		<dl>
...
$(function(){
	...
	$('.notice').click(function(){
		...
		notice = true;
		$.post("{pigcms{:U('Foodshop/call_store', array('order_id' => $order['order_id']))}", function(response){
...
<if condition="$order['running_state']">
timeout = setInterval(check_status, 10000);
</if>
