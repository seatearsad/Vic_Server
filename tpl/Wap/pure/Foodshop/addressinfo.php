...
<html>
	...
	<body>
				...
				<div id="address">
					<dl class="list">
						...
						<dd id="see_load">
                            ...
                            <else/>
							    <a class="btn right goHere" href="{pigcms{:U('Foodshop/get_route',array('store_id'=>$now_store['store_id']))}">查看路线</a>
						    </if>
                        </dd>
					</dl>
				</div>
		...
		window.shareData = {
					...
					"sendFriendLink": "{pigcms{$config.site_url}{pigcms{:U('Foodshop/addressinfo', array('store_id' => $now_store['store_id']))}",
