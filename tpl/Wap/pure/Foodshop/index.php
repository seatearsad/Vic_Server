...
<body>
	<if condition="$wap_foodshop_index_top">
	...
	<if condition="$wap_foodshop_slider">
									...
									<li class="category-wrapper">
										<ul class="dropdown-list">
											...
											<volist name="all_category_list" id="category">
												<li data-category-id="{pigcms{$category['cat_url']}" class="right-arrow-point-right <if condition="$now_category_url eq $category['cat_url']">active</if>" onclick="list_location($(this));return false;"><span data-name="{pigcms{$category['cat_name']}">{pigcms{$category['cat_name']}</span></li>
											</volist>
										</ul>
									</li>
