...
<html lang="zh-CN">
	<head>
		...
		<style>
			...
			.hotCategory dd .imgBox img{height:100%;}
			...
			<div id="scroller">
				...
				<volist name="all_category_list" id="vo">
					<section class="hotCategory clearfix">
						<div class="headBox link-url" data-url="{pigcms{:U('Appoint/category',array('cat_id'=>$vo['cat_id']))}">热门{pigcms{$vo.cat_name}<div class="more"><span>更多</span>&gt;</div></div>
