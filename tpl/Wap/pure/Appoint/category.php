...
<html lang="zh-CN">
	<head>
		...
		<style>
			...
			.leftBar li.cur {color: #06c1ae;position: relative;border-left:3px solid #06c1ae;background-color:#F6F6F7;}
			.rightBar{float:left;}
			...
			.rightBar dl dd .remind.third{background: url({pigcms{$static_path}images/yyt1.png) center no-repeat; background-size: 24px 25px;}
			.rightBar dl dd .remind.platform{background: url({pigcms{$static_path}images/yyt2.png) center no-repeat; background-size: 24px 25px;}
