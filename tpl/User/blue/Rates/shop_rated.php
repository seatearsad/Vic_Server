...
<title>已评价快店订单 | {pigcms{$config.site_name}</title>
				...
				<div id="content" class="coupons-box">
					<div class="mainbox mine">
						<select class="J-orders-filter orders-filter dropdown--small">
							...
							<option value="{pigcms{:U('Rates/shop_rated')}" selected="selected">{pigcms{$config.shop_alias_name}</option>
							<option value="{pigcms{:U('Rates/appoint_rated')}">预约</option>
						</select>
						...
						<else/>
							<div class="notice">您没有已评价的{pigcms{$config.shop_alias_name}订单</div>
						</if>
                    </div>
				</div>
			</div> <!-- bd end -->
