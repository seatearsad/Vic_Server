						...
						<div class="table-section">
							<table cellspacing="0" cellpadding="0" border="0">
								<tr>
									...
									<th width="110">消耗{pigcms{$config['score_name']}</th>
								 ...
								 <if condition="isset($levelarr[$nextlevel])">
									<tr>
										...
										<td>
										<a href="javascript:void(0);" class="btn" onclick="levelToupdate({pigcms{$now_user.score_count},{pigcms{$levelarr[$nextlevel]['integral']},$(this))" style="color:#FFF;">{pigcms{$config['score_name']}兑换</a>
