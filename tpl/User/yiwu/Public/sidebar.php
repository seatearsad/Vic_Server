		...
		<dl class="side-nav__list">
			...
			<dd>
				<ul class="item-list">
					...
					<li <if condition="in_array(MODULE_NAME,array('Index')) && in_array(ACTION_NAME,array('appoint_order'))">class="current"</if>><a href="{pigcms{:U('Index/appoint_order')}">预约订单</a></li>
